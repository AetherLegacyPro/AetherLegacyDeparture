...
public class BlocksAether {
    ...
    public static Block enchanted_deific_bricks, enchanted_agiosite_bricks, enchanted_aetheral_stone_bricks,
        enchanted_holystone_bricks;
    public static Block aerogel, quicksoil_glass, frozen_quicksoil_glass;
    public static Block enchanted_gravitite, zanite_block, arkenium_block, ambrosium_block, continuum_block,
        divineral_block, reinforced_arkenium_block;
    ...
    // Aether Ores
    public static Block ambrosium_ore, zanite_ore, gravitite_ore, arkenium_ore, continuum_ore, icestone,
        primeval_artifact;
    public static Block aetheral_ambrosium_ore, aetheral_zanite_ore, aetheral_gravitite_ore, aetheral_arkenium_ore,
        aetheral_continuum_ore;
    public static Block agiosite_ambrosium_ore, agiosite_zanite_ore, agiosite_gravitite_ore, agiosite_arkenium_ore,
        agiosite_continuum_ore;
    public static Block deific_ambrosium_ore, deific_zanite_ore, deific_gravitite_ore, deific_arkenium_ore,
        deific_continuum_ore;
    ...
    public static Block skyroot_leaves, golden_oak_leaves, crystal_leaves, green_light_skyroot_leaves,
        blue_light_skyroot_leaves, void_leaves;
    ...
    public static Block skyroot_log, golden_oak_log, golden_oak_new_log, greatroot_log, wisproot_log, void_log,
        divine_oak_log;
    public static Block skyroot_planks, golden_oak_planks, greatroot_planks, wisproot_planks, void_planks,
        divine_oak_planks;
    ...
    public static Block skyroot_fence_gate, golden_oak_gate, greatroot_fence_gate, wisproot_fence_gate, void_fence_gate,
        divine_oak_gate;
    ...
    public static Block aether_tallgrass, arctic_tallgrass, snowy_tallgrass, enchanted_aether_tallgrass, burstblossom,
        carrion_flower, moonlit_bloom;
    ...
    public static Block purple_skyroot_sapling, blue_skyroot_sapling, dark_blue_skyroot_sapling, wisproot_sapling,
        greatroot_sapling;
    ...
    public static Block chest_mimic, treasure_chest, treasure_chest_breakable, skyroot_chest, elysian_chest,
        elysian_mimic;
    ...
    public static Block locked_carved_stone, locked_ancient_carved_stone, locked_divine_carved_stone,
        locked_mythic_carved_stone;
    public static Block sentry_stone, ancient_sentry_stone, divine_sentry_stone, mythic_sentry_stone;
    public static Block locked_sentry_stone, locked_ancient_sentry_stone, locked_divine_sentry_stone,
        locked_mythic_sentry_stone;
    ...
    public static Block light_angelic_stone, ancient_light_angelic_stone, divine_light_angelic_stone,
        mythic_light_angelic_stone;
    public static Block locked_angelic_stone, locked_ancient_angelic_stone, locked_divine_angelic_stone,
        locked_mythic_angelic_stone;
    public static Block locked_light_angelic_stone, locked_ancient_light_angelic_stone,
        locked_divine_light_angelic_stone, locked_mythic_light_angelic_stone;
    ...
    public static Block light_hellfire_stone, ancient_light_hellfire_stone, divine_light_hellfire_stone,
        mythic_light_hellfire_stone;
    public static Block locked_hellfire_stone, locked_ancient_hellfire_stone, locked_divine_hellfire_stone;
    public static Block locked_light_hellfire_stone, locked_ancient_light_hellfire_stone,
        locked_divine_light_hellfire_stone;
    ...
    // Aether Stairs
    public static Block carved_stairs, angelic_stairs, hellfire_stairs, fuse_stairs, skyroot_stairs,
        mossy_holystone_stairs, holystone_stairs;
    public static Block holystone_brick_stairs, aerogel_stairs, golden_oak_stairs, greatroot_stairs, wisproot_stairs,
        agiosite_stairs;
    public static Block enchanted_agiosite_stairs, aetheral_stone_stairs, enchanted_aetheral_stone_stairs, void_stairs,
        deific_stairs;
    public static Block enchanted_deific_stairs, enchanted_holystone_stairs, enchanted_holystone_brick_stairs,
        caelestia_stone_stairs;
    public static Block ancient_carved_stone_stairs, divine_carved_stone_stairs, ancient_angelic_stone_stairs,
        divine_angelic_stone_stairs, divine_hellfire_stone_stairs;
    public static Block mythic_carved_stone_stairs, mythic_angelic_stone_stairs, mythic_hellfire_stone_stairs,
        oblitus_stairs, divine_oak_stairs;
    public static Block aetheral_stone_brick_stairs, agiosite_brick_stairs, deific_brick_stairs,
        carved_caelestia_stone_stairs;
    public static Block enchanted_agiosite_brick_stairs, enchanted_deific_brick_stairs,
        enchanted_aetheral_stone_brick_stairs;
    public static Block ancient_hellfire_stairs;

    // Aether Slabs
    public static Block carved_slab, angelic_slab, hellfire_slab, fuse_slab, skyroot_slab, holystone_slab,
        holystone_brick_slab, divine_oak_slab;
    public static Block mossy_holystone_slab, aerogel_slab, greatroot_slab, wisproot_slab, agiosite_slab,
        agiosite_brick_slab, aetheral_stone_brick_slab;
    public static Block enchanted_agiosite_slab, aetheral_stone_slab, enchanted_aetheral_stone_slab, void_slab,
        deific_slab, deific_brick_slab;
    public static Block enchanted_deific_slab, enchanted_holystone_slab, enchanted_holystone_brick_slab,
        caelestia_stone_slab, carved_caelestia_stone_slab;
    public static Block enchanted_agiosite_brick_slab, ancient_carved_stone_slab, divine_carved_stone_slab,
        golden_oak_slab, divine_hellfire_stone_slab;
    public static Block mythic_carved_stone_slab, divine_angelic_stone_slab, mythic_angelic_stone_slab,
        oblitus_stone_slab, enchanted_deific_brick_slab;
    public static Block enchanted_aetheral_stone_brick_slab, ancient_angelic_stone_slab, ancient_hellfire_stone_slab;

    // Aether Double Slabs
    public static Block carved_double_slab, angelic_double_slab, hellfire_double_slab, fuse_double_slab,
        skyroot_double_slab, holystone_double_slab;
    public static Block holystone_brick_double_slab, mossy_holystone_double_slab, aerogel_double_slab,
        greatroot_double_slab, aetheral_stone_brick_double_slab;
    public static Block wisproot_double_slab, agiosite_double_slab, enchanted_agiosite_double_slab,
        aetheral_stone_double_slab, divine_oak_double_slab;
    public static Block enchanted_aetheral_stone_double_slab, void_double_slab, deific_double_slab,
        agiosite_brick_double_slab, deific_brick_double_slab;
    public static Block enchanted_deific_double_slab, enchanted_holystone_double_slab,
        enchanted_holystone_brick_double_slab, caelestia_stone_double_slab;
    public static Block carved_caelestia_stone_double_slab, enchanted_agiosite_brick_double_slab,
        divine_carved_stone_double_slab;
    public static Block golden_oak_double_slab, divine_hellfire_stone_double_slab, mythic_carved_stone_double_slab,
        oblitus_stone_double_slab;
    public static Block ancient_carved_stone_double_slab, divine_angelic_stone_double_slab,
        mythic_angelic_stone_double_slab, enchanted_deific_brick_double_slab;
    public static Block enchanted_aetheral_stone_brick_double_slab, ancient_angelic_stone_double_slab,
        ancient_hellfire_stone_double_slab;

    // Aether Walls
    public static Block holystone_wall, mossy_holystone_wall, holystone_brick_wall, carved_wall, angelic_wall,
        hellfire_wall, fuse_wall, aerogel_wall;
    public static Block agiosite_wall, agiosite_brick_wall, enchanted_agiosite_wall, aetheral_stone_wall,
        enchanted_aetheral_stone_wall, aetheral_stone_brick_wall;
    public static Block deific_wall, deific_brick_wall, enchanted_deific_wall, enchanted_holystone_wall,
        enchanted_holystone_brick_wall, caelestia_stone_wall, carved_caelestia_stone_wall;
    public static Block mythic_carved_stone_wall, mythic_angelic_stone_wall, enchanted_agiosite_brick_wall,
        oblitus_wall, enchanted_deific_brick_wall;
    public static Block skyroot_log_wall, golden_oak_log_wall, wisproot_log_wall, greatroot_log_wall, void_log_wall,
        enchanted_aetheral_stone_brick_wall;
    public static Block ancient_carved_stone_wall, divine_carved_stone_wall, divine_angelic_stone_wall,
        divine_hellfire_stone_wall, divine_oak_log_wall;
    ...
    public static void initialization() {
        ...
        enchanted_aether_grass = registerRarity(
            "enchanted_aether_grass",
            new BlockEnchantedAetherGrass(),
            EnumRarity.rare);
        ...
        enchanted_aether_farmland = registerRarity(
            "enchanted_aether_farmland",
            new BlockEnchantedAetherFarmland(),
            EnumRarity.rare);

        holystone = registerMeta("holystone", new BlockHolystone());
        holystone_brick = register(
            "holystone_brick",
            new BlockAether(Material.rock, Aether.find("holystone_brick")).setHardness(0.5F)
                .setResistance(10.0F));
        enchanted_holystone = registerMeta(
            "enchanted_holystone",
            new BlockEnchantedAgiosite().setBlockTextureName(Aether.findHighlands("agiosite")));
        enchanted_holystone_bricks = register(
            "enchanted_holystone_bricks",
            new BlockAether(Material.rock, Aether.find("enchanted_holystone_bricks")).setHardness(0.6F)
                .setResistance(14.0F));
        aetheral_stone = registerMeta(
            "aetheral_stone",
            new BlockHolystone().setBlockTextureName(Aether.find("aetheral_stone"))
                .setHardness(3.0F)
                .setResistance(5.0F));
        aetheral_stone_bricks = register(
            "aetheral_stone_bricks",
            new BlockAether(Material.rock, Aether.find("aetheral_stone_brick")).setHardness(3.0F)
                .setResistance(5.0F));
        enchanted_aetheral_stone = registerMeta(
            "enchanted_aetheral_stone",
            new BlockEnchantedAetheralStone().setHardness(3.0F)
                .setResistance(5.0F));
        enchanted_aetheral_stone_bricks = register(
            "enchanted_aetheral_stone_bricks",
            new BlockAether(Material.rock, Aether.find("enchanted_aetheral_stone_brick")).setHardness(3.0F)
                .setResistance(5.0F));
        deific = registerMeta(
            "deific",
            new BlockHolystone().setBlockTextureName(Aether.find("deific"))
                .setHardness(5.5F)
                .setResistance(7.0F));
        deific_bricks = register(
            "deific_bricks",
            new BlockAether(Material.rock, Aether.find("deific_bricks")).setHardness(5.5F)
                .setResistance(7.0F));
        enchanted_deific = registerMeta(
            "enchanted_deific",
            new BlockEnchantedAetheralStone().setBlockTextureName(Aether.find("enchanted_deific"))
                .setHardness(5.5F)
                .setResistance(7.0F));
        enchanted_deific_bricks = register(
            "enchanted_deific_bricks",
            new BlockAether(Material.rock, Aether.find("enchanted_deific_bricks")).setHardness(5.5F)
                .setResistance(7.0F));
        agiosite = registerMeta(
            "agiosite",
            new BlockAgiosite().setHardness(4.0F)
                .setResistance(6.0F));
        agiosite_bricks = register(
            "agiosite_bricks",
            new BlockAether(Material.rock, Aether.find("agiosite_stone_bricks")).setHardness(4.0F)
                .setResistance(6.0F));
        enchanted_agiosite = registerMeta(
            "enchanted_agiosite",
            new BlockEnchantedAgiosite().setBlockTextureName(Aether.find("enchanted_agiosite"))
                .setHardness(4.0F)
                .setResistance(6.0F));
        enchanted_agiosite_bricks = register(
            "enchanted_agiosite_bricks",
            new BlockAether(Material.rock, Aether.find("enchanted_agiosite_stone_bricks")).setHardness(4.0F)
                .setResistance(6.0F));
        caelestia_stone = registerMeta(
            "caelestia_stone",
            new BlockHolystone().setResistance(124.0F)
                .setBlockTextureName(Aether.find("caelestia_stone")));
        carved_caelestia_stone = registerMeta(
            "carved_caelestia_stone",
            new BlockCarvedCaelestia().setResistance(18.0F)
                .setHardness(0.7F)
                .setResistance(12.0F));
        ...
        frozen_quicksoil_glass = registerRarity(
            "frozen_quicksoil_glass",
            new BlockFrozenQuicksoilGlass(),
            EnumRarity.rare);
        glowing_icestone = register("glowing_icestone", new BlockGlowingIcestone());
        luminous_stone = registerMeta(
            "luminous_stone",
            new BlockLuminousStone().setBlockTextureName(Aether.find("luminous_stone")));
        arctic_glowstone = registerMeta(
            "arctic_glowstone",
            new BlockLuminousStone().setBlockTextureName(Aether.find("arctic_glowstone")));
        amethyst_glowstone = registerMeta(
            "amethyst_glowstone",
            new BlockLuminousStone().setBlockTextureName(Aether.find("amethyst_glowstone")));
        cer_scales_block = registerRarity("cer_scales_block", new BlockAerScalesBlock(), ItemsAether.aether_loot);
        elysian_scales_block = registerRarity(
            "elysian_scales_block",
            new BlockElysianScalesBlock(),
            ItemsAether.divine_aether_loot).setBlockTextureName(Aether.find("elysian_scales_block"));
        ambrosium_torch = register(
            "ambrosium_torch",
            new BlockAmbrosiumTorch().setBlockTextureName(Aether.find("ambrosium_torch")));
        ethereal_torch = register(
            "ethereal_torch",
            new BlockEtherealTorch().setBlockTextureName(Aether.find("ethereal_torch")));
        inferno_torch = register(
            "hellfire_torch",
            new BlockInfernoTorch().setBlockTextureName(Aether.find("hellfire_torch")));
        holystone_lever = registerMeta(
            "holystone_lever",
            new BlockAetherLever(Material.circuits).setBlockTextureName(Aether.find("holystone_lever")));
        ...
        enchanted_gravitite = registerRarity(
            "enchanted_gravitite",
            new BlockFloating(Material.rock, true).setHardness(5.0F)
                .setBlockTextureName(Aether.find("enchanted_gravitite")),
            EnumRarity.rare);
        arkenium_block = register("arkenium_block", new BlockArkenium());
        reinforced_arkenium_block = registerRarity(
            "reinforced_arkenium_block",
            new BlockReinforcedArkenium().setBlockTextureName(Aether.find("reinforced_arkenium_block")),
            EnumRarity.rare);
        empyrean_block = registerRarity(
            "empyrean_block",
            new BlockReinforcedArkenium().setBlockTextureName(Aether.find("empyrean_block")),
            EnumRarity.rare);
        charged_empyrean_block = registerRarity(
            "charged_empyrean_block",
            new BlockReinforcedArkenium().setBlockTextureName(Aether.find("charged_empyrean_block")),
            EnumRarity.rare);
        ...
        gravitite_ore = register(
            "gravitite_ore",
            new BlockFloating(Material.rock, false).setHardness(5.0F)
                .setBlockTextureName(Aether.find("gravitite_ore")));
        arkenium_ore = register(
            "arkenium_ore",
            new BlockAetherOreNew(1).setBlockTextureName(Aether.find("arkenium_ore")));
        continuum_ore = register(
            "continuum_ore",
            new BlockAetherOreNew(1).setBlockTextureName(Aether.findII("continuumOre")));

        aetheral_ambrosium_ore = register(
            "aetheral_ambrosium_ore",
            new BlockAetherOreAetheral(0).setBlockTextureName(Aether.find("aetheral_ambrosium_ore")));
        aetheral_zanite_ore = register(
            "aetheral_zanite_ore",
            new BlockAetherOreAetheral(1).setBlockTextureName(Aether.find("aetheral_zanite_ore")));
        aetheral_gravitite_ore = register(
            "aetheral_gravitite_ore",
            new BlockFloating(Material.rock, false).setHardness(5.0F)
                .setBlockTextureName(Aether.find("aetheral_gravitite_ore")));
        aetheral_arkenium_ore = register(
            "aetheral_arkenium_ore",
            new BlockAetherOreNewAetheral(1).setBlockTextureName(Aether.find("aetheral_arkenium_ore")));
        aetheral_continuum_ore = register(
            "aetheral_continuum_ore",
            new BlockAetherOreNewAetheral(1).setBlockTextureName(Aether.find("aetheral_continuum_ore")));

        agiosite_ambrosium_ore = register(
            "agiosite_ambrosium_ore",
            new BlockAetherOreAgiosite(0).setBlockTextureName(Aether.find("agiosite_ambrosium_ore")));
        agiosite_zanite_ore = register(
            "agiosite_zanite_ore",
            new BlockAetherOreAgiosite(1).setBlockTextureName(Aether.find("agiosite_zanite_ore")));
        agiosite_gravitite_ore = register(
            "agiosite_gravitite_ore",
            new BlockFloating(Material.rock, false).setHardness(5.0F)
                .setBlockTextureName(Aether.find("agiosite_gravitite_ore")));
        agiosite_arkenium_ore = register(
            "agiosite_arkenium_ore",
            new BlockAetherOreNewAgiosite(1).setBlockTextureName(Aether.find("agiosite_arkenium_ore")));
        agiosite_continuum_ore = register(
            "agiosite_continuum_ore",
            new BlockAetherOreNewAgiosite(1).setBlockTextureName(Aether.find("agiosite_continuum_ore")));

        deific_ambrosium_ore = register(
            "deific_ambrosium_ore",
            new BlockAetherOreDeific(0).setBlockTextureName(Aether.find("deific_ambrosium_ore")));
        deific_zanite_ore = register(
            "deific_zanite_ore",
            new BlockAetherOreDeific(1).setBlockTextureName(Aether.find("deific_zanite_ore")));
        deific_gravitite_ore = register(
            "deific_gravitite_ore",
            new BlockFloating(Material.rock, false).setHardness(5.0F)
                .setBlockTextureName(Aether.find("deific_gravitite_ore")));
        deific_arkenium_ore = register(
            "deific_arkenium_ore",
            new BlockAetherOreNewDeific(1).setBlockTextureName(Aether.find("deific_arkenium_ore")));
        deific_continuum_ore = register(
            "deific_continuum_ore",
            new BlockAetherOreNewDeific(1).setBlockTextureName(Aether.find("deific_continuum_ore")));

        empyrean_ore = registerRarity("empyrean_ore", new BlockEmpyreanOre(), ItemsAether.scaled_aether_loot)
            .setBlockTextureName(Aether.find("empyrean_ore"));
        empyrean_ore_2 = registerRarity("empyrean_ore_2", new BlockEmpyreanOre(), ItemsAether.scaled_aether_loot)
            .setBlockTextureName(Aether.find("empyrean_ore_2"));

        icestone = register("icestone", new BlockIcestone());
        primeval_artifact = registerRarity(
            "primeval_artifact",
            new BlockPrimevalDebris(),
            ItemsAether.divine_aether_loot);

        block_of_auralite = registerRarity(
            "block_of_auralite",
            new BlockAuralite().setBlockTextureName(Aether.find("block_of_auralite")),
            ItemsAether.scaled_aether_loot);
        budding_auralite = registerRarity(
            "budding_auralite",
            new BlockBuddingAuralite().setBlockTextureName(Aether.find("budding_auralite")),
            ItemsAether.scaled_aether_loot);
        auralite_pillar = registerRarity(
            "auralite_pillar",
            new BlockAuralitePillar().setBlockTextureName(Aether.find("block_of_auralite")),
            ItemsAether.scaled_aether_loot);
        auralite_cluster_1 = registerItemBlock(
            "auralite_cluster_1",
            new BlockAuraliteCluster(0),
            ItemAuraliteCluster.class);
        auralite_cluster_2 = registerItemBlock(
            "auralite_cluster_2",
            new BlockAuraliteCluster(1),
            ItemAuraliteCluster.class);

        block_of_aceninum = registerRarity(
            "block_of_aceninum",
            new BlockAceninum().setBlockTextureName(Aether.find("block_of_aceninum")),
            ItemsAether.divine_aether_loot);
        aceninum_cluster = registerRarity(
            "aceninum_cluster",
            new BlockAceninumCluster(0),
            ItemsAether.divine_aether_loot);
        ...
        golden_oak_fruit_leaves = register(
            "golden_oak_fruit_leaves",
            new BlockAetherLeaves().setBlockTextureName(Aether.find("golden_oak_fruit_leaves")));
        ...
        decorated_holiday_leaves = register(
            ...
            new BlockAetherLeaves().setBlockTextureName(Aether.find("decorated_holiday_leaves")));
        purple_skyroot_fruit_leaves = register(
            "purple_skyroot_fruit_leaves",
            new BlockAetherLeaves().setBlockTextureName(Aether.findII("Purple Fruit Leaves")));
        purple_skyroot_leaves = register(
            "purple_skyroot_leaves",
            new BlockAetherLeaves().setBlockTextureName(Aether.findII("Purple Crystal Leaves")));
        blue_skyroot_leaves = register(
            "blue_skyroot_leaves",
            new BlockAetherLeaves().setBlockTextureName(Aether.findII("blueSkyrootLeaves")));
        dark_blue_skyroot_leaves = register(
            "dark_blue_skyroot_leaves",
            new BlockAetherLeaves().setBlockTextureName(Aether.findII("darkBlueSkyrootLeaves")));
        green_light_skyroot_leaves = register(
            "green_light_skyroot_leaves",
            new BlockAetherLeaves().setBlockTextureName(Aether.find("green_light_skyroot_leaves")));
        blue_light_skyroot_leaves = register(
            "blue_light_skyroot_leaves",
            new BlockAetherLeaves().setBlockTextureName(Aether.find("blue_light_skyroot_leaves")));
        void_leaves = register("void_leaves", new BlockAetherLeaves().setBlockTextureName(Aether.find("void_leaves")));
        void_fruit_leaves = register(
            "void_fruit_leaves",
            new BlockAetherLeaves().setBlockTextureName(Aether.find("void_fruit_leaves")));
        divine_oak_leaves = register(
            "divine_oak_leaves",
            new BlockAetherLeaves().setBlockTextureName(Aether.find("divine_oak_leaves")));

        skyroot_log = registerMeta("skyroot_log", new BlockAetherLog()).setBlockTextureName(Aether.find("skyroot_log"));
        golden_oak_log = registerHidden(
            "golden_oak_log",
            new BlockAetherLogOld().setBlockTextureName(Aether.find("golden_oak_log")));
        golden_oak_new_log = registerMeta("golden_oak_new_log", new BlockGoldenOakNewLog());
        greatroot_log = registerMeta(
            "greatroot_log",
            new BlockAetherLogGreatroot().setBlockTextureName(Aether.findHighlands("logs/greatroot_log")));
        wisproot_log = registerMeta(
            "wisproot_log",
            new BlockAetherLogWisproot().setBlockTextureName(Aether.findHighlands("logs/wisproot_log")));
        void_log = registerMeta("void_log", new BlockAetherLogVoid().setBlockTextureName(Aether.find("void_log")));
        divine_oak_log = registerMeta(
            "divine_oak_log",
            new BlockAetherLogDivine().setBlockTextureName(Aether.find("divine_log")));
        ...
        wisproot_trapdoor = registerMeta(
            "wisproot_trapdoor",
            new BlockAetherTrapdoor(Material.wood).setBlockTextureName(Aether.find("wisproot_trapdoor")));
        greatroot_trapdoor = registerMeta(
            "greatroot_trapdoor",
            new BlockAetherTrapdoor(Material.wood).setBlockTextureName(Aether.find("greatroot_trapdoor")));
        void_trapdoor = registerMeta(
            "void_trapdoor",
            new BlockAetherTrapdoor(Material.wood).setBlockTextureName(Aether.find("void_trapdoor")));
        zanite_trapdoor = registerMeta(
            "zanite_trapdoor",
            new BlockAetherTrapdoor(Material.iron).setBlockTextureName(Aether.find("zanite_trapdoor")));
        skyroot_ladder = registerMeta(
            "skyroot_ladder",
            new BlockAetherLadder().setBlockTextureName(Aether.findII("skyrootLadder")));

        small_blueberry_bush = registerHidden(
            "small_blueberry_bush",
            new BlockSmallBerryBushStem().setBlockTextureName(Aether.find("small_blueberry_bush")));
        medium_blueberry_bush = registerHidden(
            "medium_blueberry_bush",
            new BlockMediumBerryBushStem().setBlockTextureName(Aether.find("medium_blueberry_bush")));
        berry_bush_stem = registerHidden("berry_bush_stem", new BlockBerryBushStem());
        berry_bush = register("berry_bush", new BlockBerryBush());

        small_raspberry_bush = registerHidden(
            "small_raspberry_bush",
            new BlockSmallRaspberryBush().setBlockTextureName(Aether.find("small_blueberry_bush")));
        medium_raspberry_bush = registerHidden(
            "medium_raspberry_bush",
            new BlockMediumRaspberryBush().setBlockTextureName(Aether.find("medium_blueberry_bush")));
        ...
        small_strawberry_bush = registerHidden(
            "small_strawberry_bush",
            new BlockSmallStrawberryBush().setBlockTextureName(Aether.find("small_blueberry_bush")));
        medium_strawberry_bush = registerHidden(
            "medium_strawberry_bush",
            new BlockMediumStrawberryBush().setBlockTextureName(Aether.find("medium_blueberry_bush")));
        ...
        small_blackberry_bush = registerHidden(
            "small_blackberry_bush",
            new BlockSmallBlackberryBushStem().setBlockTextureName(Aether.find("small_blueberry_bush")));
        medium_blackberry_bush = registerHidden(
            "medium_blackberry_bush",
            new BlockMediumBlackberryBushStem().setBlockTextureName(Aether.find("medium_blueberry_bush")));
        ...
        small_orange_tree = registerHidden(
            "small_orange_tree",
            new BlockSmallOrangeTree().setBlockTextureName(Aether.find("small_orange_tree")));
        medium_orange_tree = registerHidden(
            "medium_orange_tree",
            new BlockMediumOrangeTree().setBlockTextureName(Aether.find("medium_orange_tree")));
        large_orange_tree = registerHidden(
            "large_orange_tree",
            new BlockLargeOrangeTree().setBlockTextureName(Aether.find("large_orange_tree")));
        mature_orange_tree = register(
            "mature_orange_tree",
            new BlockMatureOrangeTree().setBlockTextureName(Aether.find("orange_tree_mature")));

        grape_tree_stage_one = registerHidden(
            "grape_tree_stage_one",
            new BlockGrapeTreeStage1().setBlockTextureName(Aether.find("grape_tree_stage_one")));
        grape_tree_stage_two = registerHidden(
            "grape_tree_stage_two",
            new BlockGrapeTreeStage2().setBlockTextureName(Aether.find("grape_tree_stage_two")));
        grape_tree_mature = register(
            "grape_tree_mature",
            new BlockGrapeTreeMature().setBlockTextureName(Aether.find("grape_tree_mature")));

        aether_tallgrass = register(
            "aether_tallgrass",
            new BlockAetherTallGrass().setBlockTextureName(Aether.find("aether_grass")));
        arctic_tallgrass = register(
            "arctic_tallgrass",
            new BlockArcticTallGrass().setBlockTextureName(Aether.find("arctic_tallgrass")));
        snowy_tallgrass = register(
            "snowy_tallgrass",
            new BlockSnowyTallGrass().setBlockTextureName(Aether.find("snowy_tallgrass")));
        enchanted_aether_tallgrass = register(
            "enchanted_aether_tallgrass",
            new BlockEnchantedAetherTallGrass().setBlockTextureName(Aether.find("enchanted_aether_grass")));
        divine_aether_tallgrass = register(
            "divine_aether_tallgrass",
            new BlockDivineAetherTallGrass().setBlockTextureName(Aether.find("divine_grass")));
        ...
        white_rose = register("white_rose", new BlockAetherFlower().setBlockTextureName("aether:flowers/white_rose"));// could
                                                                                                                      // re-findII
                                                                                                                      // this
        aechor_sprout = register(
            "aechor_sprout",
            new BlockAetherFlower().setBlockTextureName(Aether.findHighlands("flowers/aechor_sprout")));
        blue_swingtip = register(
            "blue_swingtip",
            new BlockAetherFlower().setBlockTextureName(Aether.findHighlands("flowers/blue_swingtip")));
        neverbloom = register(
            "neverbloom",
            new BlockAetherFlower().setBlockTextureName(Aether.findHighlands("flowers/neverbloom")));
        burstblossom = register(
            "burstblossom",
            new BlockAetherFlower().setBlockTextureName(Aether.find("burstblossom")));
        carrion_flower = register(
            "carrion_flower",
            new BlockAetherFlower().setBlockTextureName(Aether.find("carrion_flower")));
        moonlit_bloom = register(
            "moonlit_bloom",
            new BlockAetherFlower().setBlockTextureName(Aether.find("moonlit_bloom")));
        quickshoot = register("quickshoot", new BlockAetherFlower().setBlockTextureName(Aether.find("quickshoot")));
        enchanted_quickshoot = register(
            "enchanted_quickshoot",
            new BlockEnchantedAetherFlower().setBlockTextureName(Aether.find("enchanted_quickshoot")));
        aether_tulips = register(
            "aether_tulips",
            new BlockAetherFlower().setBlockTextureName(Aether.find("aether_tulips")));
        enchanted_aether_tulips = register(
            "enchanted_aether_tulips",
            new BlockEnchantedAetherFlower().setBlockTextureName(Aether.find("enchanted_aether_tulips")));
        enchanted_bloom = register(
            "enchanted_bloom",
            new BlockEnchantedAetherFlower().setBlockTextureName(Aether.find("enchanted_bloom")));
        divine_stalk = register(
            "divine_stalk",
            new BlockDivineAetherFlower().setBlockTextureName(Aether.find("divine_stalk")));
        divine_bloom = register(
            "divine_bloom",
            new BlockDivineAetherFlower().setBlockTextureName(Aether.find("divine_bloom")));
        divine_lily = register(
            "divine_lily",
            new BlockDivineAetherFlower().setBlockTextureName(Aether.find("divine_lily")));
        ...
        golden_oak_sapling = register(
            "golden_oak_sapling",
            new BlockAetherSapling(new AetherGenOakTree()).setBlockTextureName(Aether.find("golden_oak_sapling")));
        crystal_sapling = register(
            "crystal_sapling",
            new BlockAetherSapling(new AetherGenCrystalTree(false))
                .setBlockTextureName(Aether.find("crystal_sapling")));
        purple_skyroot_sapling = register(
            "purple_skyroot_sapling",
            new BlockAetherSapling(new AetherGenPurpleSkyrootTree(false))
                .setBlockTextureName(Aether.findII("purpleCrystalSapling")));
        blue_skyroot_sapling = register(
            "blue_skyroot_sapling",
            new BlockAetherSapling(new AetherGenBlueSkyrootTree(false))
                .setBlockTextureName(Aether.findII("blueSkyrootSapling")));
        dark_blue_skyroot_sapling = register(
            "dark_blue_skyroot_sapling",
            new BlockAetherSapling(new AetherGenDarkBlueSkyrootTree(false))
                .setBlockTextureName(Aether.findII("darkBlueSkyrootSapling")));
        wisproot_sapling = register(
            "wisproot_sapling",
            new BlockAetherSapling(new AetherGenWisprootTree(BlocksAether.blue_light_skyroot_leaves, 8, true))
                .setBlockTextureName(Aether.find("wisproot_sapling")));
        greatroot_sapling = register(
            "greatroot_sapling",
            new BlockAetherSapling(new AetherGenGreatrootTree(BlocksAether.green_light_skyroot_leaves, 20, true))
                .setBlockTextureName(Aether.find("greatroot_sapling")));
        void_sapling = register(
            "void_sapling",
            new BlockVoidSapling(new AetherGenVoidTree(false)).setBlockTextureName(Aether.find("void_sapling")));
        divine_oak_sapling = register(
            "divine_oak_sapling",
            new BlockAetherSapling(new AetherGenDivineTree(BlocksAether.divine_oak_leaves, 40, true))
                .setBlockTextureName(Aether.find("divine_oak_sapling")));
        ...
        aether_enchantment_table = register(
            "aether_enchantment_table",
            new BlockAetherEnchantmentTable().setLightOpacity(3));
        divine_enchantment_table = registerRarity(
            "divine_enchantment_table",
            new BlockDivineEnchantmentTable(),
            ItemsAether.divine_aether_loot).setLightOpacity(3);
        ...
        bloodmoss_stone = registerMeta(
            "bloodmoss_stone",
            new BlockHolystone().setBlockTextureName(Aether.find("bloodmoss_stone")));
        azure_holystone = registerMeta(
            "azure_holystone",
            new BlockHolystone().setBlockTextureName(Aether.find("azure_holystone")));
        notch_holystone = registerMeta(
            "notch_holystone",
            new BlockHolystone().setBlockTextureName(Aether.find("notch_holystone")));
        ...
        ancient_carved_stone = register(
            "ancient_carved_stone",
            new BlockDungeonBase(false).setBlockTextureName(Aether.find("ancient_carved_stone")));
        ancient_sentry_stone = register(
            "ancient_sentry_stone",
            new BlockDungeonBase(true).setBlockTextureName(Aether.find("ancient_sentry_stone")));
        divine_carved_stone = register(
            "divine_carved_stone",
            new BlockDungeonBase(false).setBlockTextureName(Aether.findII("divineCarvedStone")));
        divine_sentry_stone = register(
            "divine_sentry_stone",
            new BlockDungeonBase(true).setBlockTextureName(Aether.findII("divineSentryStone")));
        mythic_carved_stone = register(
            "mythic_carved_stone",
            new BlockDungeonBase(false).setBlockTextureName(Aether.find("mythic_carved_stone")));
        mythic_sentry_stone = register(
            "mythic_sentry_stone",
            new BlockDungeonBase(true).setBlockTextureName(Aether.find("mythic_sentry_stone")));

        oblitus_stone = registerHidden(
            "oblitus_stone",
            new BlockOblitusStone().setResistance(20.0F)
                .setBlockTextureName(Aether.find("oblitus_stone"))
                .setCreativeTab(null));
        oblitus_stone_2 = register(
            "oblitus_stone_2",
            new BlockOblitusStone2().setResistance(20.0F)
                .setBlockTextureName(Aether.find("oblitus_stone")));
        cracked_oblitus_stone = registerHidden(
            "cracked_oblitus_stone",
            new BlockCrackedOblitusStone().setBlockTextureName(Aether.find("cracked_oblitus_stone"))
                .setCreativeTab(null));
        cracked_oblitus_stone_2 = register(
            "cracked_oblitus_stone_2",
            new BlockCrackedOblitusStone2().setBlockTextureName(Aether.find("cracked_oblitus_stone")));
        ...
        light_angelic_stone = register(
            "light_angelic_stone",
            new BlockDungeonBase(true).setBlockTextureName(Aether.find("light_angelic_stone")));
        ancient_angelic_stone = register(
            "ancient_angelic_stone",
            new BlockDungeonBase(false).setBlockTextureName(Aether.find("ancient_angelic_stone")));
        ancient_light_angelic_stone = register(
            "ancient_light_angelic_stone",
            new BlockDungeonBase(true).setBlockTextureName(Aether.find("ancient_light_angelic_stone")));
        divine_angelic_stone = register(
            "divine_angelic_stone",
            new BlockDungeonBase(false).setBlockTextureName(Aether.find("divine_angelic_stone")));
        divine_light_angelic_stone = register(
            "divine_light_angelic_stone",
            new BlockDungeonBase(true).setBlockTextureName(Aether.find("divine_light_angelic_stone")));
        mythic_angelic_stone = register(
            "mythic_angelic_stone",
            new BlockDungeonBase(false).setBlockTextureName(Aether.find("mythic_angelic_stone")));
        mythic_light_angelic_stone = register(
            "mythic_light_angelic_stone",
            new BlockDungeonBase(true).setBlockTextureName(Aether.find("mythic_light_angelic_stone")));
        ...
        light_hellfire_stone = register(
            ...
            new BlockDungeonBase(true).setBlockTextureName(Aether.find("light_hellfire_stone")));
        ancient_hellfire_stone = register(
            "ancient_hellfire_stone",
            new BlockDungeonBase(false).setBlockTextureName(Aether.find("ancient_hellfire_stone")));
        ancient_light_hellfire_stone = register(
            "ancient_light_hellfire_stone",
            new BlockDungeonBase(true).setBlockTextureName(Aether.find("ancient_light_hellfire_stone")));
        divine_hellfire_stone = register(
            "divine_hellfire_stone",
            new BlockDungeonBase(false).setBlockTextureName(Aether.find("divine_hellfire_stone")));
        divine_light_hellfire_stone = register(
            "divine_light_hellfire_stone",
            new BlockDungeonBase(true).setBlockTextureName(Aether.find("divine_light_hellfire_stone")));

        fuse_stone = register(
            "fuse_stone",
            new BlockDungeonBase(false).setResistance(15.0F)
                .setBlockTextureName(Aether.find("fuse_stone")));
        creeping_stone = register(
            "creeping_stone",
            new BlockDungeonBase(true).setResistance(15.0F)
                .setBlockTextureName(Aether.find("creeping_stone")));
        ...
        crystallized_genesis_stone = register(
            "crystallized_genesis_stone",
            new BlockCrystallizedGenesisStone().setBlockTextureName(Aether.find("crystallized_genesis_stone")));
        ...
        locked_carved_stone = register(
            "locked_carved_stone",
            new BlockDungeonBase(carved_stone, false).setBlockTextureName(Aether.find("carved_stone")))
                .setCreativeTab(null);
        locked_sentry_stone = register(
            "locked_sentry_stone",
            new BlockDungeonBase(sentry_stone, false).setBlockTextureName(Aether.find("sentry_stone")))
                .setCreativeTab(null);
        locked_ancient_carved_stone = register(
            "locked_ancient_carved_stone",
            new BlockDungeonBase(ancient_carved_stone, false).setBlockTextureName(Aether.find("ancient_carved_stone")))
                .setCreativeTab(null);
        locked_ancient_sentry_stone = register(
            "locked_ancient_sentry_stone",
            new BlockDungeonBase(ancient_sentry_stone, false).setBlockTextureName(Aether.find("ancient_sentry_stone")))
                .setCreativeTab(null);
        locked_divine_carved_stone = register(
            "locked_divine_carved_stone",
            new BlockDungeonBase(divine_carved_stone, false).setBlockTextureName(Aether.findII("divineCarvedStone")))
                .setCreativeTab(null);
        locked_divine_sentry_stone = register(
            "locked_divine_sentry_stone",
            new BlockDungeonBase(divine_sentry_stone, false).setBlockTextureName(Aether.findII("divineSentryStone")))
                .setCreativeTab(null);
        locked_mythic_carved_stone = register(
            "locked_mythic_carved_stone",
            new BlockDungeonBase(mythic_carved_stone, false).setBlockTextureName(Aether.find("mythic_carved_stone")))
                .setCreativeTab(null);
        locked_mythic_sentry_stone = register(
            "locked_mythic_sentry_stone",
            new BlockDungeonBase(mythic_sentry_stone, false).setBlockTextureName(Aether.find("mythic_sentry_stone")))
                .setCreativeTab(null);

        locked_angelic_stone = register(
            "locked_angelic_stone",
            new BlockDungeonBase(angelic_stone, false).setBlockTextureName(Aether.find("angelic_stone")))
                .setCreativeTab(null);
        locked_light_angelic_stone = register(
            "locked_light_angelic_stone",
            new BlockDungeonBase(light_angelic_stone, true).setBlockTextureName(Aether.find("light_angelic_stone")))
                .setCreativeTab(null);
        locked_ancient_angelic_stone = register(
            "locked_ancient_angelic_stone",
            new BlockDungeonBase(ancient_angelic_stone, false)
                .setBlockTextureName(Aether.find("ancient_angelic_stone"))).setCreativeTab(null);
        locked_ancient_light_angelic_stone = register(
            "locked_ancient_light_angelic_stone",
            new BlockDungeonBase(ancient_light_angelic_stone, true)
                .setBlockTextureName(Aether.find("ancient_light_angelic_stone"))).setCreativeTab(null);
        locked_divine_angelic_stone = register(
            "locked_divine_angelic_stone",
            new BlockDungeonBase(divine_angelic_stone, false).setBlockTextureName(Aether.find("divine_angelic_stone")))
                .setCreativeTab(null);
        locked_divine_light_angelic_stone = register(
            "locked_divine_light_angelic_stone",
            new BlockDungeonBase(divine_light_angelic_stone, true)
                .setBlockTextureName(Aether.find("divine_light_angelic_stone"))).setCreativeTab(null);
        locked_mythic_angelic_stone = register(
            "locked_mythic_angelic_stone",
            new BlockDungeonBase(mythic_angelic_stone, false).setBlockTextureName(Aether.find("mythic_angelic_stone")))
                .setCreativeTab(null);
        locked_mythic_light_angelic_stone = register(
            "locked_mythic_light_angelic_stone",
            new BlockDungeonBase(mythic_light_angelic_stone, true)
                .setBlockTextureName(Aether.find("mythic_light_angelic_stone"))).setCreativeTab(null);

        locked_hellfire_stone = register(
            "locked_hellfire_stone",
            new BlockDungeonBase(hellfire_stone, false).setBlockTextureName(Aether.find("hellfire_stone")))
                .setCreativeTab(null);
        locked_light_hellfire_stone = register(
            "locked_light_hellfire_stone",
            new BlockDungeonBase(light_hellfire_stone, true).setBlockTextureName(Aether.find("light_hellfire_stone")))
                .setCreativeTab(null);
        locked_ancient_hellfire_stone = register(
            "locked_ancient_hellfire_stone",
            new BlockDungeonBase(ancient_hellfire_stone, false)
                .setBlockTextureName(Aether.find("ancient_hellfire_stone"))).setCreativeTab(null);
        locked_ancient_light_hellfire_stone = register(
            "locked_ancient_light_hellfire_stone",
            new BlockDungeonBase(ancient_light_hellfire_stone, true)
                .setBlockTextureName(Aether.find("ancient_light_hellfire_stone"))).setCreativeTab(null);
        locked_divine_hellfire_stone = register(
            "locked_divine_hellfire_stone",
            new BlockDungeonBase(divine_hellfire_stone, false)
                .setBlockTextureName(Aether.find("divine_hellfire_stone"))).setCreativeTab(null);
        locked_divine_light_hellfire_stone = register(
            "locked_divine_light_hellfire_stone",
            new BlockDungeonBase(divine_light_hellfire_stone, true)
                .setBlockTextureName(Aether.find("divine_light_hellfire_stone"))).setCreativeTab(null);

        // .setResistance(15.0F)
        locked_fuse_stone = register(
            "locked_fuse_stone",
            new BlockDungeonBase(fuse_stone, false).setBlockTextureName(Aether.find("fuse_stone"))).setResistance(15.0F)
                .setCreativeTab(null);
        locked_creeping_stone = register(
            "locked_creeping_stone",
            new BlockDungeonBase(creeping_stone, true).setBlockTextureName(Aether.find("creeping_stone")))
                .setResistance(15.0F)
                .setCreativeTab(null);

        carved_trap = register(
            "carved_trap",
            new BlockDungeonTrap(carved_stone).setBlockTextureName(Aether.find("carved_stone"))).setCreativeTab(null);
        divine_carved_trap = register(
            "divine_carved_trap",
            new BlockDungeonTrap(divine_carved_stone).setBlockTextureName(Aether.findII("divineCarvedStone")))
                .setCreativeTab(null);

        angelic_trap = register(
            "angelic_trap",
            new BlockDungeonTrap(angelic_stone).setBlockTextureName(Aether.find("angelic_stone"))).setCreativeTab(null);
        ancient_angelic_trap = register(
            "ancient_angelic_trap",
            new BlockDungeonTrap(ancient_angelic_stone).setBlockTextureName(Aether.find("ancient_angelic_stone")))
                .setCreativeTab(null);
        divine_angelic_trap = register(
            "divine_angelic_trap",
            new BlockDungeonTrap(divine_angelic_stone).setBlockTextureName(Aether.find("divine_angelic_stone")))
                .setCreativeTab(null);

        fuse_trap = register(
            "fuse_trap",
            new BlockDungeonTrap(locked_fuse_stone).setResistance(15.0F)
                .setBlockTextureName(Aether.find("fuse_stone"))).setCreativeTab(null);
        fuse_trap_2 = register(
            "fuse_trap_2",
            new BlockDungeonTrap2(locked_creeping_stone).setResistance(15.0F)
                .setBlockTextureName(Aether.find("creeping_stone"))).setCreativeTab(null);

        hellfire_trap = register(
            "hellfire_trap",
            new BlockDungeonTrap(hellfire_stone).setBlockTextureName(Aether.find("hellfire_stone")))
                .setCreativeTab(null);
        genesis_trap = register(
            "genesis_trap",
            new BlockDungeonTrap(genesis_stone).setBlockTextureName(Aether.find("genesis_stone"))).setCreativeTab(null);
        ...
        enchanted_agiosite_brick_wall = register(
            "enchanted_agiosite_brick_wall",
            new BlockAetherWall(enchanted_agiosite_bricks));
        ...
        enchanted_aetheral_stone_wall = register(
            "enchanted_aetheral_stone_wall",
            new BlockAetherWall(enchanted_aetheral_stone));
        enchanted_aetheral_stone_brick_wall = register(
            "enchanted_aetheral_stone_brick_wall",
            new BlockAetherWall(enchanted_aetheral_stone_bricks));
        ...
        enchanted_deific_brick_wall = register(
            "enchanted_deific_brick_wall",
            new BlockAetherWall(enchanted_deific_bricks));
        enchanted_holystone_wall = register("enchanted_holystone_wall", new BlockAetherWall(enchanted_holystone));
        enchanted_holystone_brick_wall = register(
            "enchanted_holystone_brick_wall",
            new BlockAetherWall(enchanted_holystone_bricks));
        caelestia_stone_wall = register("caelestia_stone_wall", new BlockAetherWall(caelestia_stone));
        carved_caelestia_stone_wall = register(
            "carved_caelestia_stone_wall",
            new BlockAetherWall(carved_caelestia_stone));
        ...
        divine_hellfire_stone_stairs = register(
            "divine_hellfire_stone_stairs",
            new BlockAetherStairs(divine_hellfire_stone));
        ...
        enchanted_agiosite_brick_stairs = register(
            "enchanted_agiosite_brick_stairs",
            new BlockAetherStairs(enchanted_agiosite_bricks));
        ...
        aetheral_stone_brick_stairs = register(
            "aetheral_stone_bricks_stairs",
            new BlockAetherStairs(aetheral_stone_bricks));
        enchanted_aetheral_stone_stairs = register(
            "enchanted_aetheral_stone_stairs",
            new BlockAetherStairs(enchanted_aetheral_stone));
        enchanted_aetheral_stone_brick_stairs = register(
            "enchanted_aetheral_stone_brick_stairs",
            new BlockAetherStairs(enchanted_aetheral_stone_bricks));
        ...
        enchanted_deific_brick_stairs = register(
            "enchanted_deific_brick_stairs",
            new BlockAetherStairs(enchanted_deific_bricks));
        enchanted_holystone_stairs = register("enchanted_holystone_stairs", new BlockAetherStairs(enchanted_holystone));
        enchanted_holystone_brick_stairs = register(
            "enchanted_holystone_brick_stairs",
            new BlockAetherStairs(enchanted_holystone_bricks));
        caelestia_stone_stairs = register("caelestia_stone_stairs", new BlockAetherStairs(caelestia_stone));
        carved_caelestia_stone_stairs = register(
            "carved_caelestia_stone_stairs",
            new BlockAetherStairs(carved_caelestia_stone));
        ancient_carved_stone_stairs = register(
            "ancient_carved_stone_stairs",
            new BlockAetherStairs(ancient_carved_stone));
        ...
        ancient_angelic_stone_stairs = register(
            "ancient_angelic_stone_stairs",
            new BlockAetherStairs(ancient_angelic_stone));
        divine_angelic_stone_stairs = register(
            "divine_angelic_stone_stairs",
            new BlockAetherStairs(divine_angelic_stone));
        mythic_angelic_stone_stairs = register(
            "mythic_angelic_stone_stairs",
            new BlockAetherStairs(mythic_angelic_stone));

        skyroot_double_slab = register(
            "skyroot_double_slab",
            new BlockAetherSlab("skyroot_double_slab", true, Material.wood)
                .setBlockTextureName(Aether.find("skyroot_planks"))
                .setHardness(2.0F)
                .setResistance(5.0F)).setCreativeTab(null);
        carved_double_slab = register(
            "carved_double_slab",
            new BlockAetherSlab("carved_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("carved_stone"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        angelic_double_slab = register(
            "angelic_double_slab",
            new BlockAetherSlab("angelic_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("angelic_stone"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        hellfire_double_slab = register(
            ...
            new BlockAetherSlab("hellfire_double_slab", true, Material.rock)
                ...
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        holystone_double_slab = register(
            ...
            new BlockAetherSlab("holystone_double_slab", true, Material.rock)
                ...
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        mossy_holystone_double_slab = register(
            ...
            new BlockAetherSlab("mossy_holystone_double_slab", true, Material.rock)
                ...
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        holystone_brick_double_slab = register(
            ...
            new BlockAetherSlab("holystone_brick_double_slab", true, Material.rock)
                ...
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        aerogel_double_slab = register(
            "aerogel_double_slab",
            new BlockAetherSlab("aerogel_double_slab", true, Material.rock).setBlockTextureName(Aether.find("aerogel"))
                .setHardness(2.0F)
                .setResistance(2000F)
                .setLightOpacity(3)
        ...
        skyroot_slab = registerSlab(
            "skyroot_slab",
            new BlockAetherSlab("skyroot_slab", false, Material.wood).setBlockTextureName(Aether.find("skyroot_planks"))
                .setHardness(2.0F)
                .setResistance(5.0F),
            skyroot_double_slab);
        carved_slab = registerSlab(
            "carved_slab",
            new BlockAetherSlab("carved_slab", false, Material.rock).setBlockTextureName(Aether.find("carved_stone"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            carved_double_slab);
        angelic_slab = registerSlab(
            "angelic_slab",
            new BlockAetherSlab("angelic_slab", false, Material.rock).setBlockTextureName(Aether.find("angelic_stone"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            angelic_double_slab);
        hellfire_slab = registerSlab(
            ...
            new BlockAetherSlab("hellfire_slab", false, Material.rock)
                ...
                .setResistance(10.0F),
            hellfire_double_slab);
        fuse_double_slab = register(
            "fuse_double_slab",
            new BlockAetherSlab("fuse_double_slab", true, Material.rock).setBlockTextureName(Aether.find("fuse_stone"))
                .setHardness(0.5F)
                .setResistance(10.0F)).setCreativeTab(null);
        fuse_slab = registerSlab(
            "fuse_slab",
            new BlockAetherSlab("fuse_slab", false, Material.rock).setBlockTextureName(Aether.find("fuse_stone"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            fuse_double_slab);
        holystone_slab = registerSlab(
            "holystone_slab",
            new BlockAetherSlab("holystone_slab", false, Material.rock).setBlockTextureName(Aether.find("holystone"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            holystone_double_slab);
        ...
        aerogel_slab = registerSlab(
            "aerogel_slab",
            new BlockAetherSlab("aerogel_slab", false, Material.rock).setBlockTextureName(Aether.find("aerogel"))
                .setHardness(0.5F)
                .setResistance(2000F)
                .setLightOpacity(3)
        ...
        genesis_double_slab = register(
            "genesis_double_slab",
            new BlockAetherSlab("genesis_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("genesis_stone"))
                .setHardness(3.5F)
                .setResistance(20.0F)).setCreativeTab(null);
        genesis_slab = registerSlab(
            "genesis_slab",
            new BlockAetherSlab("genesis_slab", false, Material.rock).setBlockTextureName(Aether.find("genesis_stone"))
                .setHardness(3.5F)
                .setResistance(20.0F),
            genesis_double_slab);
        agiosite_double_slab = register(
            "agiosite_double_slab",
            new BlockAetherSlab("agiosite_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("agiosite"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        agiosite_slab = registerSlab(
            "agiosite_slab",
            new BlockAetherSlab("agiosite_slab", false, Material.rock).setBlockTextureName(Aether.find("agiosite"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            agiosite_double_slab);
        agiosite_brick_double_slab = register(
            "agiosite_brick_double_slab",
            new BlockAetherSlab("agiosite_brick_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("agiosite_stone_bricks"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        agiosite_brick_slab = registerSlab(
            "agiosite_brick_slab",
            new BlockAetherSlab("agiosite_brick_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("agiosite_stone_bricks"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            agiosite_brick_double_slab);
        enchanted_agiosite_double_slab = register(
            "enchanted_agiosite_double_slab",
            new BlockAetherSlab("enchanted_agiosite_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("enchanted_agiosite"))
                .setHardness(4.0F)
                .setResistance(6.0F)).setCreativeTab(null);
        enchanted_agiosite_slab = registerSlab(
            "enchanted_agiosite_slab",
            new BlockAetherSlab("enchanted_agiosite_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("enchanted_agiosite"))
                .setHardness(4.0F)
                .setResistance(6.0F),
            enchanted_agiosite_double_slab);
        enchanted_agiosite_brick_double_slab = register(
            "enchanted_agiosite_brick_double_slab",
            new BlockAetherSlab("enchanted_agiosite_brick_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("enchanted_agiosite_stone_bricks"))
                .setHardness(4.0F)
                .setResistance(6.0F)).setCreativeTab(null);
        enchanted_agiosite_brick_slab = registerSlab(
            "enchanted_agiosite_brick_slab",
            new BlockAetherSlab("enchanted_agiosite_brick_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("enchanted_agiosite_stone_bricks"))
                .setHardness(4.0F)
                .setResistance(6.0F),
            enchanted_agiosite_brick_double_slab);
        aetheral_stone_double_slab = register(
            "aetheral_stone_double_slab",
            new BlockAetherSlab("aetheral_stone_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("aetheral_stone"))
                .setHardness(3.0F)
                .setResistance(5.0F)).setCreativeTab(null);
        aetheral_stone_slab = registerSlab(
            "aetheral_stone_slab",
            new BlockAetherSlab("aetheral_stone_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("aetheral_stone"))
                .setHardness(3.0F)
                .setResistance(5.0F),
            aetheral_stone_double_slab);
        aetheral_stone_brick_double_slab = register(
            "aetheral_stone_brick_double_slab",
            new BlockAetherSlab("aetheral_stone_brick_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("aetheral_stone_brick"))
                .setHardness(3.0F)
                .setResistance(5.0F)).setCreativeTab(null);
        aetheral_stone_brick_slab = registerSlab(
            "aetheral_stone_brick_slab",
            new BlockAetherSlab("aetheral_stone_brick_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("aetheral_stone_brick"))
                .setHardness(3.0F)
                .setResistance(5.0F),
            aetheral_stone_brick_double_slab);
        enchanted_aetheral_stone_double_slab = register(
            "enchanted_aetheral_stone_double_slab",
            new BlockAetherSlab("enchanted_aetheral_stone_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("enchanted_aetheral_stone"))
                .setHardness(3.0F)
                .setResistance(5.0F)).setCreativeTab(null);
        enchanted_aetheral_stone_slab = registerSlab(
            "enchanted_aetheral_stone_slab",
            new BlockAetherSlab("enchanted_aetheral_stone_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("enchanted_aetheral_stone"))
                .setHardness(3F)
                .setResistance(5.0F),
            enchanted_aetheral_stone_double_slab);
        enchanted_aetheral_stone_brick_double_slab = register(
            "enchanted_aetheral_stone_brick_double_slab",
            new BlockAetherSlab("enchanted_aetheral_stone_brick_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("enchanted_aetheral_stone_brick"))
                .setHardness(3.0F)
                .setResistance(5.0F)).setCreativeTab(null);
        enchanted_aetheral_stone_brick_slab = registerSlab(
            "enchanted_aetheral_stone_brick_slab",
            new BlockAetherSlab("enchanted_aetheral_stone_brick_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("enchanted_aetheral_stone_brick"))
                .setHardness(3.0F)
                .setResistance(5.0F),
            enchanted_aetheral_stone_brick_double_slab);
        caelestia_stone_double_slab = register(
            "caelestia_stone_double_slab",
            new BlockAetherSlab("caelestia_stone_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("caelestia_stone"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        caelestia_stone_slab = registerSlab(
            "caelestia_stone_slab",
            new BlockAetherSlab("caelestia_stone_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("caelestia_stone"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            caelestia_stone_double_slab);
        carved_caelestia_stone_double_slab = register(
            "carved_caelestia_stone_double_slab",
            new BlockAetherSlab("carved_caelestia_stone_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("carved_caelestia_stone_top"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        carved_caelestia_stone_slab = registerSlab(
            "carved_caelestia_stone_slab",
            new BlockAetherSlab("carved_caelestia_stone_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("carved_caelestia_stone_top"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            carved_caelestia_stone_double_slab);
        ancient_carved_stone_double_slab = register(
            "ancient_carved_stone_double_slab",
            new BlockAetherSlab("ancient_carved_stone_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("ancient_carved_stone"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        ancient_carved_stone_slab = registerSlab(
            "ancient_carved_stone_slab",
            new BlockAetherSlab("ancient_carved_stone_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("ancient_carved_stone"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            ancient_carved_stone_double_slab);
        divine_carved_stone_double_slab = register(
            "divine_carved_stone_double_slab",
            new BlockAetherSlab("divine_carved_stone_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.findII("divineCarvedStone"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        divine_carved_stone_slab = registerSlab(
            "divine_carved_stone_slab",
            new BlockAetherSlab("divine_carved_stone_slab", false, Material.rock)
                .setBlockTextureName(Aether.findII("divineCarvedStone"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            divine_carved_stone_double_slab);

        mythic_carved_stone_double_slab = register(
            "mythic_carved_stone_double_slab",
            new BlockAetherSlab("mythic_carved_stone_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("mythic_carved_stone"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        mythic_carved_stone_slab = registerSlab(
            "mythic_carved_stone_slab",
            new BlockAetherSlab("mythic_carved_stone_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("mythic_carved_stone"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            mythic_carved_stone_double_slab);
        ancient_angelic_stone_double_slab = register(
            "ancient_angelic_stone_double_slab",
            new BlockAetherSlab("ancient_angelic_stone_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("ancient_angelic_stone"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        ancient_angelic_stone_slab = registerSlab(
            "ancient_angelic_stone_slab",
            new BlockAetherSlab("ancient_angelic_stone_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("ancient_angelic_stone"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            ancient_angelic_stone_double_slab);
        divine_angelic_stone_double_slab = register(
            "divine_angelic_stone_double_slab",
            new BlockAetherSlab("divine_angelic_stone_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("divine_angelic_stone"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        divine_angelic_stone_slab = registerSlab(
            "divine_angelic_stone_slab",
            new BlockAetherSlab("divine_angelic_stone_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("divine_angelic_stone"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            divine_angelic_stone_double_slab);
        mythic_angelic_stone_double_slab = register(
            "mythic_angelic_stone_double_slab",
            new BlockAetherSlab("mythic_angelic_stone_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("mythic_angelic_stone"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        mythic_angelic_stone_slab = registerSlab(
            "mythic_angelic_stone_slab",
            new BlockAetherSlab("mythic_angelic_stone_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("mythic_angelic_stone"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            mythic_angelic_stone_double_slab);
        ancient_hellfire_stone_double_slab = register(
            "ancient_hellfire_stone_double_slab",
            new BlockAetherSlab("ancient_hellfire_stone_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("ancient_hellfire_stone"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        ancient_hellfire_stone_slab = registerSlab(
            "ancient_hellfire_stone_slab",
            new BlockAetherSlab("ancient_hellfire_stone_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("ancient_hellfire_stone"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            ancient_hellfire_stone_double_slab);
        divine_hellfire_stone_double_slab = register(
            "divine_hellfire_stone_double_slab",
            new BlockAetherSlab("divine_hellfire_stone_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("divine_hellfire_stone"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        divine_hellfire_stone_slab = registerSlab(
            "divine_hellfire_stone_slab",
            new BlockAetherSlab("divine_hellfire_stone_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("divine_hellfire_stone"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            divine_hellfire_stone_double_slab);
        oblitus_stone_double_slab = register(
            "oblitus_stone_double_slab",
            new BlockAetherSlab("oblitus_stone_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("oblitus_stone"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        oblitus_stone_slab = registerSlab(
            "oblitus_stone_slab",
            new BlockAetherSlab("oblitus_stone_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("oblitus_stone"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            oblitus_stone_double_slab);

        golden_oak_double_slab = register(
            "golden_oak_double_slab",
            new BlockAetherSlab("golden_oak_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("golden_oak_planks"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        golden_oak_slab = registerSlab(
            "golden_oak_slab",
            new BlockAetherSlab("golden_oak_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("golden_oak_planks"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            golden_oak_double_slab);

        divine_oak_double_slab = register(
            "divine_oak_double_slab",
            new BlockAetherSlab("divine_oak_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("divine_oak_planks"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        divine_oak_slab = registerSlab(
            "divine_oak_slab",
            new BlockAetherSlab("divine_oak_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("divine_oak_planks"))
                .setHardness(0.5F)
                .setResistance(10.0F),
            divine_oak_double_slab);

        greatroot_double_slab = register(
            "greatroot_double_slab",
            new BlockAetherSlab("greatroot_double_slab", true, Material.wood)
                .setBlockTextureName(Aether.find("greatroot_planks"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        greatroot_slab = registerSlab(
            "greatroot_slab",
            new BlockAetherSlab("greatroot_slab", false, Material.wood)
                .setBlockTextureName(Aether.find("greatroot_planks"))
                .setHardness(2.0F)
                .setResistance(5.0F),
            greatroot_double_slab);
        wisproot_double_slab = register(
            "wisproot_double_slab",
            new BlockAetherSlab("wisproot_double_slab", true, Material.wood)
                .setBlockTextureName(Aether.find("wisproot_planks"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        wisproot_slab = registerSlab(
            "wisproot_slab",
            new BlockAetherSlab("wisproot_slab", false, Material.wood)
                .setBlockTextureName(Aether.find("wisproot_planks"))
                .setHardness(2.0F)
                .setResistance(5.0F),
            wisproot_double_slab);
        void_double_slab = register(
            "void_double_slab",
            new BlockAetherSlab("void_double_slab", true, Material.wood).setBlockTextureName(Aether.find("void_planks"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        void_slab = registerSlab(
            "void_slab",
            new BlockAetherSlab("void_slab", false, Material.wood).setBlockTextureName(Aether.find("void_planks"))
                .setHardness(2.0F)
                .setResistance(5.0F),
            void_double_slab);

        deific_double_slab = register(
            "deific_double_slab",
            new BlockAetherSlab("deific_double_slab", true, Material.rock).setBlockTextureName(Aether.find("deific"))
                .setHardness(5.5F)
                .setResistance(7.0F)).setCreativeTab(null);
        deific_slab = registerSlab(
            "deific_slab",
            new BlockAetherSlab("deific_slab", false, Material.rock).setBlockTextureName(Aether.find("deific"))
                .setHardness(5.5F)
                .setResistance(7.0F),
            deific_double_slab);
        deific_brick_double_slab = register(
            "deific_brick_double_slab",
            new BlockAetherSlab("deific_brick_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("deific_bricks"))
                .setHardness(5.5F)
                .setResistance(7.0F)).setCreativeTab(null);
        deific_brick_slab = registerSlab(
            "deific_brick_slab",
            new BlockAetherSlab("deific_brick_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("deific_bricks"))
                .setHardness(5.5F)
                .setResistance(7.0F),
            deific_brick_double_slab);
        enchanted_deific_double_slab = register(
            "enchanted_deific_double_slab",
            new BlockAetherSlab("enchanted_deific_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("enchanted_deific"))
                .setHardness(5.5F)
                .setResistance(7.0F)).setCreativeTab(null);
        enchanted_deific_slab = registerSlab(
            "enchanted_deific_slab",
            new BlockAetherSlab("enchanted_deific_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("enchanted_deific"))
                .setHardness(5.5F)
                .setResistance(7.0F),
            enchanted_deific_double_slab);
        enchanted_deific_brick_double_slab = register(
            "enchanted_deific_brick_double_slab",
            new BlockAetherSlab("enchanted_deific_brick_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("enchanted_deific_bricks"))
                .setHardness(5.5F)
                .setResistance(7.0F)).setCreativeTab(null);
        enchanted_deific_brick_slab = registerSlab(
            "enchanted_deific_brick_slab",
            new BlockAetherSlab("enchanted_deific_brick_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("enchanted_deific_bricks"))
                .setHardness(5.5F)
                .setResistance(7.0F),
            enchanted_deific_brick_double_slab);
        enchanted_holystone_double_slab = register(
            "enchanted_holystone_double_slab",
            new BlockAetherSlab("enchanted_holystone_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.findHighlands("agiosite"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        enchanted_holystone_slab = registerSlab(
            "enchanted_holystone_slab",
            new BlockAetherSlab("enchanted_holystone_slab", false, Material.rock)
                .setBlockTextureName(Aether.findHighlands("agiosite"))
                .setHardness(2.0F)
                .setResistance(5.0F),
            enchanted_holystone_double_slab);
        enchanted_holystone_brick_double_slab = register(
            "enchanted_holystone_brick_double_slab",
            new BlockAetherSlab("enchanted_holystone_brick_double_slab", true, Material.rock)
                .setBlockTextureName(Aether.find("enchanted_holystone_bricks"))
                .setHardness(2.0F)
                .setResistance(10.0F)).setCreativeTab(null);
        enchanted_holystone_brick_slab = registerSlab(
            "enchanted_holystone_brick_slab",
            new BlockAetherSlab("enchanted_holystone_brick_slab", false, Material.rock)
                .setBlockTextureName(Aether.find("enchanted_holystone_bricks"))
                .setHardness(2.0F)
                .setResistance(5.0F),
            enchanted_holystone_brick_double_slab);
    ...
    public static Block registerItemBlock(String name, final Block block,
