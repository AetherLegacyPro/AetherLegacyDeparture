...
public class BlocksAether {
	...
	public static void initialization() {
		...
		purple_skyroot_fruit_leaves = register("purple_skyroot_fruit_leaves", new BlockAetherLeaves().setBlockTextureName(Aether.findII("Purple Fruit Leaves")));
		purple_skyroot_leaves = register("purple_skyroot_leaves", new BlockAetherLeaves().setBlockTextureName(Aether.findII("Purple Crystal Leaves")));
		blue_skyroot_leaves = register("blue_skyroot_leaves", new BlockAetherLeaves().setBlockTextureName(Aether.findII("blueSkyrootLeaves")));
		dark_blue_skyroot_leaves = register("dark_blue_skyroot_leaves", new BlockAetherLeaves().setBlockTextureName(Aether.findII("darkBlueSkyrootLeaves")));
		...
		purple_skyroot_sapling = register("purple_skyroot_sapling", new BlockAetherSapling(new AetherGenPurpleSkyrootTree(false)).setBlockTextureName(Aether.findII("purpleCrystalSapling")));
		blue_skyroot_sapling = register("blue_skyroot_sapling", new BlockAetherSapling(new AetherGenBlueSkyrootTree(false)).setBlockTextureName(Aether.findII("blueSkyrootSapling")));
		dark_blue_skyroot_sapling = register("dark_blue_skyroot_sapling", new BlockAetherSapling(new AetherGenDarkBlueSkyrootTree(false)).setBlockTextureName(Aether.findII("darkBlueSkyrootSapling")));
