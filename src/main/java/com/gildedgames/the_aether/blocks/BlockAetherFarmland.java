...
public class BlockAetherFarmland extends Block {
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World p_149668_1_, int p_149668_2_, int p_149668_3_,
        ...
        return AxisAlignedBB
            .getBoundingBox(p_149668_2_, p_149668_3_, p_149668_4_, p_149668_2_ + 1, p_149668_3_ + 1, p_149668_4_ + 1);
    }
    ...
    public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
        return p_149691_1_ == 1 ? (p_149691_2_ > 0 ? this.field_149824_a : this.field_149823_b)
            : BlocksAether.aether_dirt.getBlockTextureFromSide(p_149691_1_);
    }
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
        if (!this.func_149821_m(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_)
            ...
            if (l > 0) {
                ...
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, BlocksAether.aether_dirt);
            }
        } else {
    ...
    public void onFallenUpon(World p_149746_1_, int p_149746_2_, int p_149746_3_, int p_149746_4_, Entity p_149746_5_,
        ...
        if (!p_149746_1_.isRemote && p_149746_1_.rand.nextFloat() < p_149746_6_ - 0.5F) {
            ...
            p_149746_1_.setBlock(p_149746_2_, p_149746_3_, p_149746_4_, BlocksAether.aether_dirt);
        }
    }
    ...
    private boolean func_149822_e(World p_149822_1_, int p_149822_2_, int p_149822_3_, int p_149822_4_) {
        ...
        for (int l = p_149822_2_ - b0; l <= p_149822_2_ + b0; ++l) {
            for (int i1 = p_149822_4_ - b0; i1 <= p_149822_4_ + b0; ++i1) {
                ...
                if (block instanceof IPlantable && canSustainPlant(
                    p_149822_1_,
                    p_149822_2_,
                    p_149822_3_,
                    p_149822_4_,
        ...
        for (int l = p_149821_2_ - 4; l <= p_149821_2_ + 4; ++l) {
            for (int i1 = p_149821_3_; i1 <= p_149821_3_ + 1; ++i1) {
                for (int j1 = p_149821_4_ - 4; j1 <= p_149821_4_ + 4; ++j1) {
                    if (p_149821_1_.getBlock(l, i1, j1)
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_,
        ...
        Material material = p_149695_1_.getBlock(p_149695_2_, p_149695_3_ + 1, p_149695_4_)
            .getMaterial();

        if (material.isSolid()) {
            p_149695_1_.setBlock(p_149695_2_, p_149695_3_, p_149695_4_, BlocksAether.aether_dirt);
        }
    }

    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
        return BlocksAether.aether_dirt.getItemDropped(0, p_149650_2_, p_149650_3_);
    }
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        this.field_149824_a = p_149651_1_.registerIcon("aether_legacy:aether_farmland_wet");
        this.field_149823_b = p_149651_1_.registerIcon("aether_legacy:aether_farmland_dry");
    }
}
