...
public class BlockAetherFarmland extends Block {
    ...
    public void onFallenUpon(World world, int p_149746_2_, int p_149746_3_, int p_149746_4_, Entity entity, float p_149746_6_) {
        if (!world.isRemote && world.rand.nextFloat() < p_149746_6_ - 0.5F) {
            ...
            world.setBlock(p_149746_2_, p_149746_3_, p_149746_4_, BlocksAether.aether_dirt);
        }
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        this.field_149824_a = iconRegister.registerIcon("aether_legacy:aether_farmland_wet");
        this.field_149823_b = iconRegister.registerIcon("aether_legacy:aether_farmland_dry");
    }
}
