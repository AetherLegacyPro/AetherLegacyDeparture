...
public class BlockDivineEnchantmentTable extends BlockEnchantmentTable {
    ...
    public boolean onBlockActivated(final World world, final int x, final int y, final int z, final EntityPlayer player,
        ...
        if (world.getBlock(x + 2, y, z - 1) == BlocksAether.golden_oak_bookshelf
            ...
            && ((world.getBlock(x + 2, y, z) == BlocksAether.golden_oak_bookshelf
                && world.getBlock(x - 2, y, z) == BlocksAether.golden_oak_bookshelf
                && world.getBlock(x, y, z + 2) == BlocksAether.golden_oak_bookshelf))
            || (world.getBlock(x + 2, y, z) == BlocksAether.golden_oak_bookshelf
                && world.getBlock(x - 2, y, z) == BlocksAether.golden_oak_bookshelf
                && world.getBlock(x, y, z - 2) == BlocksAether.golden_oak_bookshelf)
            || (world.getBlock(x + 2, y, z) == BlocksAether.golden_oak_bookshelf
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_,
        ...
        if (p_149689_6_.hasDisplayName()) {
            ((TileEntityDivineEnchantmentTable) p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_))
