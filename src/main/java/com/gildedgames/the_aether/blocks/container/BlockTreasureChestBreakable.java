...
public class BlockTreasureChestBreakable extends BlockContainer
{
  ...
  public void onBlockPlacedBy(final World par1World, final int par2, final int par3, final int par4, final EntityLivingBase par5EntityLivingBase, final ItemStack par6ItemStack) {
      ...
      if (par6ItemStack.hasDisplayName()) {
          ((TileEntityTreasureChestBreakable)par1World.getTileEntity(par2, par3, par4)).setChestGuiName(par6ItemStack.getDisplayName());
      }
  }
  ...
  public void onNeighborBlockChange(final World par1World, final int par2, final int par3, final int par4, final Block par5) {
      ...
      final TileEntityTreasureChestBreakable TileEntitySkyrootChest = (TileEntityTreasureChestBreakable)par1World.getTileEntity(par2, par3, par4);
  ...
  public IInventory getInventory(final World par1World, final int par2, final int par3, final int par4) {
      ...
      if (par1World.getBlock(par2 - 1, par3, par4) == this) {
          object = new InventoryLargeTreasureChestBreakable("container.chestDouble", (IInventory)par1World.getTileEntity(par2 - 1, par3, par4), (IInventory)object);
      }
      if (par1World.getBlock(par2 + 1, par3, par4) == this) {
          object = new InventoryLargeTreasureChestBreakable("container.chestDouble", (IInventory)object, (IInventory)par1World.getTileEntity(par2 + 1, par3, par4));
      }
      if (par1World.getBlock(par2, par3, par4 - 1) == this) {
          object = new InventoryLargeTreasureChestBreakable("container.chestDouble", (IInventory)par1World.getTileEntity(par2, par3, par4 - 1), (IInventory)object);
      }
      if (par1World.getBlock(par2, par3, par4 + 1) == this) {
          object = new InventoryLargeTreasureChestBreakable("container.chestDouble", (IInventory)object, (IInventory)par1World.getTileEntity(par2, par3, par4 + 1));
      }
