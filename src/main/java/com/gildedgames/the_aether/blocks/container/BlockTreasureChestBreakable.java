...
public class BlockTreasureChestBreakable extends BlockContainer {
    ...
    public void onBlockPlacedBy(final World par1World, final int par2, final int par3, final int par4,
        ...
        if (par6ItemStack.hasDisplayName()) {
            ((TileEntityTreasureChestBreakable) par1World.getTileEntity(par2, par3, par4))
    ...
    public boolean canPlaceBlockAt(final World par1World, final int par2, final int par3, final int par4) {
        ...
        return l <= 1 && !this.isThereANeighborChest(par1World, par2 - 1, par3, par4)
    ...
    public void onNeighborBlockChange(final World par1World, final int par2, final int par3, final int par4,
        ...
        final TileEntityTreasureChestBreakable TileEntitySkyrootChest = (TileEntityTreasureChestBreakable) par1World
    ...
    public IInventory getInventory(final World par1World, final int par2, final int par3, final int par4) {
        ...
        if (par1World.getBlock(par2 - 1, par3, par4) == this) {
            object = new InventoryLargeTreasureChestBreakable(
                "container.chestDouble",
                (IInventory) par1World.getTileEntity(par2 - 1, par3, par4),
                (IInventory) object);
        }
        if (par1World.getBlock(par2 + 1, par3, par4) == this) {
            object = new InventoryLargeTreasureChestBreakable(
        ...
        if (par1World.getBlock(par2, par3, par4 - 1) == this) {
            object = new InventoryLargeTreasureChestBreakable(
                "container.chestDouble",
                (IInventory) par1World.getTileEntity(par2, par3, par4 - 1),
                (IInventory) object);
        }
        if (par1World.getBlock(par2, par3, par4 + 1) == this) {
            object = new InventoryLargeTreasureChestBreakable(
    ...
    public int isProvidingWeakPower(final IBlockAccess par1IBlockAccess, final int par2, final int par3, final int par4,
        final int par5) {
        if (!this.canProvidePower()) {
            return 0;
        }
        final int i1 = ((TileEntityTreasureChestBreakable) par1IBlockAccess
            .getTileEntity(par2, par3, par4)).numUsingPlayers;
        return MathHelper.clamp_int(i1, 0, 15);
    }

    public int isProvidingStrongPower(final IBlockAccess par1IBlockAccess, final int par2, final int par3,
