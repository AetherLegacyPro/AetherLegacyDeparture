...
public class BlockElysianChest extends BlockContainer {
    ...
    public void onBlockPlacedBy(final World par1World, final int par2, final int par3, final int par4,
        ...
        if (par6ItemStack.hasDisplayName()) {
            ((TileEntityElysianChest) par1World.getTileEntity(par2, par3, par4))
    ...
    public void onNeighborBlockChange(final World par1World, final int par2, final int par3, final int par4,
        ...
        final TileEntityElysianChest TileEntitySkyrootChest = (TileEntityElysianChest) par1World
    ...
    public IInventory getInventory(final World par1World, final int par2, final int par3, final int par4) {
        ...
        if (par1World.getBlock(par2 - 1, par3, par4) == this) {
            object = new InventoryLargeElysianChest(
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_,
        ...
        if (p_149734_5_.nextInt(15) == 0) {
            NewAetherParticleHandler.ELYSIAN_TELEPORT.spawn(
                p_149734_1_,
                p_149734_2_ + p_149734_5_.nextFloat(),
                p_149734_3_ + 0.1f,
