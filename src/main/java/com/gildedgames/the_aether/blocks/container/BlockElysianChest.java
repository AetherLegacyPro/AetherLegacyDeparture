...
public class BlockElysianChest extends BlockContainer {
  ...
  public void onBlockPlacedBy(final World world, final int par2, final int par3, final int par4, final EntityLivingBase par5EntityLivingBase, final ItemStack par6ItemStack) {
      ...
      if (par6ItemStack.hasDisplayName()) {
          ((TileEntityElysianChest)world.getTileEntity(par2, par3, par4)).setChestGuiName(par6ItemStack.getDisplayName());
      }
  }
  ...
  public void onNeighborBlockChange(final World world, final int par2, final int par3, final int par4, final Block par5) {
      ...
      final TileEntityElysianChest TileEntitySkyrootChest = (TileEntityElysianChest)world.getTileEntity(par2, par3, par4);
  ...
  public IInventory getInventory(final World world, final int par2, final int par3, final int par4) {
      ...
      if (world.getBlock(par2 - 1, par3, par4) == this) {
          object = new InventoryLargeElysianChest("container.chestDouble", (IInventory)world.getTileEntity(par2 - 1, par3, par4), (IInventory)object);
      }
      if (world.getBlock(par2 + 1, par3, par4) == this) {
          object = new InventoryLargeElysianChest("container.chestDouble", (IInventory)object, (IInventory)world.getTileEntity(par2 + 1, par3, par4));
      }
      if (world.getBlock(par2, par3, par4 - 1) == this) {
          object = new InventoryLargeElysianChest("container.chestDouble", (IInventory)world.getTileEntity(par2, par3, par4 - 1), (IInventory)object);
      }
      if (world.getBlock(par2, par3, par4 + 1) == this) {
          object = new InventoryLargeElysianChest("container.chestDouble", (IInventory)object, (IInventory)world.getTileEntity(par2, par3, par4 + 1));
      }
