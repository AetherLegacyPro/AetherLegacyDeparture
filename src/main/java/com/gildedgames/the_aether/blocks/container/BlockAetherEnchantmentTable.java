...
public class BlockAetherEnchantmentTable extends BlockEnchantmentTable {
    ...
    public IIcon getIcon(final int par1, final int par2) {
        return (par1 == 1) ? this.field_94385_a
            : ((par1 == 0) ? BlocksAether.aerogel.getBlockTextureFromSide(par1)
                : ((par1 != 2 && par1 != 4) ? this.blockIcon : this.field_94384_b));
    }
            ...
            for (int i1 = p_149734_4_ - 2; i1 <= p_149734_4_ + 2; ++i1) {
                ...
                if (p_149734_5_.nextInt(16) == 0) {
                    for (int j1 = p_149734_3_; j1 <= p_149734_3_ + 1; ++j1) {
                        if (p_149734_1_.getBlock(l, j1, i1) == BlocksAether.skyroot_bookshelf
                            || p_149734_1_.getBlock(l, j1, i1) == BlocksAether.golden_oak_bookshelf) {
                            if (!p_149734_1_.isAirBlock(
                                (l - p_149734_2_) / 2 + p_149734_2_,
                                j1,
                            ...
                            p_149734_1_.spawnParticle(
                                "enchantmenttable",
                                (double) p_149734_2_ + 0.5D,
                                (double) p_149734_3_ + 2.0D,
                                (double) p_149734_4_ + 0.5D,
                                (double) ((float) (l - p_149734_2_) + p_149734_5_.nextFloat()) - 0.5D,
                                (float) (j1 - p_149734_3_) - p_149734_5_.nextFloat() - 1.0F,
                                (double) ((float) (i1 - p_149734_4_) + p_149734_5_.nextFloat()) - 0.5D);
                        }
                    }
                }
            }
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_,
        ...
        if (p_149689_6_.hasDisplayName()) {
            ((TileEntityAetherEnchantmentTable) p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_))
