...
public class BlockStrawberryBush extends BlockAetherFlower {

	public BlockStrawberryBush() {
		this.setHardness(0.2F);
		this.setHarvestLevel("axe", 0);
		this.setStepSound(soundTypeGrass);
		this.setBlockTextureName(Aether.find("strawberry_bush"));
	...
	public void harvestBlock(World world, EntityPlayer entityplayer, int x, int y, int z, int meta) {
		...
		world.setBlock(x, y, z, BlocksAether.small_strawberry_bush);

		if (randomNum != 0) {
			this.dropBlockAsItem(world, x, y, z, new ItemStack(ItemsAether.strawberry, randomNum, 0));
		}
	}
