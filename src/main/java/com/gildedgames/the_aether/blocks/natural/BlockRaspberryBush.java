...
public class BlockRaspberryBush extends BlockAetherFlower {

	public BlockRaspberryBush() {
		this.setHardness(0.2F);
		this.setHarvestLevel("axe", 0);
		this.setStepSound(soundTypeGrass);
		this.setBlockTextureName(Aether.find("raspberry_bush"));
	...
	public void harvestBlock(World world, EntityPlayer entityplayer, int x, int y, int z, int meta) {
		...
		if (randomNum != 0) {
			this.dropBlockAsItem(world, x, y, z, new ItemStack(ItemsAether.raspberry, randomNum, 0));
		}
	}
