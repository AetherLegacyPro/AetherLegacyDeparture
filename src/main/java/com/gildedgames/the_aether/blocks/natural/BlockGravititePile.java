...
public class BlockGravititePile extends Block {

    public BlockGravititePile() {
        super(Material.iron);
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        this.blockIcon = p_149651_1_.registerIcon("aether_legacy:gravitite_pile");
    }
    ...
    public boolean canPlaceBlockAt(World p_149742_1_, int p_149742_2_, int p_149742_3_, int p_149742_4_) {
        ...
        return block != Blocks.ice && block != Blocks.packed_ice
            ? (block.isLeaves(p_149742_1_, p_149742_2_, p_149742_3_ - 1, p_149742_4_) ? true
                : (block == this && (p_149742_1_.getBlockMetadata(p_149742_2_, p_149742_3_ - 1, p_149742_4_) & 7) == 7
                    ? true
                    : block.isOpaqueCube()))
            : false;
    }
    ...
    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
        return ItemsAether.gravitite_nugget;
    }
    ...
    public int quantityDropped(World world, EntityPlayer p_149636_2_, int x, int y, int z, Random random) {
        ...
        switch (meta) {
            case 1:
                return 2 + 2 * (1 + random.nextInt(2));// 4~6
            case 2:
                return 3 + 2 * (2 + random.nextInt(2));// 7~9
            case 3:
                return 4 + 2 * (3 + random.nextInt(3));// 10~14
            case 4:
                return 6 + 3 * (4 + random.nextInt(3));// 18~24
            case 5:
                return 8 + 4 * (5 + random.nextInt(4));// 28~40
            case 6:
                return 12 + 5 * (6 + random.nextInt(5));// 42~62
            case 7:
                return 22 + 6 * (7 + random.nextInt(7));// 64~100
