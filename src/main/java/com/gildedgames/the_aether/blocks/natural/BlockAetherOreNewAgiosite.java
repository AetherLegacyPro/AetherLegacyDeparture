...
public class BlockAetherOreNewAgiosite extends Block {

    public BlockAetherOreNewAgiosite(int level) {
        super(Material.rock);
    ...
    public Item getItemDropped(int meta, Random random, int fortune) {
        return this == BlocksAether.agiosite_arkenium_ore ? ItemsAether.arkenium_fragement
    ...
    public int getExpDrop(IBlockAccess p_149690_1_, int p_149690_5_, int p_149690_7_) {
        ...
        if (this.getItemDropped(p_149690_5_, random, p_149690_7_) != Item.getItemFromBlock(this)) {
            ...
            if (this == BlocksAether.agiosite_continuum_ore) {
                amount = MathHelper.getRandomIntegerInRange(random, 2, 5);
            } else if (this == BlocksAether.agiosite_arkenium_ore) {
