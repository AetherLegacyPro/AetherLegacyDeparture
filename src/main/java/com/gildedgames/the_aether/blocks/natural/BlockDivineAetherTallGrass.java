...
public class BlockDivineAetherTallGrass extends BlockBush implements IShearable {
	...
	public BlockDivineAetherTallGrass() {
	...
	public boolean canPlaceBlockAt(World world, int x, int y, int z) {
		...
		return soil == BlocksAether.aether_grass || soil == BlocksAether.aether_dirt || soil == BlocksAether.arctic_grass || soil == BlocksAether.verdant_grass || soil == BlocksAether.divine_grass;
	}
	...
	public ArrayList<ItemStack> onSheared(ItemStack item, IBlockAccess world, int x, int y, int z, int fortune) {
		 ArrayList<ItemStack> ret = new ArrayList<>();
	            ret.add(new ItemStack(BlocksAether.divine_aether_tallgrass));
	        return ret;
	}
