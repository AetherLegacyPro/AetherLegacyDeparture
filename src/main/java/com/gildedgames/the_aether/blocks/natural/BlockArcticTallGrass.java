...
public class BlockArcticTallGrass extends BlockBush implements IShearable {
	...
	public boolean canPlaceBlockAt(World world, int x, int y, int z) {
		...
		return soil == BlocksAether.aether_dirt || soil == BlocksAether.arctic_grass || soil == BlocksAether.verdant_grass;
	}
	...
	public ArrayList<ItemStack> onSheared(ItemStack item, IBlockAccess world, int x, int y, int z, int fortune) {
		 ArrayList<ItemStack> ret = new ArrayList<>();
	            ret.add(new ItemStack(BlocksAether.arctic_tallgrass));
	        return ret;
	}
