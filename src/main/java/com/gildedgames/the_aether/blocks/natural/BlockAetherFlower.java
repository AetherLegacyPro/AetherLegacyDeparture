...
public class BlockAetherFlower extends BlockBush {
	...
	public boolean canPlaceBlockAt(World world, int x, int y, int z) {
		...
		return soil == BlocksAether.aether_grass || soil == BlocksAether.aether_dirt || soil == BlocksAether.arctic_grass || soil == BlocksAether.enchanted_aether_grass || soil == BlocksAether.aether_farmland || soil == BlocksAether.enchanted_aether_farmland || soil == BlocksAether.arctic_grass || soil == BlocksAether.divine_grass;
	}
