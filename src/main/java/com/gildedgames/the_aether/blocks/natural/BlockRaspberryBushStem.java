...
public class BlockRaspberryBushStem extends BlockAetherFlower implements IGrowable {

	public BlockRaspberryBushStem() {
	...
	public void updateTick(World world, int x, int y, int z, Random random) {
		...
		if (world.getBlockLightValue(x, y + 1, z) >= 9 && random.nextInt(60) == 0) {
			world.setBlock(x, y, z, BlocksAether.raspberry_bush);
		}
	}
