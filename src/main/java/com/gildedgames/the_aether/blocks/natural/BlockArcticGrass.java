...
public class BlockArcticGrass extends Block implements IGrowable {
    ...
    public IIcon getIcon(int side, int meta) {
        return side == 1 ? this.blockIconTop
            : (side == 0 ? BlocksAether.holystone.getBlockTextureFromSide(side) : this.blockIcon);
    }
        ...
        while (l < 128) {
            ...
            while (true) {
                if (l1 < l / 16) {
                    ...
                    if (p_149853_1_.getBlock(i1, j1 - 1, k1) == BlocksAether.arctic_grass
