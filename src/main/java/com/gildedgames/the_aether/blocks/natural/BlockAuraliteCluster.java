...
public class BlockAuraliteCluster extends BlockAuralite implements ISubBlocksBlock {
    ...
    public BlockAuraliteCluster(int type) {
        super(Material.glass);
        setHardness(1.5F);
        setResistance(1.5F);
        this.setStepSound(soundTypeGlass);
        setBlockName(Aether.getUnlocalisedName("auralite_cluster" + (type + 1)));
    ...
    public int quantityDropped(int meta, int fortune, Random random) {
        if (this == BlocksAether.auralite_cluster_2 && meta >= 6) {
    ...
    private boolean harvestingWithPickaxe() {
        return harvesters.get() != null && harvesters.get()
    ...
    protected void checkAndDropBlock(World p_149855_1_, int p_149855_2_, int p_149855_3_, int p_149855_4_) {
        if (!this.canBlockStay(p_149855_1_, p_149855_2_, p_149855_3_, p_149855_4_)) {
            this.dropBlockAsItem(
                ...
                p_149855_3_,
                p_149855_4_,
                p_149855_1_.getBlockMetadata(p_149855_2_, p_149855_3_, p_149855_4_),
                0);
    ...
    public boolean canPlaceBlockOnSide(World world, int x, int y, int z, int side) {
        ...
        return world.getBlock(x - facing.getFrontOffsetX(), y - facing.getFrontOffsetY(), z - facing.getFrontOffsetZ())
            .isOpaqueCube();
    }
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        icons = new IIcon[2];
        if (type == 0) {
            icons[0] = p_149651_1_.registerIcon("aether_legacy:auralite_bud");
            icons[1] = p_149651_1_.registerIcon("aether_legacy:auralite_medium_bud");
        }
        if (type == 1) {
            icons[0] = p_149651_1_.registerIcon("aether_legacy:auralite_large_bud");
            icons[1] = p_149651_1_.registerIcon("aether_legacy:auralite_cluster");
        }
    ...
    public Class<? extends ItemBlock> getItemBlockClass() {
        return ItemAuraliteCluster.class;
    }
}
