...
public class BlockAuraliteCluster extends BlockAuralite implements ISubBlocksBlock {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		icons = new IIcon[2];
		if(type == 0) {
			icons[0] = iconRegister.registerIcon("aether_legacy:auralite_bud");
			icons[1] = iconRegister.registerIcon("aether_legacy:auralite_medium_bud");
		}
		if(type == 1) {
			icons[0] = iconRegister.registerIcon("aether_legacy:auralite_large_bud");
			icons[1] = iconRegister.registerIcon("aether_legacy:auralite_cluster");
		}
