...
public class BlockAetherOreDeific extends Block {

	public BlockAetherOreDeific(int level) {
		super(Material.rock);
	...
	public Item getItemDropped(int meta, Random random, int fortune) {
		return this == BlocksAether.deific_zanite_ore ? ItemsAether.zanite_gemstone : ItemsAether.ambrosium_shard;
	}
	...
	public int getExpDrop(IBlockAccess p_149690_1_, int p_149690_5_, int p_149690_7_) {
		...
		if (this.getItemDropped(p_149690_5_, random, p_149690_7_) != Item.getItemFromBlock(this)) {
			...
			if (this == BlocksAether.deific_ambrosium_ore) {
				amount = MathHelper.getRandomIntegerInRange(random, 0, 3);
			} else if (this == BlocksAether.deific_zanite_ore) {
				amount = MathHelper.getRandomIntegerInRange(random, 2, 7);
			}
