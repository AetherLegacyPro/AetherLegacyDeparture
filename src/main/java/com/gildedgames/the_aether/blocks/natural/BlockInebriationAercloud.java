...
public class BlockInebriationAercloud extends Block implements IColoredBlock, INamedBlock {
	...
	public BlockInebriationAercloud() {
		...
		this.setBlockTextureName("aether_legacy:inebriation_aercloud");
	}
	...
	public String getUnlocalizedName(ItemStack stack) {
		return stack.getItemDamage() == 1 ? "freezing_aercloud" : stack.getItemDamage() == 2 ? "creeping_aercloud" : "inebriation_aercloud";
	}
