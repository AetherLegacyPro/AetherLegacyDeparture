...
public class BlockBlackberryBushStem extends BlockAetherFlower implements IGrowable {

	public BlockBlackberryBushStem() {
	...
	public void updateTick(World world, int x, int y, int z, Random random) {
		...
		if (world.getBlockLightValue(x, y + 1, z) >= 9 && random.nextInt(60) == 0) {
			world.setBlock(x, y, z, BlocksAether.blackberry_bush);
		}
	}
