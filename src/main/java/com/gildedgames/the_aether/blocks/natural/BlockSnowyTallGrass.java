...
public class BlockSnowyTallGrass extends BlockBush implements IShearable {
	...
	public boolean canPlaceBlockAt(World world, int x, int y, int z) {
		...
		return soil == BlocksAether.aether_grass || soil == BlocksAether.aether_dirt || soil == BlocksAether.arctic_grass || soil == BlocksAether.verdant_grass;
	}
