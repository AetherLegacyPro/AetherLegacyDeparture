...
public class BlockAetherOreNew extends Block {
	...
	public Item getItemDropped(int meta, Random random, int fortune) {
		return this == BlocksAether.arkenium_ore ? ItemsAether.arkenium_fragement : ItemsAether.continuum_gemstone;
	}
	...
	public int getExpDrop(IBlockAccess p_149690_1_, int p_149690_5_, int p_149690_7_) {
		...
		if (this.getItemDropped(p_149690_5_, random, p_149690_7_) != Item.getItemFromBlock(this)) {
			...
			if (this == BlocksAether.continuum_ore) {
				amount = MathHelper.getRandomIntegerInRange(random, 3, 5);
			} else if (this == BlocksAether.arkenium_ore) {
