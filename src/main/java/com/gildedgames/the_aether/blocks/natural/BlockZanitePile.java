...
public class BlockZanitePile extends Block {

    public BlockZanitePile() {
        super(Material.iron);
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        this.blockIcon = p_149651_1_.registerIcon("aether_legacy:zanite_pile");
    }
    ...
    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
        return ItemsAether.zanite_nugget;
    }
