...
public class BlockColdFire extends BlockFire {
    ...
    public void registerBlockIcons(final IIconRegister p_149651_1_) {
        this.field_149850_M = new IIcon[] { p_149651_1_.registerIcon("aether_legacy:coldfire_0"),
            p_149651_1_.registerIcon("aether_legacy:coldfire_1") };
    }
    ...
    public void updateTick(final World world, final int x, final int y, final int z, final Random rand) {
        if (world.getGameRules()
            ...
            final boolean flag = world.getBlock(x, y - 1, z)
                ...
                || world.getBlock(x, y - 1, z) == BlocksAether.coldfire;
