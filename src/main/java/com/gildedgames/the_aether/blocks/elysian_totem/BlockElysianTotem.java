...
public class BlockElysianTotem extends BlockMultiTileEntity {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
        ...
        if (world.getBlock(x, y, z) == BlocksAether.elysian_totem
            ...
            && (world.getBlock(x + 1, y - 2, z) == BlocksAether.genesis_stone_2
                || world.getBlock(x + 1, y - 2, z) == BlocksAether.genesis_stone)
            && (world.getBlock(x - 1, y - 2, z) == BlocksAether.genesis_stone_2
                || world.getBlock(x - 1, y - 2, z) == BlocksAether.genesis_stone)
            && (world.getBlock(x, y - 2, z + 1) == BlocksAether.genesis_stone_2
                || world.getBlock(x, y - 2, z + 1) == BlocksAether.genesis_stone)
            && (world.getBlock(x, y - 2, z - 1) == BlocksAether.genesis_stone_2
                || world.getBlock(x, y - 2, z - 1) == BlocksAether.genesis_stone)
            && (world.getBlock(x + 1, y - 2, z + 1) == BlocksAether.light_genesis_stone_2
                || world.getBlock(x + 1, y - 2, z + 1) == BlocksAether.light_genesis_stone)
            && (world.getBlock(x - 1, y - 2, z - 1) == BlocksAether.light_genesis_stone_2
                || world.getBlock(x - 1, y - 2, z - 1) == BlocksAether.light_genesis_stone)
            && (world.getBlock(x + 1, y - 2, z - 1) == BlocksAether.light_genesis_stone_2
                || world.getBlock(x + 1, y - 2, z - 1) == BlocksAether.light_genesis_stone)
            ...
            world.playSoundEffect(
                ...
                2.0F,
                world.rand.nextFloat() - world.rand.nextFloat() * 0.4f + 0.8f);
