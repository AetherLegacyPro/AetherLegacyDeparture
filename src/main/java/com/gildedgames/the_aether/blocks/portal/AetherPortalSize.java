...
public class AetherPortalSize {
    ...
    public AetherPortalSize(World worldIn, int x, int y, int z, int axis) {
        ...
        for (int i1 = y; y > i1 - 21 && y > 0
            && this.isEmptyBlock(WorldUtils.getBlockSafe(this.world, x, y - 1, z)); --y) {
            ;
        }
        ...
        if (i >= 0) {
            ...
            this.width = this
                .getDistanceUntilEdge(this.bottomLeft.posX, this.bottomLeft.posY, this.bottomLeft.posZ, this.rightDir);
