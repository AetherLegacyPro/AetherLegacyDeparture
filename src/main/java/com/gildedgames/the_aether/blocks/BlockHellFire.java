...
public class BlockHellFire extends BlockFire
{
    ...
    public void registerBlockIcons(final IIconRegister iconRegister) {
    	this.field_149850_M = new IIcon[] { iconRegister.registerIcon("aether_legacy:hellfire_0"), iconRegister.registerIcon("aether_legacy:hellfire_1")};
    }
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
		...
		if (entity instanceof EntityWither boss) {
			boss.addPotionEffect(new PotionEffect(Potion.regeneration.id, 200, 0));
            boss.addPotionEffect(new PotionEffect(Potion.damageBoost.id, 300, 0));
        }
		else  {
    ...
    public void randomDisplayTick(final World world, final int p_149734_2_, final int p_149734_3_, final int p_149734_4_, final Random random) {
        ...
        if (random.nextInt(15) == 0) {
            ...
            float f2;
        	 ...
        	 for (int i = 0; i < 2; ++i) {
        		 f = (float)p_149734_2_ + random.nextFloat() * 0.1F;
                 f1 = (float)p_149734_3_ + random.nextFloat();
                 f2 = (float)p_149734_4_ + random.nextFloat();
