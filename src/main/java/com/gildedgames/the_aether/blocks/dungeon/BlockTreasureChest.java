...
public class BlockTreasureChest extends BlockChest {
	...
	@Override
	public float getBlockHardness(World world, int p_149712_2_, int p_149712_3_, int p_149712_4_) {
		TileEntityTreasureChest treasurechest = (TileEntityTreasureChest) world.getTileEntity(p_149712_2_, p_149712_3_, p_149712_4_);
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(Aether.find("carved_stone"));
	}
