...
public class BlockSkyrootBed extends BlockBed {
    ...
    public boolean onBlockActivated(World world, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer entityPlayer, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
        if (world.isRemote) {
            ...
            if (!isBlockHeadOfBed(i1)) {
                ...
                if (world.getBlock(p_149727_2_, p_149727_3_, p_149727_4_) != this) {
                    return true;
                }

                i1 = world.getBlockMetadata(p_149727_2_, p_149727_3_, p_149727_4_);
            }

            if (entityPlayer.dimension == AetherConfig.getAetherDimensionID() || entityPlayer.dimension == 0) {
                if (func_149976_c(i1)) {
                    ...
                    func_149979_a(world, p_149727_2_, p_149727_3_, p_149727_4_, false);
                }

                EntityPlayer.EnumStatus enumstatus = entityPlayer.sleepInBedAt(p_149727_2_, p_149727_3_, p_149727_4_);

                if (enumstatus == EntityPlayer.EnumStatus.OK) {
                    func_149979_a(world, p_149727_2_, p_149727_3_, p_149727_4_, true);
                    return true;
                }
                else
                {
                    if (enumstatus == EntityPlayer.EnumStatus.NOT_POSSIBLE_NOW) {
                        ...
                        if (entityPlayer.dimension == AetherConfig.getAetherDimensionID()) {
                            entityPlayer.addChatMessage(new ChatComponentTranslation("gui.skyroot_bed.respawn_point"));
                            entityPlayer.setSpawnChunk(new ChunkCoordinates(p_149727_2_, p_149727_3_, p_149727_4_), false, AetherConfig.getAetherDimensionID());
                            PlayerAether.get(entityPlayer).setBedLocation(new ChunkCoordinates(p_149727_2_, p_149727_3_, p_149727_4_));
                        }
                    }
                ...
                world.newExplosion(null, (float)p_149727_2_ + 0.5F, (float)p_149727_3_ + 0.5F, (float)p_149727_4_ + 0.5F, 5.0F, true, true);
                return true;
            }
        }
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        this.field_149983_N = new IIcon[] {iconRegister.registerIcon(this.getTextureName() + "_feet_top"), iconRegister.registerIcon(this.getTextureName() + "_head_top")};
        this.field_149980_b = new IIcon[] {iconRegister.registerIcon(this.getTextureName() + "_feet_end"), iconRegister.registerIcon(this.getTextureName() + "_head_end")};
        this.field_149982_M = new IIcon[] {iconRegister.registerIcon(this.getTextureName() + "_feet_side"), iconRegister.registerIcon(this.getTextureName() + "_head_side")};
    }
