...
public class BlockAmbrosiumTorch extends BlockTorch {
    ...
    public void randomDisplayTick(final World world, final int p_149734_2_, final int p_149734_3_, final int p_149734_4_, final Random random) {
        ...
        if (l == 1) {
            ...
            NewAetherParticleHandler.AMBROSIUM_FLAME.spawn(world, d0 - d5, d2 + d4, d3, 0.0, 0.0, 0.0, 0.0f);
        }
        else if (l == 2) {
            world.spawnParticle("smoke", d0 + d5, d2 + d4, d3, 0.0, 0.0, 0.0);
            NewAetherParticleHandler.AMBROSIUM_FLAME.spawn(world, d0 + d5, d2 + d4, d3, 0.0, 0.0, 0.0, 0.0f);
            ...
            NewAetherParticleHandler.AMBROSIUM_FLAME.spawn(world, d0, d2 + d4, d3 - d5, 0.0, 0.0, 0.0, 0.0f);
        }
        else if (l == 4) {
            world.spawnParticle("smoke", d0, d2 + d4, d3 + d5, 0.0, 0.0, 0.0);
            NewAetherParticleHandler.AMBROSIUM_FLAME.spawn(world, d0, d2 + d4, d3 + d5, 0.0, 0.0, 0.0, 0.0f);
            ...
            NewAetherParticleHandler.AMBROSIUM_FLAME.spawn(world, d0, d2, d3, 0.0, 0.0, 0.0, 0.0f);
        }
    }
}
