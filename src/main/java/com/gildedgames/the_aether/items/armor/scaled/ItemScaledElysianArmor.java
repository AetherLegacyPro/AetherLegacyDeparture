    ...
    public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
        ...
        if (helmet != null) {
            hasElysianHelmet = (helmet.getItem() == ItemsAether.amplified_elysian_helmet
                || helmet.getItem() == ItemsAether.scaled_elysian_helmet
                || helmet.getItem() == ItemsAether.elysian_helmet);
        }
        if (chest != null) {
            hasElysianChest = (chest.getItem() == ItemsAether.amplified_elysian_chestplate
                || chest.getItem() == ItemsAether.scaled_elysian_chestplate
                || chest.getItem() == ItemsAether.elysian_chestplate);
        }
        if (legs != null) {
            hasElysianLegs = (legs.getItem() == ItemsAether.amplified_elysian_leggings
                || legs.getItem() == ItemsAether.scaled_elysian_leggings
                || legs.getItem() == ItemsAether.elysian_leggings);
        }
        if (boots != null) {
            hasElysianBoots = (boots.getItem() == ItemsAether.amplified_elysian_boots
                || boots.getItem() == ItemsAether.scaled_elysian_boots
                || boots.getItem() == ItemsAether.elysian_boots
