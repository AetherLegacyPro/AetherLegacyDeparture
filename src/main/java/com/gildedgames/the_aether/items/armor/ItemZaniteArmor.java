...
public class ItemZaniteArmor extends ItemZaniteArmorBase implements ISpecialArmor {
    ...
    public ItemZaniteArmor(int armorType, ArmorMaterial material, String name, Item repair) {
    ...
    public void addInformation(final ItemStack stack, final EntityPlayer player, final List tooltip,
        ...
        if (AetherConfig.enableTooltips())
            tooltip.add(EnumChatFormatting.GRAY + "" + StatCollector.translateToLocal("tooltip.zanite_armor.desc"));
    }
