...
public class ItemAetherDungeonArmor extends ItemArmor {
    ...
    public void addInformation(final ItemStack stack, final EntityPlayer player, final List tooltip,
        ...
        if (AetherConfig.enableTooltips()) {
            if (stack.getItem() == ItemsAether.neptune_helmet || stack.getItem() == ItemsAether.neptune_chestplate
                || stack.getItem() == ItemsAether.neptune_leggings
                || stack.getItem() == ItemsAether.neptune_boots) {
                tooltip
                    .add(EnumChatFormatting.GREEN + "" + StatCollector.translateToLocal("tooltip.neptune_armor.desc"));
            } else if (stack.getItem() == ItemsAether.agility_boots) {
                tooltip
                    .add(EnumChatFormatting.GREEN + "" + StatCollector.translateToLocal("tooltip.agility_boots.desc"));
            } else
                if (stack.getItem() == ItemsAether.obsidian_helmet || stack.getItem() == ItemsAether.obsidian_chestplate
                    || stack.getItem() == ItemsAether.obsidian_leggings
                    || stack.getItem() == ItemsAether.obsidian_boots) {
                        tooltip.add(
                            EnumChatFormatting.GREEN + ""
                                + StatCollector.translateToLocal("tooltip.obsidian_armor.desc"));
                    } else if (stack.getItem() == ItemsAether.valkyrie_helmet
                        || stack.getItem() == ItemsAether.valkyrie_chestplate
                        || stack.getItem() == ItemsAether.valkyrie_leggings
                        || stack.getItem() == ItemsAether.valkyrie_boots) {
                            tooltip.add(
                                EnumChatFormatting.GREEN + ""
