...
public class ItemScaledDungeonArmor extends ItemArmor {
    ...
    public void addInformation(final ItemStack stack, final EntityPlayer player, final List tooltip,
        ...
        if (AetherConfig.enableTooltips()) {
            if (stack.getItem() == ItemsAether.scaled_neptune_helmet
                || stack.getItem() == ItemsAether.scaled_neptune_chestplate
                || stack.getItem() == ItemsAether.scaled_neptune_leggings
                || stack.getItem() == ItemsAether.scaled_neptune_boots) {
                tooltip
                    .add(EnumChatFormatting.AQUA + "" + StatCollector.translateToLocal("tooltip.neptune_armor.desc"));
            } else if (stack.getItem() == ItemsAether.scaled_agility_boots) {
                tooltip
                    .add(EnumChatFormatting.AQUA + "" + StatCollector.translateToLocal("tooltip.agility_boots.desc"));
            } else if (stack.getItem() == ItemsAether.scaled_obsidian_helmet
                || stack.getItem() == ItemsAether.scaled_obsidian_chestplate
                || stack.getItem() == ItemsAether.scaled_obsidian_leggings
                || stack.getItem() == ItemsAether.scaled_obsidian_boots) {
                    tooltip.add(
                        EnumChatFormatting.AQUA + "" + StatCollector.translateToLocal("tooltip.obsidian_armor.desc"));
                } else if (stack.getItem() == ItemsAether.scaled_valkyrie_helmet
                    || stack.getItem() == ItemsAether.scaled_valkyrie_chestplate
                    || stack.getItem() == ItemsAether.scaled_valkyrie_leggings
                    || stack.getItem() == ItemsAether.scaled_valkyrie_boots) {
                        tooltip.add(
