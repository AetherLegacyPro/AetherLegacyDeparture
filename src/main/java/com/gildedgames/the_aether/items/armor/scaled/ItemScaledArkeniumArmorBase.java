...
public class ItemScaledArkeniumArmorBase extends ItemArmor {

	private String[] defualt_location = new String[]{"aether_legacy:textures/armor/scaled_arkenium_layer_1.png", "aether_legacy:textures/armor/scaled_arkenium_layer_2.png"};
	...
	public ItemScaledArkeniumArmorBase(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public ItemScaledArkeniumArmorBase(int armorType, ArmorMaterial material, String name, Item repair, int hex) {
