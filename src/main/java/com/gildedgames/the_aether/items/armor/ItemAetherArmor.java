...
public class ItemAetherArmor extends ItemArmor {
    ...
    public EnumRarity getRarity(ItemStack stack) {
        return !this.armorName.contains("zanite") && !this.armorName.contains("gravitite")
            && !this.armorName.contains("continuum")
            && !this.armorName.contains("arkenium") ? ItemsAether.aether_loot : super.getRarity(stack);
    }
