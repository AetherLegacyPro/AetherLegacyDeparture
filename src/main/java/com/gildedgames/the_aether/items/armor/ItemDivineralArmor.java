...
public class ItemDivineralArmor extends ItemArmor {
    ...
    public void addInformation(final ItemStack stack, final EntityPlayer player, final List tooltip,
        ...
        if (AetherConfig.enableTooltips()) {
            if (stack.getItem() == ItemsAether.divineral_helmet || stack.getItem() == ItemsAether.divineral_chestplate
                || stack.getItem() == ItemsAether.divineral_leggings
                || stack.getItem() == ItemsAether.divineral_boots) {
                tooltip.add(
                    EnumChatFormatting.LIGHT_PURPLE + ""
                        + StatCollector.translateToLocal("tooltip.divineral_armor.desc"));
            } else if (stack.getItem() == ItemsAether.amplified_agility_boots) {
                tooltip.add(
                    EnumChatFormatting.LIGHT_PURPLE + ""
                        + StatCollector.translateToLocal("tooltip.agility_boots.desc"));
            } else if (stack.getItem() == ItemsAether.amplified_neptune_helmet
                || stack.getItem() == ItemsAether.amplified_neptune_chestplate
                || stack.getItem() == ItemsAether.amplified_neptune_leggings
                || stack.getItem() == ItemsAether.amplified_neptune_boots) {
                    tooltip.add(
                        EnumChatFormatting.LIGHT_PURPLE + ""
                            + StatCollector.translateToLocal("tooltip.neptune_armor.desc"));
                } else if (stack.getItem() == ItemsAether.amplified_obsidian_helmet
                    || stack.getItem() == ItemsAether.amplified_obsidian_chestplate
                    || stack.getItem() == ItemsAether.amplified_obsidian_leggings
                    || stack.getItem() == ItemsAether.amplified_obsidian_boots) {
                        tooltip.add(
                            EnumChatFormatting.LIGHT_PURPLE + ""
                                + StatCollector.translateToLocal("tooltip.obsidian_armor.desc"));
                    } else if (stack.getItem() == ItemsAether.amplified_valkyrie_helmet
                        || stack.getItem() == ItemsAether.amplified_valkyrie_chestplate
                        || stack.getItem() == ItemsAether.amplified_valkyrie_leggings
                        || stack.getItem() == ItemsAether.amplified_valkyrie_boots) {
                            tooltip.add(
                                EnumChatFormatting.LIGHT_PURPLE + ""
                                    + StatCollector.translateToLocal("tooltip.valkyrie_armor.desc"));
                        }
        }
    }
}
