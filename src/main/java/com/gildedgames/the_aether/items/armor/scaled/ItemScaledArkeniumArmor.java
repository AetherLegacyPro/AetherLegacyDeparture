...
public class ItemScaledArkeniumArmor extends ItemScaledArkeniumArmorBase implements ISpecialArmor {
    ...
    public ItemScaledArkeniumArmor(int armorType, ArmorMaterial material, String name, Item repair, int hex) {
    ...
    public void addInformation(final ItemStack stack, final EntityPlayer player, final List tooltip,
        ...
        if (AetherConfig.enableTooltips())
            tooltip.add(EnumChatFormatting.AQUA + "" + StatCollector.translateToLocal("tooltip.arkenium_armor.desc"));
    }
