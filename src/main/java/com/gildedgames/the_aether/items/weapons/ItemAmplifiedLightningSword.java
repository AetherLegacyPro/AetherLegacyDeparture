    ...
    public boolean hitEntity(ItemStack itemstack, EntityLivingBase entityliving, EntityLivingBase entityliving1) {
        ...
        if (this == ItemsAether.amplified_lightning_sword) {
            EntityLightningBolt lightning = new EntityLightningBolt(
                entityliving1.worldObj,
                entityliving.posX,
                entityliving.posY,
                entityliving.posZ);

            EntityLightningBolt lightning1 = new EntityLightningBolt(
                entityliving1.worldObj,
                entityliving.posX + 3,
                entityliving.posY,
                entityliving.posZ + 3);

            EntityLightningBolt lightning2 = new EntityLightningBolt(
                entityliving1.worldObj,
                entityliving.posX - 3,
                entityliving.posY,
                entityliving.posZ - 3);

            EntityLightningBolt lightning3 = new EntityLightningBolt(
                entityliving1.worldObj,
                entityliving.posX + 3,
                entityliving.posY,
                entityliving.posZ - 3);

            EntityLightningBolt lightning4 = new EntityLightningBolt(
                entityliving1.worldObj,
                entityliving.posX - 3,
                entityliving.posY,
                entityliving.posZ + 3);
