...
public class ItemAmplifiedOverworldSlayer extends ItemSword {
    ...
    public ItemAmplifiedOverworldSlayer() {
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(ItemStack stack) {
        ...
        if (stack.getItem() instanceof ItemAmplifiedOverworldSlayer) {
            if (newWorld == true) {
                multimap.put(
