...
public class ItemAmplifiedPhoenixBow extends ItemBow {

	@SideOnly(Side.CLIENT)
	private IIcon[] iconArray;

	public ItemAmplifiedPhoenixBow() {
		super();
		this.maxStackSize = 1;
		this.setMaxDamage(1588);
		this.setFull3D();
		this.setTextureName(Aether.find("weapons/amplified_bow"));
	...
	public IIcon getIcon(ItemStack stack, int renderPass, EntityPlayer player, ItemStack usingItem, int useRemaining) {
		if (usingItem != null && stack.getItem() == ItemsAether.amplified_phoenix_bow) {
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(Aether.find("weapons/amplified_phoenix_bow"));
