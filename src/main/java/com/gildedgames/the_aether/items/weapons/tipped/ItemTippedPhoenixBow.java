...
public class ItemTippedPhoenixBow extends ItemBow {
	...
	public ItemTippedPhoenixBow() {
		...
		this.setFull3D();
		this.setTextureName(Aether.find("weapons/tipped_bow"));
	...
	public IIcon getIcon(ItemStack stack, int renderPass, EntityPlayer player, ItemStack usingItem, int useRemaining) {
		if (usingItem != null && stack.getItem() == ItemsAether.tipped_phoenix_bow) {
