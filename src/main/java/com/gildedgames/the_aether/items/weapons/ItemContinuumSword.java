...
public class ItemContinuumSword extends ItemSword {

    public float[] level = new float[] { 5F, 6F, 7F, 8F, 9F };

    public ItemContinuumSword(float damage, EnumAetherToolType toolType) {
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(ItemStack stack) {
        ...
        if (stack.getItem() instanceof ItemContinuumSword) {
            multimap.put(
    ...
    public boolean hitEntity(ItemStack itemstack, EntityLivingBase entityliving, EntityLivingBase entityliving1) {
        if ((new Random()).nextInt(5) == 0 && entityliving1 instanceof EntityPlayer
