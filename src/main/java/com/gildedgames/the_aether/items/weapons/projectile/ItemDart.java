...
public class ItemDart extends Item {
    ...
    public static final IBehaviorDispenseItem DISPENSER_BEHAVIOR = new IBehaviorDispenseItem() {
        ...
        public ItemStack dispense(IBlockSource p_82482_1_, final ItemStack p_82482_2_) {
            ...
            } else if (p_82482_2_.getItem() == ItemsAether.dart
                && p_82482_2_.getItemDamage() == EnumDartType.Enchanted.meta) {
                    return (new BehaviorProjectileDispense() {
    ...
    public void registerIcons(IIconRegister registry) {
        ...
        this.phoenixIcon = registry.registerIcon(Aether.find("projectile/phoenix_dart"));
    }

    @Override
    @SideOnly(Side.CLIENT)
    public IIcon getIconFromDamage(int meta) {
        return meta == 1 ? this.poisonIcon
            : meta == 2 ? this.enchantedIcon : meta == 3 ? this.phoenixIcon : this.goldenIcon;
    }
