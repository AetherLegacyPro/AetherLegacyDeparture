...
public class ItemBlockAetherDoor extends Item {
    ...
    public ItemBlockAetherDoor() {
        this.door = BlocksAether.skyroot_door;
            ...
            if (par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, par1ItemStack)
                ...
                if (!block.canPlaceBlockAt(par3World, par4, par5, par6)) {
                    ...
                    int i1 = MathHelper.floor_double(
                        (double) ((par2EntityPlayer.rotationYaw + 180.0F) * 4.0F / 360.0F) - (double) 0.5F) & 3;
    ...
    public static void placeDoorBlock(World par0World, int par1, int par2, int par3, int par4, Block par5Block) {
        ...
        int i1 = (par0World.getBlock(par1 - b0, par2, par3 - b1)
            .isNormalCube() ? 1 : 0)
            + (par0World.getBlock(par1 - b0, par2 + 1, par3 - b1)
                .isNormalCube() ? 1 : 0);
        int j1 = (par0World.getBlock(par1 + b0, par2, par3 + b1)
            .isNormalCube() ? 1 : 0)
            + (par0World.getBlock(par1 + b0, par2 + 1, par3 + b1)
                .isNormalCube() ? 1 : 0);
        boolean flag = par0World.getBlock(par1 - b0, par2, par3 - b1) == par5Block
            || par0World.getBlock(par1 - b0, par2 + 1, par3 - b1) == par5Block;
        boolean flag1 = par0World.getBlock(par1 + b0, par2, par3 + b1) == par5Block
            || par0World.getBlock(par1 + b0, par2 + 1, par3 + b1) == par5Block;
        boolean flag2 = false;
        if (flag && !flag1) {
            flag2 = true;
