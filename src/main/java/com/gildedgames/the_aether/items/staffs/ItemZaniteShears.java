...
public class ItemZaniteShears extends ItemShears {
    ...
    public boolean onBlockDestroyed(ItemStack stack, World world, Block block, int p_150894_4_, int p_150894_5_, int p_150894_6_, EntityLivingBase p_150894_7_) {
        if (block.getMaterial() != Material.leaves && block != Blocks.web && block != Blocks.tallgrass && block != Blocks.vine && block != Blocks.tripwire && block != BlocksAether.aether_tallgrass && block != BlocksAether.enchanted_aether_tallgrass && !(block instanceof IShearable)) {
            return super.onBlockDestroyed(stack, world, block, p_150894_4_, p_150894_5_, p_150894_6_, p_150894_7_);
        }
        else {
            return true;
        }
