...
public class ItemConfractusStaff extends Item {
    ...
    public boolean onItemUse(ItemStack heldItem, EntityPlayer player, World world, int x, int y, int z, int facing,
        ...
        if ((world.getBlock(x, y, z) == BlocksAether.carved_trap)
        ...
        else if ((world.getBlock(x, y, z) == BlocksAether.divine_carved_trap)
        ...
        else if ((world.getBlock(x, y, z) == BlocksAether.locked_sentry_stone)
            || (world.getBlock(x, y, z) == BlocksAether.locked_divine_sentry_stone)
            || (world.getBlock(x, y, z) == BlocksAether.locked_mythic_sentry_stone)) {
        ...
        else if ((world.getBlock(x, y, z) == BlocksAether.fuse_trap)
            || (world.getBlock(x, y, z) == BlocksAether.fuse_trap_2)) {
