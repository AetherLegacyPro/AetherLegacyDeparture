...
public class ItemSwettyBall extends Item {
	...
	public static boolean func_150919_a(ItemStack stack, World world, int p_150919_2_, int p_150919_3_, int p_150919_4_) {
        if (world instanceof WorldServer)
            return applyBonemeal(stack, world, p_150919_2_, p_150919_3_, p_150919_4_, FakePlayerFactory.getMinecraft((WorldServer)world));
        return false;
    }

    public static boolean applyBonemeal(ItemStack stack, World world, int p_150919_2_, int p_150919_3_, int p_150919_4_, EntityPlayer player) {
