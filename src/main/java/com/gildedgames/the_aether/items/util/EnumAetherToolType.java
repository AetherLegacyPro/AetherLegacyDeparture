...
public enum EnumAetherToolType {
    ...
    PICKAXE(Sets.newHashSet(
        ...
        BlocksAether.holystone_brick,
        BlocksAether.mossy_holystone,
        BlocksAether.enchanter,
        BlocksAether.incubator,
        BlocksAether.enchanter,
        BlocksAether.ambrosium_ore,
        BlocksAether.icestone,
        BlocksAether.aerogel,
        BlocksAether.carved_stone,
        BlocksAether.angelic_stone,
        BlocksAether.hellfire_stone,
        BlocksAether.sentry_stone,
        BlocksAether.light_angelic_stone,
        ...
        public boolean canHarvestBlock(ToolMaterial toolMaterial, Block state) {
            ...
            if (block == BlocksAether.zanite_ore || block == BlocksAether.zanite_block
                || block == BlocksAether.icestone) {
            ...
            return block
                == Blocks.obsidian
                    ? toolMaterial.getHarvestLevel() == 3
                                    ...
                                    ? (block != Blocks.iron_block && block != Blocks.iron_ore
                                        ? (block != Blocks.lapis_block && block != Blocks.lapis_ore
                                            ? (block != Blocks.redstone_ore && block != Blocks.lit_redstone_ore
                                                ? (state.getMaterial() == Material.rock ? true
                                                    : (state.getMaterial() == Material.iron ? true
        ...
        public float getStrVsBlock(ItemStack stack, Block block) {
            return block != null && (block.getMaterial() == Material.iron || block.getMaterial() == Material.anvil
                || block.getMaterial() == Material.rock) ? this.efficiencyOnProperMaterial
                    : super.getStrVsBlock(stack, block);
        }
    },
    SHOVEL(Sets.newHashSet(
        Blocks.grass,
        Blocks.dirt,
        Blocks.sand,
        Blocks.gravel,
        ...
        Blocks.soul_sand,
        Blocks.mycelium,
        BlocksAether.aether_dirt,
        BlocksAether.aether_grass,
        BlocksAether.aercloud,
        BlocksAether.enchanted_aether_grass,
        BlocksAether.quicksoil)) {
    ...
    AXE(Sets.newHashSet(
        ...
        @Override
        public float getStrVsBlock(ItemStack stack, Block block) {
            return block != null && (block.getMaterial() == Material.wood || block.getMaterial() == Material.plants
                || block.getMaterial() == Material.vine) ? this.efficiencyOnProperMaterial
                    : super.getStrVsBlock(stack, block);
        }
    };
