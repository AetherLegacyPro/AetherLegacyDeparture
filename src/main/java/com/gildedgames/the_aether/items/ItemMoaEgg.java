...
public class ItemMoaEgg extends Item {
    ...
    public void getSubItems(Item item, CreativeTabs tab, List subItems) {
        for (int moaTypeSize = 0; moaTypeSize < AetherAPI.instance()
            .getMoaTypeSize(); ++moaTypeSize) {
            ItemStack stack = new ItemStack(this);
            NBTTagCompound compound = new NBTTagCompound();
            AetherMoaType moaType = AetherAPI.instance()
                .getMoaType(moaTypeSize);
    ...
    public int getColorFromItemStack(ItemStack stack, int renderPass) {
        ...
        if (tag != null) {
            AetherMoaType moaType = AetherAPI.instance()
                .getMoaType(tag.getInteger("typeId"));
    ...
    public String getUnlocalizedName(ItemStack stack) {
        ...
        if (tag != null && stack.getTagCompound()
            ...
            return "item." + moaType.getRegistryName()
                .getResourcePath()
                .replace(" ", "_")
                .toLowerCase() + "_moa_egg.name";
        }
