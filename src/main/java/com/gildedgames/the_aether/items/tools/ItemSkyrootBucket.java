...
public class ItemSkyrootBucket extends Item {
    ...
    public IIcon getIconFromDamage(int meta) {
        return meta == 1 ? this.waterBucket
            : meta == 2 ? this.poisonBucket
                : meta == 3 ? this.remedyBucket : meta == 4 ? this.milkBucket : this.itemIcon;
    }
    ...
    public boolean onItemUseFirst(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        if (world.getBlock(movingobjectposition.blockX, movingobjectposition.blockY, movingobjectposition.blockZ)
            ...
            int waterLevel = BlockCauldron.func_150027_b(
                ...
                if (waterLevel < 3) {
                    if (!player.capabilities.isCreativeMode) {
                        player.inventory.setInventorySlotContents(
                            ...
                            new ItemStack(ItemsAether.skyroot_bucket, 1, EnumSkyrootBucketType.Empty.meta));
                    }

                    cauldron.func_150024_a(
                        world,
                        movingobjectposition.blockX,
                        movingobjectposition.blockY,
                        movingobjectposition.blockZ,
    ...
    public ItemStack onItemRightClick(ItemStack heldItem, World world, EntityPlayer player) {
        ...
        if (EnumSkyrootBucketType.getType(meta) != EnumSkyrootBucketType.Water
            && EnumSkyrootBucketType.getType(meta) != EnumSkyrootBucketType.Empty) {
    ...
    public ItemStack onBucketUsed(ItemStack itemstack, World world, EntityPlayer entityplayer) {
        ...
        if (EnumSkyrootBucketType.getType(meta) == EnumSkyrootBucketType.Poison) {
            ...
            if (!world.isRemote) {
                entityplayer
                    .curePotionEffects(new ItemStack(ItemsAether.skyroot_bucket, EnumSkyrootBucketType.Remedy.meta));
            }
