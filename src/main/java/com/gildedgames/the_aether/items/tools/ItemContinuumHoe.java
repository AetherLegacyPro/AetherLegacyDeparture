...
public class ItemContinuumHoe extends ItemHoe {

    public ItemContinuumHoe() {
        super(ToolMaterial.IRON);
        this.setCreativeTab(AetherCreativeTabs.tools);
        this.setMaxDamage(2471);
    }
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_,
        ...
        if (!p_77648_2_.canPlayerEdit(p_77648_4_, p_77648_5_, p_77648_6_, p_77648_7_, p_77648_1_)) {
            ...
            if (p_77648_7_ != 0 && p_77648_3_.getBlock(p_77648_4_, p_77648_5_ + 1, p_77648_6_)
                .isAir(p_77648_3_, p_77648_4_, p_77648_5_ + 1, p_77648_6_)
                && (block == BlocksAether.aether_grass || block == BlocksAether.arctic_grass
                    || block == BlocksAether.verdant_grass
                    || block == BlocksAether.aether_dirt)) {
                Block block1 = BlocksAether.aether_farmland;
                p_77648_3_.playSoundEffect(
                    (float) p_77648_4_ + 0.5F,
                    (float) p_77648_5_ + 0.5F,
                    (float) p_77648_6_ + 0.5F,
