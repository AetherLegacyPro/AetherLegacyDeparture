...
public class EntityAerbunny extends EntityAetherAnimal implements IEntityAdditionalSpawnData {
    ...
    public boolean getCanSpawnHere() {
        ...
        return (this.worldObj.getBlock(i, j - 1, k) == BlocksAether.aether_dirt
            ...
            && canSpawn
            && this.rand.nextInt(AetherConfig.getAerbunnySpawnrate()) == 0
        ...
        if (this.ridingEntity != null && this.ridingEntity instanceof EntityPlayer player) {
            ...
            if (!player.onGround) {
                ...
                if (player.motionY < -0.22499999403953552D) {
                    if (PlayerAether.get((EntityPlayer) this.ridingEntity)
                        .isJumping()) {
    ...
    public boolean interact(EntityPlayer entityplayer) {
        ...
        if (itemstack != null
            && ((itemstack.getItem() == Items.name_tag) || (itemstack.getItem() == ItemsAether.blueberry))) {
