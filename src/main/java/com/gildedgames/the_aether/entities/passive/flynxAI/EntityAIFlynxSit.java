...
public class EntityAIFlynxSit extends EntityAIBase {
    ...
    public boolean continueExecuting() {
        return this.field_151492_c <= this.field_151490_e && this.field_151489_d <= 60
            && this.func_151486_a(
                this.field_151493_a.worldObj,
                this.field_151487_f,
                this.field_151488_g,
                this.field_151494_h);
    }
    ...
    public void startExecuting() {
        this.field_151493_a.getNavigator()
            .tryMoveToXYZ(
                (double) ((float) this.field_151487_f) + 0.5D,
                this.field_151488_g + 1,
                (double) ((float) this.field_151494_h) + 0.5D,
                this.field_151491_b);
        this.field_151492_c = 0;
        this.field_151489_d = 0;
        this.field_151490_e = this.field_151493_a.getRNG()
            .nextInt(
                this.field_151493_a.getRNG()
                    .nextInt(1200) + 1200)
            + 1200;
        this.field_151493_a.func_70907_r()
            .setSitting(false);
    }
    ...
    public void updateTask() {
        ...
        if (this.field_151493_a.getDistanceSq(this.field_151487_f, this.field_151488_g + 1, this.field_151494_h)
            > 1.0D) {
            this.field_151493_a.setSitting(false);
            this.field_151493_a.getNavigator()
                .tryMoveToXYZ(
    ...
    private boolean func_151485_f() {
        ...
        for (int j = (int) this.field_151493_a.posX - 8; (double) j < this.field_151493_a.posX + 8.0D; ++j) {
            for (int k = (int) this.field_151493_a.posZ - 8; (double) k < this.field_151493_a.posZ + 8.0D; ++k) {
                if (this.func_151486_a(this.field_151493_a.worldObj, j, i, k)
                    && this.field_151493_a.worldObj.isAirBlock(j, i + 1, k)) {
    ...
    private boolean func_151486_a(World p_151486_1_, int p_151486_2_, int p_151486_3_, int p_151486_4_) {
        ...
        if (block == Blocks.chest) {
            TileEntityChest tileentitychest = (TileEntityChest) p_151486_1_
