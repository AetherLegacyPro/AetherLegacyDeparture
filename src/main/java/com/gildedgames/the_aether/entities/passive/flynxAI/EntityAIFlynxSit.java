...
public class EntityAIFlynxSit extends EntityAIBase {
    ...
    public EntityAIFlynxSit(EntityFlynx entityFlynx, double p_i45315_2_) {
        this.field_151493_a = entityFlynx;
    ...
    private boolean func_151486_a(World world, int p_151486_2_, int p_151486_3_, int p_151486_4_) {
        Block block = world.getBlock(p_151486_2_, p_151486_3_, p_151486_4_);
        int l = world.getBlockMetadata(p_151486_2_, p_151486_3_, p_151486_4_);

        if (block == Blocks.chest) {
            TileEntityChest tileentitychest = (TileEntityChest)world.getTileEntity(p_151486_2_, p_151486_3_, p_151486_4_);
