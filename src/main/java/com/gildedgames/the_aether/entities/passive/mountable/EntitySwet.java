...
public class EntitySwet extends EntityMountable
{
                ...
                if (this.getAttackTarget() != null)
                {
                    if (this.getAttackTarget() == player)
                    {
                        if (!player.capabilities.isCreativeMode)
                        {
                           ...
                           if (this.getType() == EnumSwetType.POISON)
                            {
                        	   ((EntityLivingBase) entityIn).addPotionEffect(new EffectInebriation(Potion.poison.id, 240, 0));	
                            }
                        }
                    }
                }
    ...
    protected void dropFewItems(boolean recentlyHit, int lootLevel)
    {
        ...
        {
        	this.entityDropItem(new ItemStack(ItemsAether.golden_swet_ball, count), 1.0F);
            int rand = (int)(1 + Math.random() * 3);
    		switch (rand)
            {
            case 1: this.entityDropItem(new ItemStack(Blocks.glowstone, count), 1.0F);
            break;
            case 2:
            break;
            case 3:
        ...
        if (this.getType() == EnumSwetType.PURPLE)
        {
            this.entityDropItem(new ItemStack(ItemsAether.purple_swet_ball, count), 1.0F);
            int rand = (int)(1 + Math.random() * 3);
    		switch (rand)
            {
            case 1: this.entityDropItem(new ItemStack(BlocksAether.purple_aercloud, count), 1.0F);
            break;
            case 2:
            break;
            case 3:
        ...
        if (this.getType() == EnumSwetType.POISON)
        {
            this.entityDropItem(new ItemStack(ItemsAether.poison_gummy_swet, count, 0), 1.0F);
        }
        else
        {
    		...
    		switch (rand)
            {
            case 1: this.entityDropItem(new ItemStack(BlocksAether.aercloud, count, 1), 1.0F);
            break;
            case 2:
            break;
            case 3:
