...
public class EntityFireProofItemAether extends EntityItem {
    ...
    public void onUpdate() {
        ...
        final ItemStack stack = this.getDataWatcher()
        ...
        if (this.getEntityItem() == null) {
            ...
            final boolean inlava = this.worldObj
                .getBlock(
            ...
            this.noClip = this
                .func_145771_j(this.posX, (this.boundingBox.minY + this.boundingBox.maxY) / 2.0, this.posZ);
            if (inlava) {
            ...
            final boolean flag = (int) this.prevPosX != (int) this.posX || (int) this.prevPosY != (int) this.posY
            ...
            ++this.age;
            final ItemStack item = this.getDataWatcher()
                .getWatchableObjectItemStack(10);
            if (!this.worldObj.isRemote && this.age >= this.lifespan) {
                if (item != null) {
                    final ItemExpireEvent event = new ItemExpireEvent(
                        this,
                        (item.getItem() == null) ? 6000
                            : item.getItem()
                                .getEntityLifespan(item, this.worldObj));
    ...
    private void searchForOtherItemsNearby() {
        for (final Object entityitem : this.worldObj
            .getEntitiesWithinAABB((Class) EntityItem.class, this.boundingBox.expand(0.5, 0.0, 0.5))) {
    ...
    public boolean combineItems(final EntityItem p_70289_1_) {
        ...
        if (itemstack2.hasTagCompound() && !itemstack2.getTagCompound()
        ...
        if (itemstack2.getItem()
            .getHasSubtypes() && itemstack2.getItemDamage() != itemstack.getItemDamage()) {
            return false;
        }
