...
public class EntityElysianGuardianLaser extends Entity implements IProjectile {
    ...
    public EntityElysianGuardianLaser(final World par1World, final EntityLivingBase par2EntityLivingBase,
        final EntityLivingBase par3EntityLivingBase, final float par4, final float par5) {
        super(par1World);
        this.field_145791_d = -1;
        this.field_145792_e = -1;
        this.field_145789_f = -1;
        ...
        if (d4 >= 1.0E-7) {
            ...
            this.setLocationAndAngles(
                par2EntityLivingBase.posX + d5,
                this.posY,
                par2EntityLivingBase.posZ + d6,
                f2,
                f3);
            this.yOffset = 0.0f;
    ...
    protected void onImpact(MovingObjectPosition p_70227_1_) {
        if (!this.worldObj.isRemote) {
            ...
            if (p_70227_1_.entityHit instanceof EntityPlayerMP) {
                ((EntityPlayerMP) p_70227_1_.entityHit).playerNetServerHandler
                    .sendPacket(new S12PacketEntityVelocity(p_70227_1_.entityHit));
            }
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entityHit != null) {
                    ...
                    if (this.shootingEntity == null) {
                        ...
                        damagesource = DamageSource.magic;
                        this.worldObj
                            .playSoundAtEntity(this, "random.fizz", 1.0f, 1.2f / (this.rand.nextFloat() * 0.2f + 0.9f));
                        this.setDead();
                    }
    ...
    @SideOnly(Side.CLIENT)
    public void setPositionAndRotation2(final double par1, final double par2, final double par3, final float par4,
        final float par5, final int par6) {
