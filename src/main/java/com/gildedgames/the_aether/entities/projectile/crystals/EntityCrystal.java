    ...
    public void applyEntityCollision(Entity entity) {
        ...
        if (entity instanceof EntityCrystal crystal && this.worldObj.difficultySetting == EnumDifficulty.HARD) {
            ...
            if (this.type == EnumCrystalType.FIRE && !(entity instanceof IAetherBoss)
                && !(entity instanceof EntityHellfireCinder)
                && !(entity instanceof EntityFireMinion)
                && !(entity instanceof EntityAncientFireMinion)
                && !(entity instanceof EntityDivineFireMinion)
                && !(entity instanceof EntityMythicFireMinion)
                && !(entity instanceof EntityCinerarium)
                && !(entity instanceof EntityCrystal)) {
                if (this.shootingEntity != null) {
                    flag = entity.attackEntityFrom(
                        new EntityDamageSourceIndirect("incineration", this, this.shootingEntity).setProjectile(),
                        5);
                } else {
            ...
            } else if (this.type == EnumCrystalType.HELLFIRE && !(entity instanceof IAetherBoss)
                && !(entity instanceof EntityHellfireCinder)
                && !(entity instanceof EntityFireMinion)
                && !(entity instanceof EntityAncientFireMinion)
                && !(entity instanceof EntityDivineFireMinion)
                ...
                && !(entity instanceof EntityCrystal)) {
                    if (this.shootingEntity != null) {
                        flag = entity.attackEntityFrom(
                            new EntityDamageSourceIndirect("incineration_firo", this, this.shootingEntity)
                                .setProjectile(),
                            6);
                    } else {
                        flag = entity
                            .attackEntityFrom(new EntityDamageSource("incineration_firo", this).setProjectile(), 11);
                    }
