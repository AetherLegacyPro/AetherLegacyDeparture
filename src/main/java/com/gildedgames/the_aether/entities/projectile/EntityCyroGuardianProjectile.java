    ...
    protected void onImpact(MovingObjectPosition p_70227_1_)
    {
        if (!this.worldObj.isRemote)
        {
            if (p_70227_1_.entityHit != null)
            {
                ...
                {
                	((EntityLivingBase)p_70227_1_.entityHit).addPotionEffect(new PotionEffect(Potion.digSlowdown.id, 200, 0));
                	((EntityLivingBase)p_70227_1_.entityHit).addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 200, 0));
                }
            }
            else
            {
