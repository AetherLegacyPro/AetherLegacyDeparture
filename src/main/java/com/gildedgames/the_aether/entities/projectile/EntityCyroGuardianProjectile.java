...
public class EntityCyroGuardianProjectile extends EntityFireball {
    ...
    public EntityCyroGuardianProjectile(World p_i1770_1_) {
        super(p_i1770_1_);
        this.setSize(0.0125F, 0.0125F);
    }

    public EntityCyroGuardianProjectile(World p_i1771_1_, EntityLivingBase p_i1771_2_, double p_i1771_3_,
        double p_i1771_5_, double p_i1771_7_) {
        super(p_i1771_1_, p_i1771_2_, p_i1771_3_, p_i1771_5_, p_i1771_7_);
        this.setSize(0.3125F, 0.3125F);
    }

    public EntityCyroGuardianProjectile(World p_i1772_1_, double p_i1772_2_, double p_i1772_4_, double p_i1772_6_,
    ...
    protected void onImpact(MovingObjectPosition p_70227_1_) {
        if (!this.worldObj.isRemote) {
            if (p_70227_1_.entityHit != null) {
                if (p_70227_1_.entityHit
                    .attackEntityFrom(DamageSource.causeFireballDamage(this, this.shootingEntity), 5.0F)) {
                    ((EntityLivingBase) p_70227_1_.entityHit)
                        .addPotionEffect(new PotionEffect(Potion.digSlowdown.id, 200, 0));
                    ((EntityLivingBase) p_70227_1_.entityHit)
                        .addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 200, 0));
                }
            } else {
