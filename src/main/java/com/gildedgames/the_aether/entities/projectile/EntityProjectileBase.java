...
public abstract class EntityProjectileBase extends Entity implements IProjectile, IThrowableEntity {
    ...
    public void onUpdate() {
        ...
        Vec3 vec31 = Vec3.createVectorHelper(
            this.posX + this.motionX + this.getBoundingBoxExpansion(),
            this.posY + this.motionY + this.getBoundingBoxExpansion(),
            this.posZ + this.motionZ + this.getBoundingBoxExpansion());
