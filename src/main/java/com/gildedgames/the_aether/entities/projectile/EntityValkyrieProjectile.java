...
public class EntityValkyrieProjectile extends EntityProjectileBase {
	...
	public EntityValkyrieProjectile(World worldIn, EntityLivingBase shooter) {
	...
	protected void onImpact(MovingObjectPosition object) {
		if (object.typeOfHit == MovingObjectType.ENTITY) {
			if (object.entityHit instanceof EntitySaddleMount && ((EntitySaddleMount) object.entityHit).isSaddled()) {
				...
				object.entityHit.attackEntityFrom(DamageSource.causeMobDamage(this.getThrower()), 40);
				object.entityHit.addVelocity(this.motionX, 0.1D, this.motionZ);
			}
		}
