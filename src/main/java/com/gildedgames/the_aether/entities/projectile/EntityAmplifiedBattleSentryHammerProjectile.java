...
public class EntityAmplifiedBattleSentryHammerProjectile extends EntityProjectileBase {

	public ArrayList<Block> harvestBlockBans = new ArrayList<>();

	public EntityAmplifiedBattleSentryHammerProjectile(World worldIn) {
		super(worldIn);
	}

	public EntityAmplifiedBattleSentryHammerProjectile(World worldIn, EntityLivingBase shooter) {
	...
	protected void onImpact(MovingObjectPosition object) {
		if (object.typeOfHit == MovingObjectType.ENTITY) {
			if (object.entityHit instanceof EntitySaddleMount && ((EntitySaddleMount) object.entityHit).isSaddled()) {
				...
				object.entityHit.addVelocity(this.motionX, 0.17D, this.motionZ);
			}
		}
