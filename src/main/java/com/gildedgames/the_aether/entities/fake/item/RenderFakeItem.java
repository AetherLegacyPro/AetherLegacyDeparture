...
public class RenderFakeItem extends Render {
    ...
    public void doRenderItem(final EntityFakeItem par1Entity, final double par2, final double par4, final double par6,
        final float par8, final float par9) {
        this.random.setSeed(187L);
        final ItemStack itemstack = par1Entity.getEntityItem();
        if (itemstack.getItem() != null) {
            GL11.glPushMatrix();
            final float f2 = this.shouldBob()
                ? (MathHelper.sin((par1Entity.age + par9) / 10.0f + par1Entity.hoverStart) * 0.1f + 0.1f)
                : 0.0f;
            ...
            if (!renderEntityItem(
                ...
                this.field_147909_c,
                count)) {
                if (itemstack.getItemSpriteNumber() == 0 && block != Blocks.air
                    ...
                    .requiresMultipleRenderPasses()) {
                        ...
                        for (int k = 0; k < itemstack.getItem()
                            .getRenderPasses(itemstack.getItemDamage()); ++k) {
                            this.random.setSeed(187L);
                            final IIcon icon = itemstack.getItem()
                                .getIcon(itemstack, k);
                            final float f8 = 1.0f;
                            if (this.renderWithColor) {
                                final int i = itemstack.getItem()
    ...
    private void renderDroppedItem(final EntityFakeItem par1EntityItem, IIcon par2IIcon, final int par3,
        ...
        if (this.renderManager.options.fancyGraphics) {
            ...
            if (RenderFakeItem.renderInFrame) {
                ...
                GL11.glRotatef(
                    ((par1EntityItem.age + par4) / 20.0f + par1EntityItem.hoverStart) * 57.295776f,
                    0.0f,
                    1.0f,
                    0.0f);
            }
            ...
            for (int k = 0; k < b0; ++k) {
                ...
                ItemRenderer.renderItemIn2D(
                    ...
                    f4,
                    f7,
                    par2IIcon.getIconWidth(),
                    par2IIcon.getIconHeight(),
                    f11);
    ...
    public static boolean renderEntityItem(final EntityFakeItem entity, final ItemStack item, final float bobing,
        final float rotation, final Random random, final TextureManager engine, final RenderBlocks renderBlocks,
        final int count) {
        final IItemRenderer customRenderer = MinecraftForgeClient
            .getItemRenderer(item, IItemRenderer.ItemRenderType.ENTITY);
        ...
        final boolean is3D = customRenderer.shouldUseRenderHelper(
            IItemRenderer.ItemRenderType.ENTITY,
            item,
        ...
        if (is3D || (block != null && RenderBlocks.renderItemIn3d(block.getRenderType()))) {
            ...
            final float scale = (renderType == 1 || renderType == 19 || renderType == 12 || renderType == 2) ? 0.5f
                : 0.25f;
