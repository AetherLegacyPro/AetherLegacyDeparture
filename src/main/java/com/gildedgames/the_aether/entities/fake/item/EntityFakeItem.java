...
public class EntityFakeItem extends Entity {
    ...
    private void searchForOtherItemsNearby() {
        for (final Object o : this.worldObj
            .getEntitiesWithinAABB((Class) EntityFakeItem.class, this.boundingBox.expand(0.5, 0.0, 0.5))) {
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final int par2) {
        ...
        if (this.getEntityItem() != null && this.getEntityItem()
            .getItem() == Items.nether_star && par1DamageSource.isExplosion()) {
            return false;
        }
    ...
    public ItemStack getEntityItem() {
        final ItemStack itemstack = this.getDataWatcher()
            .getWatchableObjectItemStack(10);
        if (itemstack == null) {
