...
public class EntityFakeItem extends Entity {
    ...
    public EntityFakeItem(final World world, final double par2, final double par4, final double par6) {
        super(world);
        this.age = 0;
        this.health = 5;
    ...
    public EntityFakeItem(final World world, final double par2, final double par4, final double par6, final ItemStack par8ItemStack) {
