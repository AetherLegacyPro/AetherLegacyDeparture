...
public class EntityCyroParticle extends EntityFX {
    ...
    public EntityCyroParticle(final World world, final double x, final double y, final double z, final double mx,
