...
public class EntityAmplifierFlame extends EntityFX {
    ...
    public EntityAmplifierFlame(final World world, final double x, final double y, final double z, final double mx,
