...
public class EntityCloudSmokeFX extends EntityFX {
    ...
    public EntityCloudSmokeFX(World world, double x, double y, double z, double initialMotionX, double initialMotionY,
        double intialMotionZ, float size, float red, float blue, float green, double riseRate) {
    ...
    public void renderParticle(Tessellator renderer, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        renderer.addVertexWithUV(f11 + f1 * f10 + f4 * f10, f12 + f2 * f10, f13 + f3 * f10 + f5 * f10, f61, f8);
        renderer.addVertexWithUV(f11 + f1 * f10 - f4 * f10, f12 - f2 * f10, f13 + f3 * f10 - f5 * f10, f61, f9);
    }
