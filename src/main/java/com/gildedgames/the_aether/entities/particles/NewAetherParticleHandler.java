...
public enum NewAetherParticleHandler {
    ...
    CYRO(EntityCyroParticle.class, ParticleData.VX_VY_VZ,
        new Class[] { Integer.TYPE, Float.TYPE, Integer.TYPE, ResourceLocation.class, Integer.TYPE }) {
    ...
    URKER_FLAME(EntityEtherealTorchFlame.class, ParticleData.VX_VY_VZ,
        new Class[] { Integer.TYPE, Float.TYPE, Integer.TYPE, ResourceLocation.class, Integer.TYPE }) {
    ...
    AMPLIFIER_FLAME(EntityAmplifierFlame.class, ParticleData.VX_VY_VZ,
        new Class[] { Integer.TYPE, Float.TYPE, Integer.TYPE, ResourceLocation.class, Integer.TYPE }) {
    ...
    DRAGON_FLAME(EntityAmplifierFlame.class, ParticleData.VX_VY_VZ,
        new Class[] { Integer.TYPE, Float.TYPE, Integer.TYPE, ResourceLocation.class, Integer.TYPE }) {
    ...
    AMBROSIUM_FLAME(EntityEtherealTorchFlame.class, ParticleData.VX_VY_VZ,
        new Class[] { Integer.TYPE, Float.TYPE, Integer.TYPE, ResourceLocation.class, Integer.TYPE }) {
    ...
    HELLFIRE_FLAME(EntityEtherealTorchFlame.class, ParticleData.VX_VY_VZ,
        new Class[] { Integer.TYPE, Float.TYPE, Integer.TYPE, ResourceLocation.class, Integer.TYPE }) {
    ...
    ELYSIAN_TELEPORT(EntityEtherealTorchFlame.class, ParticleData.VX_VY_VZ,
        new Class[] { Integer.TYPE, Float.TYPE, Integer.TYPE, ResourceLocation.class, Integer.TYPE }) {
    ...
    ETHEREAL_FLAME(EntityEtherealTorchFlame.class, ParticleData.VX_VY_VZ,
        new Class[] { Integer.TYPE, Float.TYPE, Integer.TYPE, ResourceLocation.class, Integer.TYPE }) {
    ...
    private NewAetherParticleHandler(final Class<? extends EntityFX> fxClass, final float r, final float g,
        final float b) {
        this(fxClass, r, g, b, ParticleData.VX_VY_VZ, new Class[0]);
    }

    private NewAetherParticleHandler(final Class<? extends EntityFX> fxClass, final ParticleData args,
        final Class<?>[] additionalArgTypes) {
        this(fxClass, -1.0f, 57005.0f, 49374.0f, args, additionalArgTypes);
    }

    private NewAetherParticleHandler(final Class<? extends EntityFX> fxClass, final float r, final float g,
        final float b, final ParticleData args, final Class<?>[] additionalArgTypes) {
    ...
    private static Class<?>[] getArgumentTypes(final ParticleData args, final Class<?>[] additionalArgTypes) {
        final Class<?>[] argumentTypes = (Class<?>[]) new Class[4 + args.getArgumentCount()
    ...
    public final void spawn(final World world, final double x, final double y, final double z, final double motionX,
        final double motionY, final double motionZ, final float scale, final Object... data) {
        ...
        try {
            ...
            categoryNetherliciousParticle
                .addCrashSection("Additional Arg Types", Arrays.toString(this.additionalArgTypes));
            final CrashReportCategory categoryArguments = crash.makeCategory("Arguments");
    ...
    private Object[] getArguments(final World world, final double x, final double y, final double z,
        final double motionX, final double motionY, final double motionZ, final float scale, final Object... data) {
