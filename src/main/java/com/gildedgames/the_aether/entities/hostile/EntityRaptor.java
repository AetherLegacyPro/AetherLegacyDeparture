...
public class EntityRaptor extends EntityMob {
    ...
    public EntityRaptor(World world) {
        ...
        this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityMoa.class, 5.0F));
        this.tasks.addTask(8, new EntityAILookIdle(this));
        this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, EntityPlayer.class, 0, true));
        this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, EntityMoa.class, 0, true));
    }
    ...
    public boolean getCanSpawnHere() {
        return this.rand.nextInt(AetherConfig.getRaptorSpawnrate()) == 0 && super.getCanSpawnHere();
    }
    ...
    public void shootTarget() {
        ...
        EntityArrow entityarrow = new EntityDartGolden(this.worldObj, this, 1.0F);
