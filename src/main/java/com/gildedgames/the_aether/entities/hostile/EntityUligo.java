...
public class EntityUligo extends EntityLiving implements IMob {
    ...
    protected void setSlimeSize(int p_70799_1_) {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth)
            .setBaseValue(p_70799_1_ * p_70799_1_);
        ...
        if (this.onGround && !flag) {
            ...
            if (this.makesSoundOnLand()) {
                this.playSound(
                    this.getJumpSound(),
                    this.getSoundVolume(),
                    ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.4F + 1.0F) / 0.8F);
            }
    ...
    public void onCollideWithPlayer(EntityPlayer p_70100_1_) {
        if (this.canDamagePlayer()) {
            ...
            if (this.canEntityBeSeen(p_70100_1_)
                && this.getDistanceSqToEntity(p_70100_1_) < 0.6D * (double) i * 0.6D * (double) i
    ...
    private void func_146077_cc() {
        if (!this.worldObj.isRemote) {
            ...
            if (this.getPowered()) {
                this.worldObj
                    .createExplosion(this, this.posX, this.posY, this.posZ, (float) (this.explosionRadius * 2), flag);
    ...
    public float getBlockPathWeight(final int par1, final int par2, final int par3) {
        return ((this.worldObj.getBlock(par1, par2 - 1, par3) == BlocksAether.locked_fuse_stone
            || this.worldObj.getBlock(par1, par2 - 1, par3) == BlocksAether.locked_creeping_stone)) ? 10.0f
    ...
    public boolean getCanSpawnHere() {
        ...
        return (this.worldObj.getBlock(i, j - 1, k) == BlocksAether.locked_creeping_stone
            || this.worldObj.getBlock(i, j - 1, k) == BlocksAether.locked_fuse_stone)
