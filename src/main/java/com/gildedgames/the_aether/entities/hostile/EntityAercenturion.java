...
public class EntityAercenturion extends EntityMob {
    ...
    public void onLivingUpdate() {
        if (this.worldObj.isRemote) if (Minecraft.getMinecraft().thePlayer.capabilities.isCreativeMode == false) {
            List<Entity> volume2 = this.worldObj
                .getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.expand(5, 5, 5));
            for (Entity entity2 : volume2) {
                if (entity2 instanceof EntityPlayer && this.canEntityBeSeen(entity2))
                    ((EntityPlayer) entity2).addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 120, 1, true));
            }
        }
        ...
        if (this.entityToAttack instanceof EntityPlayer
            ...
            if (this.getEntityToAttack() != null) {
                if (this.getAttackTarget() instanceof EntityPlayer
                    ...
                    this.getLookHelper()
                        .setLookPositionWithEntity(this.getEntityToAttack(), 30.0F, 30.0F);
    ...
    public void shootTarget() {
        ...
        this.playSound(
            "aether_legacy:aemob.aercenturion.seenEnemy",
            2.0F,
    ...
    private boolean shouldAttackPlayer(EntityPlayer p_70821_1_) {
        Vec3 vec3 = p_70821_1_.getLook(1.0F)
            .normalize();
        Vec3 vec31 = Vec3.createVectorHelper(
            this.posX - p_70821_1_.posX,
    ...
    public boolean attackEntityAsMob(final Entity target) {
        ...
        if (target instanceof EntityPlayer) {
            ...
            if (helmet != null) hasdivineralHelmet = ((helmet.getItem() == ItemsAether.divineral_helmet)
                || (helmet.getItem() == ItemsAether.amplified_arkenium_helmet)
                || (helmet.getItem() == ItemsAether.amplified_continuum_helmet)
                || (helmet.getItem() == ItemsAether.amplified_neptune_helmet)
                || (helmet.getItem() == ItemsAether.amplified_valkyrie_helmet)
                || (helmet.getItem() == ItemsAether.amplified_zanite_helmet)
                || (helmet.getItem() == ItemsAether.amplified_phoenix_helmet)
                || (helmet.getItem() == ItemsAether.amplified_obsidian_helmet));

            if (chest != null) hasdivineralChest = ((chest.getItem() == ItemsAether.divineral_chestplate)
                || (chest.getItem() == ItemsAether.amplified_arkenium_chestplate)
                || (chest.getItem() == ItemsAether.amplified_continuum_chestplate)
                || (chest.getItem() == ItemsAether.amplified_neptune_chestplate)
                || (chest.getItem() == ItemsAether.amplified_valkyrie_chestplate)
                || (chest.getItem() == ItemsAether.amplified_zanite_chestplate)
                || (chest.getItem() == ItemsAether.amplified_phoenix_chestplate)
                || (chest.getItem() == ItemsAether.amplified_obsidian_chestplate));

            if (legs != null) hasdivineralLegs = ((legs.getItem() == ItemsAether.divineral_leggings)
                || (legs.getItem() == ItemsAether.amplified_arkenium_leggings)
                || (legs.getItem() == ItemsAether.amplified_continuum_leggings)
                || (legs.getItem() == ItemsAether.amplified_neptune_leggings)
                || (legs.getItem() == ItemsAether.amplified_valkyrie_leggings)
                || (legs.getItem() == ItemsAether.amplified_zanite_leggings)
                || (legs.getItem() == ItemsAether.amplified_phoenix_leggings)
                || (legs.getItem() == ItemsAether.amplified_obsidian_leggings));

            if (boots != null) hasdivineralBoots = ((boots.getItem() == ItemsAether.divineral_boots)
                || (boots.getItem() == ItemsAether.amplified_arkenium_boots)
                || (boots.getItem() == ItemsAether.amplified_continuum_boots)
                || (boots.getItem() == ItemsAether.amplified_neptune_boots)
                || (boots.getItem() == ItemsAether.amplified_valkyrie_boots)
                || (boots.getItem() == ItemsAether.amplified_zanite_boots)
                || (boots.getItem() == ItemsAether.amplified_phoenix_boots)
                || (boots.getItem() == ItemsAether.amplified_obsidian_boots)
            ...
            if (hasdivineralHelmet || hasdivineralChest || hasdivineralLegs || hasdivineralBoots) {
                ...
                final boolean flag = target
                    .attackEntityFrom(DamageSource.causeMobDamage(this), (float) (6 + this.rand.nextInt(5)));
                if (flag) {
                ...
                this.worldObj.setEntityState(this, (byte) 4);
                final boolean flag = target
                    .attackEntityFrom(DamageSource.causeMobDamage(this), (float) (12 + this.rand.nextInt(5)));
                if (flag) {
                    target.motionY += 0.4000000059604645;
                }
