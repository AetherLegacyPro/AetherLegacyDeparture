...
public class EntityUro extends EntityMob {
    ...
    public void onDeath(DamageSource source) {
        ...
        if (source.getEntity() instanceof EntityCockatrice) {
    ...
    protected boolean interact(EntityPlayer p_70085_1_) {
        ...
        if (itemstack != null && (itemstack.getItem() == Items.flint_and_steel || itemstack.getItem() == ItemsAether.zanite_and_cinerarium)) {
