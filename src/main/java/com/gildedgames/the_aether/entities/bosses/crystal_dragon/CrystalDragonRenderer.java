...
public class CrystalDragonRenderer extends RenderLiving {
    ...
    private static final ResourceLocation genesisDragonExplodingTextures = Aether
        .locate("textures/entities/crystal_dragon/crystal_dragon_exploding.png");
    private static final ResourceLocation genesisDragonCrystalBeamTextures = Aether
        .locate("textures/entities/crystal_dragon/genesis_endercrystal_beam.png");
    private static final ResourceLocation genesisDragonEyesTextures = Aether
        .locate("textures/entities/crystal_dragon/crystal_dragon_eyes.png");
    private static final ResourceLocation genesisDragonTextures = Aether
        .locate("textures/entities/crystal_dragon/crystal_dragon.png");
     ...
     */
    protected void renderModel(EntityCrystalDragon p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_,
     ...
     */
    public void doRender(EntityCrystalDragon p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
    ...
    protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_,
        float p_77036_5_, float p_77036_6_, float p_77036_7_) {
        this.renderModel(
            (EntityCrystalDragon) p_77036_1_,
            p_77036_2_,
            p_77036_3_,
            p_77036_4_,
            p_77036_5_,
