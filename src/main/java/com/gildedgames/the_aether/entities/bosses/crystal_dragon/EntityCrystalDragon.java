...
public class EntityCrystalDragon extends EntityFlying implements GIEntityMultiPartTwo, IMob {
    ...
    public EntityCrystalDragon(final World p_i1700_1_) {
        super(p_i1700_1_);
        this.dragonPartArray = new EntityCrystalDragonPart[] {
            this.dragonPartHead = new EntityCrystalDragonPart(this, "head", 6.0F, 6.0F),
            this.dragonPartBody = new EntityCrystalDragonPart(this, "body", 8.0F, 8.0F),
            this.dragonPartTail1 = new EntityCrystalDragonPart(this, "tail", 4.0F, 4.0F),
            this.dragonPartTail2 = new EntityCrystalDragonPart(this, "tail", 4.0F, 4.0F),
            this.dragonPartTail3 = new EntityCrystalDragonPart(this, "tail", 4.0F, 4.0F),
            this.dragonPartWing1 = new EntityCrystalDragonPart(this, "wing", 4.0F, 4.0F),
            this.dragonPartWing2 = new EntityCrystalDragonPart(this, "wing", 4.0F, 4.0F) };
    ...
    public boolean getCanSpawnHere() {
        ...
        return (this.worldObj.getBlock(i, j - 1, k) == BlocksAether.genesis_stone
            || this.worldObj.getBlock(i, j - 1, k) == BlocksAether.light_genesis_stone) && canSpawn;
    ...
    public void onLivingUpdate() {
        ...
        List<Entity> volume = this.worldObj
            .getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.expand(4, 4, 4));
    ...
    private void attackEntitiesInList(List p_70971_1_) {
        for (int i = 0; i < p_70971_1_.size(); ++i) {
            ...
            if (!((entity instanceof EntityIrk) || (entity instanceof EntityElysianGuardian)
                || (entity instanceof EntityCrystalDragon)
                || (entity instanceof EntityGenesisDragon))) {
    ...
    public boolean aattackEntityFromPart(EntityCrystalDragonPart p_70965_1_, DamageSource p_70965_2_,
        float p_70965_3_) {
        ...
        if (ds.getEntity() instanceof EntityPlayer) {
            ...
            if (entity instanceof EntityPlayer) {
                ...
                if (stack != null && stack.getItem() != null
                    && (stack.getItem() == ItemsAether.dragon_bane
                        || stack.getItem() == ItemsAether.tipped_dragon_bane)) {
                    ...
                    && stack.getItem() == ItemsAether.amplified_dragon_bane) {
