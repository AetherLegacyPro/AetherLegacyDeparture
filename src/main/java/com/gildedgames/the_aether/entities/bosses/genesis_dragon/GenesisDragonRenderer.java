...
public class GenesisDragonRenderer extends RenderLiving {
    ...
    private static final ResourceLocation genesisDragonExplodingTextures = Aether
        .locate("textures/bosses/genesis_dragon/genesis_dragon_exploding.png");
    private static final ResourceLocation genesisDragonCrystalBeamTextures = Aether
        .locate("textures/bosses/genesis_dragon/genesis_endercrystal_beam.png");
    ...
    protected void rotateCorpse(EntityGenesisDragon p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_) {
     ...
     */
    protected void renderModel(EntityGenesisDragon p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_,
     ...
     */
    public void doRender(EntityGenesisDragon p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
        ...
        if (p_76986_1_.healingEnderCrystal != null) {
            ...
            float f5 = (float) ((double) f3 + p_76986_1_.healingEnderCrystal.posY
                - 1.0D
                - p_76986_1_.posY
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGenesisDragon p_110775_1_) {
        return genesisDragonTextures;
    }

    protected void renderEquippedItems(EntityGenesisDragon p_77029_1_, float p_77029_2_) {
     ...
     */
    protected int shouldRenderPass(EntityGenesisDragon p_77032_1_, int p_77032_2_, float p_77032_3_) {
        if (p_77032_2_ == 1) {
            GL11.glDepthFunc(GL11.GL_LEQUAL);
        }
    ...
    protected int shouldRenderPass(EntityLivingBase p_77032_1_, int p_77032_2_, float p_77032_3_) {
        return this.shouldRenderPass((EntityGenesisDragon) p_77032_1_, p_77032_2_, p_77032_3_);
    }

    protected void renderEquippedItems(EntityLivingBase p_77029_1_, float p_77029_2_) {
        this.renderEquippedItems((EntityGenesisDragon) p_77029_1_, p_77029_2_);
    }

    protected void rotateCorpse(EntityLivingBase p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_) {
        this.rotateCorpse((EntityGenesisDragon) p_77043_1_, p_77043_2_, p_77043_3_, p_77043_4_);
    }
    ...
    protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_,
        float p_77036_5_, float p_77036_6_, float p_77036_7_) {
        this.renderModel(
            (EntityGenesisDragon) p_77036_1_,
            p_77036_2_,
            p_77036_3_,
            p_77036_4_,
            p_77036_5_,
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return this.getEntityTexture((EntityGenesisDragon) p_110775_1_);
    }
    ...
    static {
        ...
        genesisDragonEyesTextures = new ResourceLocation(
            "aether_legacy",
            "textures/bosses/genesis_dragon/genesis_dragon_eyes.png");
    }
