...
public class EntityCrystalDragonPart extends Entity {

    /** The dragon entity this dragon part belongs to */
    public final GIEntityMultiPartTwo entityDragonObj;
    public final String field_146032_b;

    public EntityCrystalDragonPart(GIEntityMultiPartTwo p_i1697_1_, String p_i1697_2_, float p_i1697_3_,
        float p_i1697_4_) {
    ...
    public boolean attackEntityFrom(DamageSource p_70097_1_, float p_70097_2_) {
        return this.isEntityInvulnerable() ? false
            : this.entityDragonObj.aattackEntityFromPart(this, p_70097_1_, p_70097_2_);
    }
