...
public class EntityGenesisDragon extends EntityFlying implements IAetherBoss, GIEntityMultiPart, IMob {
    ...
    public EntityGenesisDragon(final World world) {
        super(world);
    ...
    public void onLivingUpdate() {
        ...
        int summon = (int)(1 + Math.random() * 20);
        if (summon == 1) {
    ...
    public boolean aattackEntityFromPart(EntityGenesisDragonPart entityGenesisDragonPart, DamageSource source, float p_70965_3_) {
        if (entityGenesisDragonPart != this.dragonPartHead) {
    ...
    public boolean attackEntityFrom(DamageSource ds, float i) {
        if (ds.getEntity() instanceof EntityPlayer) {
            ...
            int summon = (int)(1 + Math.random() * 50);
       	 	if(summon == 1 ) {
        ...
        Entity entity = ds.getEntity();
     	if (entity instanceof EntityPlayer) {
     	int lightning = (int)(1 + Math.random() * 14);
     	switch (lightning) {
     	case 1:
		...
		if (stack != null && stack.getItem() != null && (stack.getItem() == ItemsAether.dragon_bane || stack.getItem() == ItemsAether.tipped_dragon_bane)) {
			 ...
			 int damage_source = (int)(1 + Math.random() * 4);
			 int drop_amount = (int)(1 + Math.random() * 24);
		        	...
		        	case 1:
		        		...
		        		if (this.getHealth() <= 0 || this.isDead) {
		        	        ...
		        	        int k;
		        	        {
		        	            ...
		        	            for (k = 0; k < j; ++k)
		        	            {
		        	                this.dropItem(ItemsAether.elysian_dragon_scales, 12 + drop_amount);
		        	            }
		        	        }
		        		}
		        	}
			 ...
			 int damage_source = (int)(1 + Math.random() * 4);
			 int drop_amount2 = (int)(1 + Math.random() * 24);
			 switch (damage_source) {
	        		case 1:
	        			...
	        			if (this.getHealth() <= 0 || this.isDead) {
		        	        ...
		        	        int k;
		        	        {
		        	            ...
		        	            for (k = 0; k < j; ++k)
		        	            {
		        	                this.dropItem(ItemsAether.elysian_dragon_scales, 12 + drop_amount2);
		        	            }
		        	        }
		        		 }
	        			}
    ...
    private ItemStack getScales(Random random) {
		return new ItemStack(ItemsAether.elysian_dragon_scales, random.nextInt(30) + 24);
	}
    ...
    public void onDeath(DamageSource source) {
        ...
        if (source.getEntity() instanceof EntityPlayer) {
            ((EntityPlayer) source.getEntity()).triggerAchievement(AchievementsAether.defeat_palladium);
        }
    }
