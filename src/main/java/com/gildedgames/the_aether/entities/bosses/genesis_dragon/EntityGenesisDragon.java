...
public class EntityGenesisDragon extends EntityFlying implements IAetherBoss, GIEntityMultiPart, IMob {
    ...
    public EntityGenesisDragon(final World p_i1700_1_) {
        super(p_i1700_1_);
        this.dragonPartArray = new EntityGenesisDragonPart[] {
            this.dragonPartHead = new EntityGenesisDragonPart(this, "head", 6.0F, 6.0F),
            this.dragonPartBody = new EntityGenesisDragonPart(this, "body", 8.0F, 8.0F),
            this.dragonPartTail1 = new EntityGenesisDragonPart(this, "tail", 4.0F, 4.0F),
            this.dragonPartTail2 = new EntityGenesisDragonPart(this, "tail", 4.0F, 4.0F),
            this.dragonPartTail3 = new EntityGenesisDragonPart(this, "tail", 4.0F, 4.0F),
            this.dragonPartWing1 = new EntityGenesisDragonPart(this, "wing", 4.0F, 4.0F),
            this.dragonPartWing2 = new EntityGenesisDragonPart(this, "wing", 4.0F, 4.0F) };
    ...
    public void FireBreath() {
        if (this.worldObj.isRemote) {
            ...
            for (int i = 0; i < 6; i++) {
                ...
                double spread = 6 + this.getRNG()
                    .nextDouble() * 2.5;
                double velocity = 1.15 + this.getRNG()
                    .nextDouble() * 0.45;

                dx += this.getRNG()
                    .nextGaussian() * 0.007499999832361937D
                    * spread;
                dy += this.getRNG()
                    .nextGaussian() * 0.007499999832361937D
                    * spread;
    ...
    public void onLivingUpdate() {
        ...
        if (this.getHealth() <= 0.0F) {
            ...
            f = 0.2F
                / (MathHelper.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ) * 20.0F + 1.0F); // 10.0
            ...
            if (!this.worldObj.isRemote && this.hurtTime == 0) {
                this.collideWithEntities(
                    this.worldObj.getEntitiesWithinAABBExcludingEntity(
                        this,
                        this.dragonPartWing1.boundingBox.expand(4.0D, 2.0D, 4.0D)
                            .offset(0.0D, -2.0D, 0.0D)));
                this.collideWithEntities(
                    this.worldObj.getEntitiesWithinAABBExcludingEntity(
                        this,
                        this.dragonPartWing2.boundingBox.expand(4.0D, 2.0D, 4.0D)
                            .offset(0.0D, -2.0D, 0.0D)));
        ...
        List<Entity> volume = this.worldObj
            .getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.expand(10, 10, 10));

        for (Entity entity : volume) {
            if (entity instanceof EntityPlayer && this.canEntityBeSeen(entity)) {
                if (worldObj.isRemote) this.FireBreath();
            }
        }
    }
    ...
    public void playBreathSound() {
        worldObj.playSoundEffect(
            ...
            this.posY + 0.5,
            this.posZ + 0.5,
            "nova_craft:deepoid.breath",
            rand.nextFloat() * 0.5F,
            rand.nextFloat() * 0.5F); // mob.enderdragon.growl
    }
    ...
    private void collideWithEntities(List p_70970_1_) {
        ...
        while (iterator.hasNext()) {
            ...
            if (entity instanceof EntityLivingBase
                && !(entity instanceof EntityCrystalDragon || entity instanceof EntityCrystalDragonPart)) {
    ...
    public boolean aattackEntityFromPart(EntityGenesisDragonPart p_70965_1_, DamageSource p_70965_2_,
        float p_70965_3_) {
    ...
    public boolean attackEntityFrom(DamageSource ds, float i) {
        ...
        if (entity instanceof EntityPlayer) {
            ...
            switch (random1) {
                case 1:
                    this.worldObj
                        .addWeatherEffect(new EntityLightningBolt(this.worldObj, this.posX, this.posY, this.posZ));
                    break;
                case 2:
                    this.worldObj
                        .addWeatherEffect(new EntityLightningBolt(this.worldObj, this.posX + 2, this.posY, this.posZ));
                    this.worldObj
                        .addWeatherEffect(new EntityLightningBolt(this.worldObj, this.posX - 2, this.posY, this.posZ));
                    this.worldObj
                        .addWeatherEffect(new EntityLightningBolt(this.worldObj, this.posX, this.posY, this.posZ + 2));
                    this.worldObj
                        .addWeatherEffect(new EntityLightningBolt(this.worldObj, this.posX, this.posY, this.posZ - 2));
                    break;
                case 3:
                    this.worldObj
                        .addWeatherEffect(new EntityLightningBolt(this.worldObj, this.posX + 4, this.posY, this.posZ));
                    this.worldObj
                        .addWeatherEffect(new EntityLightningBolt(this.worldObj, this.posX - 4, this.posY, this.posZ));
                    this.worldObj
                        .addWeatherEffect(new EntityLightningBolt(this.worldObj, this.posX, this.posY, this.posZ + 4));
                    this.worldObj
                        .addWeatherEffect(new EntityLightningBolt(this.worldObj, this.posX, this.posY, this.posZ - 4));
                    break;
                case 4:
                ...
                case 7:
                    this.worldObj
                        .addWeatherEffect(new EntityLightningBolt(this.worldObj, this.posX + 8, this.posY, this.posZ));
                    this.worldObj
                        .addWeatherEffect(new EntityLightningBolt(this.worldObj, this.posX - 8, this.posY, this.posZ));
                    this.worldObj
                        .addWeatherEffect(new EntityLightningBolt(this.worldObj, this.posX, this.posY, this.posZ + 8));
                    this.worldObj
                        .addWeatherEffect(new EntityLightningBolt(this.worldObj, this.posX, this.posY, this.posZ - 8));
                    this.worldObj
                        .addWeatherEffect(new EntityLightningBolt(this.worldObj, this.posX, this.posY, this.posZ));
            ...
            if (stack != null && stack.getItem() != null
                && (stack.getItem() == ItemsAether.dragon_bane || stack.getItem() == ItemsAether.tipped_dragon_bane)) {
                ...
                switch (rand) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        this.damageEntity(DamageSource.generic, 3F);
                        if (!(this.worldObj.isRemote)) {
                            if (this.getHealth() <= 0 || this.isDead) {
                                this.entityDropItem(new ItemStack(ItemsAether.dungeon_key, 1, 14), 0.5F);
    ...
    public void createloot(World world, Random random, int p_70975_1_, int p_70975_2_, int p_70975_3_) {
        ...
        TileEntityTreasureChestBreakable chest = (TileEntityTreasureChestBreakable) world
            .getTileEntity(p_70975_1_, p_70975_2_ + 1, p_70975_3_);
        ...
        TileEntityElysianChest chest2 = (TileEntityElysianChest) worldObj
            .getTileEntity(p_70975_1_ + 2, p_70975_2_ + 1, p_70975_3_);
        chest2.setInventorySlotContents(random.nextInt(chest2.getSizeInventory()), this.getScales(random));

        this.worldObj.setBlock(p_70975_1_ - 2, p_70975_2_ + 1, p_70975_3_, BlocksAether.elysian_chest);
        TileEntityElysianChest chest3 = (TileEntityElysianChest) worldObj
            .getTileEntity(p_70975_1_ - 2, p_70975_2_ + 1, p_70975_3_);
    ...
    public String getBossName() {
        return this.dataWatcher.getWatchableObjectString(19) + ", "
            + StatCollector.translateToLocal("tile.aether_legacy.genesis_dragon.name");
    }
