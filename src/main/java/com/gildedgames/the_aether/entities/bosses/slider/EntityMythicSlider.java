...
public class EntityMythicSlider extends EntityFlying implements IAetherBoss {
                ...
                if (this.isCollided) {
                    ...
                    if (this.crushedBlock) {
                        this.worldObj.playSoundEffect(
                            ...
                            "random.explode",
                            3.0F,
                            (0.625F + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.4F) * 0.7F);
                        this.worldObj.playSoundEffect(
                            this.posX,
                            this.posY,
                            this.posZ,
                            ...
                            2.5F,
                            1.0F / (this.rand.nextFloat() * 0.4F + 0.9F));
                    }
    ...
    private void destroyBlock(double x, double y, double z) {
        ...
        if (block == Blocks.air || block == BlocksAether.locked_carved_stone
            || block == BlocksAether.locked_divine_carved_stone
            || block == BlocksAether.locked_sentry_stone
            || block == BlocksAether.carved_trap
            ...
            for (int k = 0; k < 4; ++k) {
                for (int l = 0; l < 4; ++l) {
                    ...
                    this.worldObj.spawnParticle(
                        "blockcrack_" + Block.getIdFromBlock(block) + "_" + metadata,
                        x + d0,
                        y + d1,
                        z + d2,
                        d0 - 0.5D,
        ...
        if (this.isAwake() && this.isMoving()) {
            ...
            if (flag && entity instanceof EntityLivingBase collidedEntity) {
                ...
                this.worldObj.playSoundEffect(
                    ...
                    "aether_legacy:aeboss.slider.collide",
                    3F,
                    1.0F / (this.rand.nextFloat() * 0.3F + 0.8F));
    ...
    public EntityItem entityDropItem(ItemStack stack, float offsetY) {
        if (stack.stackSize != 0 && stack.getItem() != null) {
            ...
            if (captureDrops) this.capturedDrops.add(entityitem);
    ...
    public boolean attackEntityFrom(DamageSource ds, float var2) {
        ...
        if (!((EntityPlayer) ds.getEntity()).capabilities.isCreativeMode && ds.getSourceOfDamage()
            .getDistance(this.posX, this.posY, this.posZ) > 6 && !this.isAwake()) {
            ...
            if (!((stack.getItem() == ItemsAether.divineral_pickaxe)
                ...
                || (stack.getItem() == ItemsAether.amplified_holystone_pickaxe)
        ...
        if (flag) {
                ...
                for (int j = 0; j < 8; ++j) {
                    for (int k = 0; k < 8; ++k) {
                        for (int l = 0; l < 8; ++l) {
                            ...
                            double d2 = ((double) l + 0.5D) / 4.0D;
                            this.worldObj.spawnParticle(
                                "blockcrack_" + BlocksAether.divineral_block + "_0",
                                a + d0,
                                b + d1,
                                c + d2,
                                d0 - 0.5D,
            ...
            if (this.getHealth() <= 0 || this.isDead) {
                ...
                this.worldObj
                    .setBlock(this.dungeonX + 6, this.dungeonY, this.dungeonZ + 6, BlocksAether.mythic_carved_stone);
                this.worldObj
                    .setBlock(this.dungeonX - 5, this.dungeonY, this.dungeonZ - 5, BlocksAether.mythic_carved_stone);
                this.worldObj
                    .setBlock(this.dungeonX + 4, this.dungeonY, this.dungeonZ - 4, BlocksAether.mythic_carved_stone);
                this.worldObj
                    .setBlock(this.dungeonX + 5, this.dungeonY, this.dungeonZ - 5, BlocksAether.mythic_carved_stone);
                this.worldObj
                    .setBlock(this.dungeonX - 6, this.dungeonY, this.dungeonZ - 2, BlocksAether.mythic_carved_stone);
                this.worldObj
                    .setBlock(this.dungeonX + 5, this.dungeonY, this.dungeonZ + 7, BlocksAether.mythic_carved_stone);
                ...
                for (int x = this.dungeonX - 27; x < this.dungeonX + 30; x++) {
                    for (int y = this.dungeonY - 1; y < this.dungeonY + 22; y++) {
                        for (int z = this.dungeonZ - 6; z < this.dungeonZ + 26; z++) {
                            ...
                            if (block == BlocksAether.locked_mythic_carved_stone
                                || block == BlocksAether.locked_mythic_sentry_stone) {
                ...
                this.worldObj.playSoundEffect(
                    ...
                    2.5F,
                    1.0F / (this.rand.nextFloat() * 0.2F + 0.9F));
                this.setDead();
            }
            ...
            if (!this.isAwake()) {
                this.worldObj.playSoundEffect(
                    ...
                    this.posY,
                    this.posZ,
                    "aether_legacy:aeboss_slider.awaken",
                    2.5F,
                    1.0F / (this.rand.nextFloat() * 0.2F + 0.9F));
    ...
    public String getBossName() {
        return this.dataWatcher.getWatchableObjectString(19) + ", "
            + StatCollector.translateToLocal("title.aether_legacy.mythic_slider.name");
    }
