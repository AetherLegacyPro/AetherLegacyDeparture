...
public class EntityMythicSlider extends EntityFlying implements IAetherBoss {
    ...
    public EntityMythicSlider(World world) {
        super(world);
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (this.isMoving()) {
                if (this.isCollided) {
                    ...
                    if (y > 4D) {
                        if (this.direction == EnumFacing.UP) {
                            for (int i = 0; i < 25; i++) {
                                double a = (double) ((i / 5) - 2) * 0.8D;
                                double b = (double) ((i % 5) - 2) * 0.8D;
                    ...
                    if (this.crushedBlock) {
                        this.worldObj.playSoundEffect(this.posX, this.posY, this.posZ, "random.explode", 3.0F, (0.625F + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.4F) * 0.7F);
                        this.worldObj.playSoundEffect(this.posX, this.posY, this.posZ, "aether_legacy:aeboss.slider.collide", 2.5F, 1.0F / (this.rand.nextFloat() * 0.4F + 0.9F));
                    }
                    ...
                    if (this.direction == EnumFacing.UP) {
                        ...
                        if (this.boundingBox.minY > this.getAttackTarget().boundingBox.minY + 0.65D) {
                            this.stop();
                            this.moveTime = this.criticalCondition() ? 2 : 4;
                        }
                    } else if (this.direction == EnumFacing.DOWN) {
                        this.motionY = -this.velocity;

                        if (this.boundingBox.minY < this.getAttackTarget().boundingBox.minY - 0.50D) {
                            this.stop();
                            this.moveTime = this.criticalCondition() ? 2 : 4;
                        }
                    } else if (this.direction == EnumFacing.EAST) {
                        ...
                        if (this.posX > this.getAttackTarget().posX + 0.225D) {
                            this.stop();
                            this.moveTime = this.criticalCondition() ? 2 : 4;
                        }
                    } else if (this.direction == EnumFacing.WEST) {
                        ...
                        if (this.posZ > this.getAttackTarget().posZ + 0.225D) {
                            this.stop();
                            this.moveTime = this.criticalCondition() ? 2 : 4;
                        }
                    } else if (this.direction == EnumFacing.NORTH) {
                ...
                if (this.moveTime > 0) {
                    ...
                    this.worldObj.playSoundEffect(this.posX, this.posY, this.posZ, "aether_legacy:aeboss.slider.move", 3F, 1.0F / (this.rand.nextFloat() * 0.4F + 0.9F));
                    this.setMoving(true);
                }
            }
        }
    ...
    private void closeDoor()
    {
        ...
        this.worldObj.setBlock(this.dungeonX + 6, this.dungeonY, this.dungeonZ + 6, BlocksAether.divine_carved_trap);
        this.worldObj.setBlock(this.dungeonX - 5, this.dungeonY, this.dungeonZ - 5, BlocksAether.divine_carved_trap);
        this.worldObj.setBlock(this.dungeonX + 4, this.dungeonY, this.dungeonZ - 4, BlocksAether.divine_carved_trap);
        this.worldObj.setBlock(this.dungeonX + 5, this.dungeonY, this.dungeonZ - 5, BlocksAether.divine_carved_trap);
        this.worldObj.setBlock(this.dungeonX - 6, this.dungeonY, this.dungeonZ - 2 , BlocksAether.divine_carved_trap);
        this.worldObj.setBlock(this.dungeonX + 5, this.dungeonY, this.dungeonZ + 7, BlocksAether.divine_carved_trap);
        this.worldObj.setBlock(this.dungeonX + 8, this.dungeonY, this.dungeonZ + 7, BlocksAether.divine_carved_trap);
        ...
        if (checkIsAir(this.dungeonX + 15, this.dungeonY + 1, this.dungeonZ + 6, this.dungeonX + 15, this.dungeonY + 4, this.dungeonZ + 9))
        {
            ...
            for(int y = this.dungeonY + 1; y < this.dungeonY + 8; y++)
            {
                ...
                {
                    this.worldObj.setBlock(x, y, z, BlocksAether.locked_mythic_carved_stone);
                }
            }
        }
    ...
    public void applyEntityCollision(Entity entity) {
        if (this.isAwake() && this.isMoving()) {
            boolean flag = entity.attackEntityFrom(new EntityDamageSource("crush", this), 80);

            if (flag && entity instanceof EntityLivingBase) {
                EntityLivingBase collidedEntity = (EntityLivingBase) entity;
                collidedEntity.addVelocity(collidedEntity.motionY, 0.9D, collidedEntity.motionZ);
                this.worldObj.playSoundEffect(this.posX, this.posY, this.posZ, "aether_legacy:aeboss.slider.collide", 3F, 1.0F / (this.rand.nextFloat() * 0.3F + 0.8F));
    ...
    public boolean attackEntityFrom(DamageSource ds, float var2) {
        ...
        if (flag) {
                ...
                for (int j = 0; j < 8; ++j) {
                    for (int k = 0; k < 8; ++k) {
                        for (int l = 0; l < 8; ++l) {
                            ...
                            double d1 = ((double) k + 0.5D) / 4.0D;
                            double d2 = ((double) l + 0.5D) / 4.0D;
                            this.worldObj.spawnParticle("blockcrack_" + BlocksAether.divineral_block + "_0", (double) a + d0, (double) b + d1, (double) c + d2, d0 - 0.5D, d1 - 0.5D, d2 - 0.5D);
                        }
                    }
                }
            }
            ...
            if (this.getHealth() <= 0 || this.isDead) {
                ...
                this.worldObj.setBlock(this.dungeonX + 7, this.dungeonY + 1, this.dungeonZ + 7, BlocksAether.skyroot_trapdoor, 3, 2);
                this.worldObj.setBlock(this.dungeonX + 8, this.dungeonY + 1, this.dungeonZ + 7, BlocksAether.skyroot_trapdoor, 2, 2);
                this.worldObj.setBlock(this.dungeonX + 7, this.dungeonY + 1, this.dungeonZ + 8, BlocksAether.skyroot_trapdoor, 3, 2);
                this.worldObj.setBlock(this.dungeonX + 8, this.dungeonY + 1, this.dungeonZ + 8, BlocksAether.skyroot_trapdoor, 2, 2);
                this.worldObj.setBlock(this.dungeonX + 7, this.dungeonY, this.dungeonZ + 7, Blocks.air);
                this.worldObj.setBlock(this.dungeonX + 8, this.dungeonY, this.dungeonZ + 7, Blocks.air);
                this.worldObj.setBlock(this.dungeonX + 7, this.dungeonY, this.dungeonZ + 8, Blocks.air);
                this.worldObj.setBlock(this.dungeonX + 8, this.dungeonY, this.dungeonZ + 8, Blocks.air);
                
                this.worldObj.setBlock(this.dungeonX + 6, this.dungeonY, this.dungeonZ + 6, BlocksAether.mythic_carved_stone);
                this.worldObj.setBlock(this.dungeonX - 5, this.dungeonY, this.dungeonZ - 5, BlocksAether.mythic_carved_stone);
                this.worldObj.setBlock(this.dungeonX + 4, this.dungeonY, this.dungeonZ - 4, BlocksAether.mythic_carved_stone);
                this.worldObj.setBlock(this.dungeonX + 5, this.dungeonY, this.dungeonZ - 5, BlocksAether.mythic_carved_stone);
                this.worldObj.setBlock(this.dungeonX - 6, this.dungeonY, this.dungeonZ - 2 , BlocksAether.mythic_carved_stone);
                this.worldObj.setBlock(this.dungeonX + 5, this.dungeonY, this.dungeonZ + 7, BlocksAether.mythic_carved_stone);
    ...
    public String getBossName() {
        return this.dataWatcher.getWatchableObjectString(19) + ", " + StatCollector.translateToLocal("title.aether_legacy.mythic_slider.name");
    }
