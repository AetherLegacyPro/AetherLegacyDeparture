...
public class CrystalDragonModel extends ModelBase {
    ...
    public CrystalDragonModel() { // +x left -xright //-z forward +z back
        ...
        (this.back_bottom_right_leg = new ModelRenderer((ModelBase) this, 56, 76))
            .setRotationPoint(16.0F, -3.25F, -2.5F);
        ...
        (this.top_bottom_left_leg = new ModelRenderer((ModelBase) this, 41, 76))
            .setRotationPoint(62.25F, -2.25F, -2.5F);
        ...
        (this.back_bottom_left_leg = new ModelRenderer((ModelBase) this, 56, 76))
            .setRotationPoint(62.25F, -2.25F, -2.5F);
        ...
        (this.right_wing_base_1 = new ModelRenderer((ModelBase) this, 35, 104))
            .setRotationPoint(-10.0F, -10.0F, -0.25F);
        ...
        (this.left_wing_base_2 = new ModelRenderer((ModelBase) this, 35, 104)).setRotationPoint(33.75F, 0.35F, 0.0F); // 21.75F,
                                                                                                                      // 0.35F,
                                                                                                                      // 0.0F
