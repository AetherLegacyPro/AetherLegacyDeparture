...
public class EntityValkyrieQueen extends EntityBossMob implements IAetherBoss {
    ...
    private void unlockTreasure() {
        this.worldObj.setBlock(this.dungeonX + 16, dungeonY + 1, dungeonZ + 9, BlocksAether.skyroot_trapdoor, 3, 2);
        this.worldObj.setBlock(this.dungeonX + 17, dungeonY + 1, dungeonZ + 9, BlocksAether.skyroot_trapdoor, 2, 2);
        this.worldObj.setBlock(this.dungeonX + 16, dungeonY + 1, dungeonZ + 10, BlocksAether.skyroot_trapdoor, 3, 2);
        this.worldObj.setBlock(this.dungeonX + 17, dungeonY + 1, dungeonZ + 10, BlocksAether.skyroot_trapdoor, 2, 2);
    ...
    public void displayValkyrieDialogue() {
        if (this.worldObj.isRemote) {
            FMLClientHandler.instance()
                .getClient()
                .displayGuiScreen(new GuiValkyrieDialogue(this));
        }
    }
