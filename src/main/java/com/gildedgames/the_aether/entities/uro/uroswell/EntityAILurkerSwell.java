...
public class EntityAILurkerSwell extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        if (rand == 10) {
            ...
            return this.swellingLurker.getCreeperState() > 0
                || entitylivingbase != null && this.swellingLurker.getDistanceSqToEntity(entitylivingbase) < 12.0D;
        }
    ...
    public void startExecuting() {
        this.swellingLurker.getNavigator()
            .clearPathEntity();
    ...
    public void updateTask() {
        if (this.uroAttackTarget == null) {
            ...
            this.swellingLurker.setCreeperState(-1); // -1
        } else if (!this.swellingLurker.getEntitySenses()
