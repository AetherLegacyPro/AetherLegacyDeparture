...
public class EntityAIUligoSwell extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        return this.swellingUro.getCreeperState() > 0
            || entitylivingbase != null && this.swellingUro.getDistanceSqToEntity(entitylivingbase) < 9.0D;
    }
    ...
    public void updateTask() {
        if (this.uroAttackTarget == null) {
            ...
            this.swellingUro.setCreeperState(-1);
        } else if (!this.swellingUro.getEntitySenses()
            .canSee(this.uroAttackTarget)) {
                this.swellingUro.setCreeperState(-1);
            } else {
                this.swellingUro.setCreeperState(1);
            }
