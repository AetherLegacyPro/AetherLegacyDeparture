    ...
    public boolean shouldExecute() {
        if (this.sheepuff.getRNG()
            ...
            return (this.entityWorld.getBlock(i, j - 1, k) == BlocksAether.aether_grass)
                || (this.entityWorld.getBlock(i, j - 1, k) == BlocksAether.arctic_grass)
                || (this.entityWorld.getBlock(i, j - 1, k) == BlocksAether.verdant_grass);
        }
    }
    ...
    public void updateTask() {
        ...
        if (this.eatingGrassTimer == 4) {
            ...
            if (this.entityWorld.getBlock(i, j - 1, k) == BlocksAether.aether_grass) {
                if (this.entityWorld.getGameRules()
