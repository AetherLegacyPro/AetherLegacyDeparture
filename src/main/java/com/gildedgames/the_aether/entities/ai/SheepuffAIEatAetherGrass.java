...
public class SheepuffAIEatAetherGrass extends EntityAIBase {
	...
	public boolean shouldExecute()
	{
		...
		else
		{
			...
			return (this.entityWorld.getBlock(i, j - 1, k) == BlocksAether.aether_grass) || (this.entityWorld.getBlock(i, j - 1, k) == BlocksAether.arctic_grass) || (this.entityWorld.getBlock(i, j - 1, k) == BlocksAether.verdant_grass);
		}
	}
