...
public class EntitiesAether {
    ...
    public static void register(Class<? extends Entity> entityClass, String entityName, int entityID, int trackingRange,
    ...
    private static void addMapping(Class<?> entityClass, String entityName, int entityID, int primaryEggColor,
        ...
        if (IDtoClassMapping.containsKey(entityID)) {
            ...
            ItemAetherSpawnEgg.entityEggs
                .put(entityID, new AetherEggInfo(entityID, primaryEggColor, secondaryEggColor));
        }
    }
