    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
       ...
       // for (i = 0; i < 4; ++i)
        //{
           ...
           // this.blazeSticks[i].rotationPointX = MathHelper.cos(f6) * 7.0F; //12
           // this.blazeSticks[i].rotationPointZ = MathHelper.sin(f6) * 7.0F; //12
           // ++f6;
       // }
        ...
        //{
           // this.blazeSticks[i].rotationPointY = 2.0F + MathHelper.cos(((float)(i * 2) + p_78087_3_) * 0.25F);
            //this.blazeSticks[i].rotationPointX = MathHelper.cos(f6) * 7.0F; //10
           // this.blazeSticks[i].rotationPointZ = MathHelper.sin(f6) * 7.0F; //10
           // ++f6;
       // }
        ...
        //{
           ...
           // this.blazeSticks[i].rotationPointX = MathHelper.cos(f6) * 5.0F; //8
           // this.blazeSticks[i].rotationPointZ = MathHelper.sin(f6) * 5.0F; //8
            //++f6;
       // }
