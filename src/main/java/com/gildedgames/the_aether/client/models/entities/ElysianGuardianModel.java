...
public class ElysianGuardianModel extends ModelBase {
    ...
    public ElysianGuardianModel() {
        ...
        (this.right_lowerarm = new ModelRenderer(this, 38, 12)).addBox(-4.0f, 7.0f, 4.0f, 4, 11, 4, 0.0f); // -4.0f,
                                                                                                           // 7.0f, 4.0f
    ...
    @Override
    public final void render(final Entity entity, final float n, final float n2, final float n3, final float n4,
        final float n5, final float n6) {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
        ...
        this.right_upperarm.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + 3.141593F) * 2.0F
            * limbSwingAmount
            * 0.5F;
        ...
        if (this.onGround > -9990F) {
            float f6 = onGround;
            this.upper_back.rotateAngleY = this.upper_body.rotateAngleY = MathHelper
