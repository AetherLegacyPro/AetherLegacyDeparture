...
public class ElysianGuardianModel extends ModelBase {
    ...
    public ElysianGuardianModel() {
        ...
        (this.right_lowerarm = new ModelRenderer(this, 38, 12)).addBox(-4.0f, 7.0f, 4.0f, 4, 11, 4, 0.0f);
        this.right_lowerarm.setRotationPoint(1.0f, 2.0f, -1.0f);
        this.right_lowerarm.mirror = true;
        this.setRotateAngle(this.right_lowerarm, -0.3490659f, -0.1745329f, 0.0872665f);

        (this.right_hand = new ModelRenderer(this, 38, 27)).addBox(-4.5f, 15.0f, 3.5f, 4, 6, 5, 0.0f);
        this.right_hand.setRotationPoint(1.0f, 2.0f, -1.0f);
        ...
        this.left_lowerarm.setRotationPoint(-1.0f, 2.0f, 0.0f);
        ...
        this.top_right_leg.setRotationPoint(-3.0f, 5.0f, 6.0f);
        ...
        this.right_lower_leg.setRotationPoint(0.5f, 0.0f, 0.0f);
        ...
        this.left_lower_leg.setRotationPoint(-0.5f, 0.0f, 0.0f);
        ...
        this.blade.setRotationPoint(-1.0f, 2.0f, 0.0f);
        ...
        this.hilt.setRotationPoint(-1.0f, 2.0f, -1.0f);
        ...
        this.handle.setRotationPoint(-1.0f, 0.0f, -1.0f);
