...
public class IrkModel extends ModelBase {
    ...
    public IrkModel() {
        ...
        left_front_leg_middle.cubeList
            .add(new ModelBox(left_front_leg_middle, 100, 36, 0.0F, -4.0F, -1.0F, 10, 4, 4, 0.0F));
        ...
        left_front_leg_bottom.cubeList
            .add(new ModelBox(left_front_leg_bottom, 114, 45, -8.0F, 0.0F, 0.0F, 2, 12, 2, 0.0F));
        ...
        right_front_leg_middle.cubeList
            .add(new ModelBox(right_front_leg_middle, 100, 36, -11.0F, -4.0F, -1.0F, 10, 4, 4, 0.0F));
        ...
        right_front_leg_bottom.cubeList
            .add(new ModelBox(right_front_leg_bottom, 114, 45, -1.0F, 0.0F, 0.0F, 2, 12, 2, 0.0F));
        ...
        left_middle_leg_middle.cubeList
            .add(new ModelBox(left_middle_leg_middle, 100, 36, 1.0F, -4.0F, -1.0F, 10, 4, 4, 0.0F));
        ...
        left_middle_leg_bottom.cubeList
            .add(new ModelBox(left_middle_leg_bottom, 114, 45, 1.0F, 0.0F, 0.25F, 2, 12, 2, 0.0F)); // 1.0F, 0.0F, 1.0F
        ...
        right_middle_leg_middle.cubeList
            .add(new ModelBox(right_middle_leg_middle, 100, 36, -9.0F, -4.0F, -1.0F, 10, 4, 4, 0.0F));
        ...
        right_middle_leg_bottom.cubeList
            .add(new ModelBox(right_middle_leg_bottom, 114, 45, -1.0F, -1.0F, -0.25F, 2, 12, 2, 0.0F)); // -1.0F, 0.0F,
                                                                                                        // -1.0F
        ...
        left_back_leg_middle.cubeList
            .add(new ModelBox(left_back_leg_middle, 100, 36, 0.0F, -4.0F, -1.0F, 10, 4, 4, 0.0F));
        ...
        left_back_leg_bottom.cubeList
            .add(new ModelBox(left_back_leg_bottom, 114, 45, 0.0F, 0.0F, 0.0F, 2, 12, 2, 0.0F)); // -1.0F, 0.0F, -1.0F
        ...
        right_back_leg_middle.cubeList
            .add(new ModelBox(right_back_leg_middle, 100, 36, -9.0F, -4.0F, -1.0F, 10, 4, 4, 0.0F));
        ...
        right_back_leg_bottom.cubeList
            .add(new ModelBox(right_back_leg_bottom, 114, 45, -1.0F, 0.0F, 0.0F, 2, 12, 2, 0.0F)); // -1.0F, 0.0F, -1.0F

        // ===== REST OF BODY =====
        antenna_left = new ModelRenderer(this);
        antenna_left.setRotationPoint(-1.0F, -6.0F, -15.0F);
        bb_main.addChild(antenna_left);
        setRotationAngle(antenna_left, 0.0F, -0.6109F, 0.0F);
        antenna_left.cubeList.add(new ModelBox(antenna_left, 106, 10, 0.0F, -1.0F, -9.0F, 2, 2, 9, 0.0F));

        antenna_right = new ModelRenderer(this);
        antenna_right.setRotationPoint(-3.0F, -6.0F, -15.0F);
        bb_main.addChild(antenna_right);
        setRotationAngle(antenna_right, 0.0F, 0.6109F, 0.0F);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
        ...
        this.left_middle_leg_middle.rotateAngleY = MathHelper.cos(limbSwing * speed + (float) Math.PI) * degree
            * limbSwingAmount;
        this.left_back_leg_middle.rotateAngleY = MathHelper.cos(limbSwing * speed) * degree * limbSwingAmount;

        // Right legs (opposite phase)
        this.right_front_leg_middle.rotateAngleY = MathHelper.cos(limbSwing * speed + (float) Math.PI) * degree
            * limbSwingAmount;
        this.right_middle_leg_middle.rotateAngleY = MathHelper.cos(limbSwing * speed) * degree * limbSwingAmount;
        this.right_back_leg_middle.rotateAngleY = MathHelper.cos(limbSwing * speed + (float) Math.PI) * degree
            * limbSwingAmount;
