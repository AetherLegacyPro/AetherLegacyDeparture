...
public class TempestModel extends ModelBase
{
    ...
    public TempestModel() {
        ...
        (this.main_body = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-6.0f, -4.0f, -7.0f, 12, 8, 14);
        ...
        (this.RB_cloud = new ModelRenderer((ModelBase)this, 16, 22)).addBox(-8.0f, -2.0f, 0.0f, 2, 6, 6);
        ...
        (this.LB_cloud = new ModelRenderer((ModelBase)this, 16, 22)).addBox(6.0f, -2.0f, 0.0f, 2, 6, 6);
        ...
        (this.tail_2 = new ModelRenderer((ModelBase)this, 32, 22)).addBox(-2.0f, -2.0f, -2.0f, 4, 4, 4);
        ...
        (this.FR_cloud = new ModelRenderer((ModelBase)this, 0, 22)).addBox(-8.0f, -3.0f, -7.0f, 2, 6, 6);
        ...
        (this.FL_cloud = new ModelRenderer((ModelBase)this, 0, 22)).addBox(6.0f, -3.0f, -7.0f, 2, 6, 6);
        ...
        (this.tail_1 = new ModelRenderer((ModelBase)this, 0, 34)).addBox(-3.0f, -3.0f, -3.0f, 6, 6, 6);
