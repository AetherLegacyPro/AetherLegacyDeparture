...
public class FallenValkyrieModel extends ModelBiped {
    ...
    public FallenValkyrieModel() {
        this(0.0F);
    }

    public FallenValkyrieModel(float f) {
        this(f, 0.0F);
    }

    public FallenValkyrieModel(float f, float f1) {
        this.isSneak = false;
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
        ...
        this.bipedRightArm.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + 3.141593F) * 2.0F
            * limbSwingAmount
            * 0.5F;
        ...
        if (this.onGround > -9990F) {
            float f6 = onGround;
            this.bipedBody2.rotateAngleY = this.bipedBody.rotateAngleY = MathHelper
