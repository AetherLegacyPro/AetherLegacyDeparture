...
public class ZarnillysModel extends ModelBase
{
    ...
    public ZarnillysModel() {
        ...
        (this.tail4 = new ModelRenderer(this, 0, 90)).setRotationPoint(0.0f, 0.0f, 8.0f);
        this.tail4.addBox(-1.5f, -1.5f, 0.0f, 3, 3, 10, 0.0f);
        this.setRotateAngle(this.tail4, 0.17453292f, 0.0f, 0.0f);
        (this.body_back = new ModelRenderer(this, 0, 32)).setRotationPoint(0.0f, -3.5f, 5.0f);
        ...
        (this.body_front = new ModelRenderer(this, 0, 17)).setRotationPoint(0.0f, -3.5f, -5.0f);
        this.body_front.addBox(-5.5f, 0.0f, -8.0f, 11, 7, 8, 0.0f);
        this.setRotateAngle(this.body_front, 0.2617994f, 0.0f, 0.0f);
        (this.foot_front_left = new ModelRenderer(this, 44, 26)).setRotationPoint(0.0f, 7.0f, 0.0f);
        ...
        (this.tail2 = new ModelRenderer(this, 0, 63)).setRotationPoint(0.0f, -0.5f, 8.0f);
        this.tail2.addBox(-3.5f, -2.5f, 0.0f, 7, 5, 9, 0.0f);
        this.setRotateAngle(this.tail2, -0.08726646f, 0.0f, 0.0f);
        (this.head_top = new ModelRenderer(this, 68, 0)).setRotationPoint(0.0f, 2.0f, -8.0f);
        this.head_top.addBox(-3.5f, -3.0f, -11.0f, 7, 4, 12, 0.0f);
        this.setRotateAngle(this.head_top, -0.17453292f, 0.0f, 0.0f);
        (this.forehead = new ModelRenderer(this, 68, 16)).setRotationPoint(0.0f, -3.0f, -7.0f);
        ...
        (this.head_bottom = new ModelRenderer(this, 68, 33)).setRotationPoint(0.0f, 1.0f, 0.0f);
        this.head_bottom.addBox(-3.0f, 0.0f, -11.0f, 6, 2, 12, 0.0f);
        this.setRotateAngle(this.head_bottom, 0.34906584f, 0.0f, 0.0f);
        (this.toe7 = new ModelRenderer(this, 44, 72)).setRotationPoint(-0.5f, 0.0f, -2.0f);
        this.toe7.addBox(-1.0f, 0.0f, -2.0f, 1, 1, 2, 0.0f);
        this.setRotateAngle(this.toe7, 0.17453292f, 0.0f, 0.0f);
        (this.toe8 = new ModelRenderer(this, 44, 75)).setRotationPoint(-0.5f, 0.0f, -2.0f);
        this.toe8.addBox(0.0f, 0.0f, -1.0f, 1, 1, 1, 0.0f);
        this.setRotateAngle(this.toe8, 0.2617994f, 0.0f, 0.0f);
        (this.leg_front_left_top = new ModelRenderer(this, 44, 0)).setRotationPoint(0.0f, 0.0f, 0.0f);
        ...
        (this.crest3 = new ModelRenderer(this, 118, 20)).setRotationPoint(-2.0f, 0.0f, 5.5f);
        this.crest3.addBox(-2.0f, -3.0f, -1.0f, 2, 3, 2, 0.0f);
        this.setRotateAngle(this.crest3, 0.0f, 0.0f, -0.6981317f);
        (this.leg_back_left_bottom = new ModelRenderer(this, 44, 57)).setRotationPoint(2.99f, 6.5f, -1.5f);
        ...
        (this.leg_front_left_bottom = new ModelRenderer(this, 44, 14)).setRotationPoint(5.0f, 3.7f, 2.0f);
        this.leg_front_left_bottom.addBox(-2.5f, -1.0f, -3.5f, 5, 8, 4, 0.0f);
        (this.foot_back_left_heel = new ModelRenderer(this, 44, 65)).setRotationPoint(-0.5f, 5.0f, 3.0f);
        ...
        (this.crest2 = new ModelRenderer(this, 106, 21)).setRotationPoint(0.0f, -5.0f, 0.0f);
        this.crest2.addBox(-4.0f, 0.0f, -1.0f, 4, 2, 2, 0.0f);
        (this.crest4 = new ModelRenderer(this, 106, 21)).setRotationPoint(2.0f, -5.0f, 0.0f);
        this.crest4.addBox(-4.0f, 0.0f, -1.0f, 4, 2, 2, 0.0f);
        (this.tail1 = new ModelRenderer(this, 0, 48)).setRotationPoint(0.0f, 4.0f, 8.0f);
        this.tail1.addBox(-4.5f, -3.5f, 0.0f, 9, 6, 9, 0.0f);
        this.setRotateAngle(this.tail1, -0.08726646f, 0.0f, 0.0f);
        (this.body = new ModelRenderer(this, 0, 0)).setRotationPoint(0.0f, 13.3f, 0.0f);
        this.body.addBox(-6.0f, -3.5f, -5.0f, 12, 7, 10, 0.0f);
        (this.cheek_left = new ModelRenderer(this, 68, 25)).setRotationPoint(3.5f, -1.0f, -6.0f);
        ...
        (this.leg_front_right_joint = new ModelRenderer(this, 0, 0)).setRotationPoint(-4.5f, -2.0f, -4.0f);
        ...
        (this.teeth_top = new ModelRenderer(this, 68, 47)).setRotationPoint(0.0f, 0.0f, 0.0f);
        ...
        (this.foot_back_left = new ModelRenderer(this, 44, 69)).setRotationPoint(0.5f, 0.6f, -2.0f);
        this.foot_back_left.addBox(-1.5f, 0.0f, -2.0f, 3, 1, 2, 0.0f);
        this.setRotateAngle(this.foot_back_left, 0.08726646f, 0.0f, 0.0f);
        (this.leg_front_left_joint = new ModelRenderer(this, 0, 0)).setRotationPoint(4.5f, -2.0f, -4.0f);
        ...
        (this.toe2 = new ModelRenderer(this, 44, 37)).setRotationPoint(0.0f, 0.6f, -5.0f);
        this.toe2.addBox(-0.5f, 0.0f, -2.0f, 1, 1, 3, 0.0f);
        this.setRotateAngle(this.toe2, 0.2617994f, 0.0f, 0.0f);
        (this.crest1 = new ModelRenderer(this, 98, 18)).setRotationPoint(2.0f, 0.0f, 5.5f);
