...
public class ModelAgilityBoots extends ModelBiped {
    ...
    // public void render(final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float
    // netHeadYaw, final float headPitch, final float scale, final Entity entityIn) {
