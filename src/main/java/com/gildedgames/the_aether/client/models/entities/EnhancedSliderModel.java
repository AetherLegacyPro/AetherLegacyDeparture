...
public class EnhancedSliderModel extends ModelBase {

	public ModelRenderer head;

	public float hurtAngle, hurtAngleX, hurtAngleZ;

	public EnhancedSliderModel() {
		this(0.0F);
	}

	public EnhancedSliderModel(float modelSize) {
		this(modelSize, 0.0F);
	}

	public EnhancedSliderModel(float modelSize, float rotationPointY) {
