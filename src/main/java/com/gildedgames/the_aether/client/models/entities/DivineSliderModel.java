...
public class DivineSliderModel extends ModelBase {

	public ModelRenderer head;

	public float hurtAngle, hurtAngleX, hurtAngleZ;

	public DivineSliderModel() {
		this(0.0F);
	}

	public DivineSliderModel(float modelSize) {
		this(modelSize, 0.0F);
	}

	public DivineSliderModel(float modelSize, float rotationPointY) {
