...
public class FlynxRenderer extends RenderLiving {
     ...
     */
    public void doRender(EntityFlynx p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
     ...
     */
    protected ResourceLocation getEntityTexture(EntityFlynx p_110775_1_) {
    ...
    public void doRender(EntityLiving p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
        float p_76986_8_, float p_76986_9_) {
        this.doRender((EntityFlynx) p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
    ...
    protected void preRenderCallback(EntityLivingBase p_77041_1_, float p_77041_2_) {
        this.preRenderCallback((EntityFlynx) p_77041_1_, p_77041_2_);
        GL11.glScalef(1.05F, 1.05F, 1.05F);
    }
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return this.getEntityTexture((EntityFlynx) p_110775_1_);
    }
