...
public class TileEntityTreasureChestBreakableRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityChestAt(final TileEntityTreasureChestBreakable par1TileEntityChest, final double par2,
        ...
        if (!par1TileEntityChest.hasWorldObj()) {
            ...
            if (var9 == 0 && var10 instanceof BlockTreasureChestBreakable) {
                ((BlockTreasureChestBreakable) var10).unifyAdjacentChests(
        ...
        if (par1TileEntityChest.adjacentChestZNeg == null && par1TileEntityChest.adjacentChestXNeg == null) {
            ...
            if (par1TileEntityChest.adjacentChestXPos == null && par1TileEntityChest.adjacentChestZPosition == null) {
                ...
                this.bindTexture(TileEntityTreasureChestBreakableRenderer.TEXTURE_SINGLE);
            } else {
                var11 = this.largeChestModel;
                this.bindTexture(TileEntityTreasureChestBreakableRenderer.TEXTURE_DOUBLE);
            }
            GL11.glPushMatrix();
            GL11.glEnable(32826);
