...
public class TileEntityElysianChestRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityChestAt(final TileEntityElysianChest par1TileEntityChest, final double par2,
        ...
        if (!par1TileEntityChest.hasWorldObj()) {
            ...
            if (var9 == 0 && var10 instanceof BlockElysianChest) {
                ((BlockElysianChest) var10).unifyAdjacentChests(
        ...
        if (par1TileEntityChest.adjacentChestZNeg == null && par1TileEntityChest.adjacentChestXNeg == null) {
            ...
            if (par1TileEntityChest.adjacentChestXPos == null && par1TileEntityChest.adjacentChestZPosition == null) {
                ...
                this.bindTexture(TileEntityElysianChestRenderer.TEXTURE_SINGLE);
            } else {
                var11 = this.largeChestModel;
                this.bindTexture(TileEntityElysianChestRenderer.TEXTURE_DOUBLE);
            }
            GL11.glPushMatrix();
            GL11.glEnable(32826);
            ...
            GL11.glTranslatef(-0.5f, -0.5f, -0.5f);
            float var13 = par1TileEntityChest.prevLidAngle
                + (par1TileEntityChest.lidAngle - par1TileEntityChest.prevLidAngle) * par8;
            if (par1TileEntityChest.adjacentChestZNeg != null) {
                final float var14 = par1TileEntityChest.adjacentChestZNeg.prevLidAngle
                    + (par1TileEntityChest.adjacentChestZNeg.lidAngle
                        - par1TileEntityChest.adjacentChestZNeg.prevLidAngle) * par8;
                if (var14 > var13) {
                    var13 = var14;
                }
            }
            if (par1TileEntityChest.adjacentChestXNeg != null) {
                final float var14 = par1TileEntityChest.adjacentChestXNeg.prevLidAngle
                    + (par1TileEntityChest.adjacentChestXNeg.lidAngle
                        - par1TileEntityChest.adjacentChestXNeg.prevLidAngle) * par8;
                if (var14 > var13) {
                    var13 = var14;
                }
            }
