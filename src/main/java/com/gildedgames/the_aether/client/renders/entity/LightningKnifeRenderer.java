...
public class LightningKnifeRenderer extends Render {
    ...
    public void doRender(Entity entity, double var2, double var4, double var6, float var8, float var9) {
        this.doRenderKnife((EntityLightningKnife) entity, var2, var4, var6, var8, var9);
    }

    public void doRenderKnife(EntityLightningKnife entityLightningKnife, double d, double d1, double d2, float yaw, float time) {
        GL11.glPushMatrix();
        GL11.glTranslatef((float) d, (float) d1, (float) d2);
        GL11.glRotatef(yaw, 0F, 1.0F, 0F);
        GL11.glRotatef(-(entityLightningKnife.prevRotationPitch + (entityLightningKnife.rotationPitch - entityLightningKnife.prevRotationPitch) * time), 1F, 0F, 0F);
