...
public class DivineFireMinionRenderer extends RenderBiped {
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        EntityDivineFireMinion sunSpirit = (EntityDivineFireMinion) entity;
