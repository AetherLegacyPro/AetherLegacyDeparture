...
public class TreasureChestRenderer extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation TEXTURE_DOUBLE = Aether
        .locate("textures/tile_entities/treasure_chest_large.png");
    ...
    @Override
    public void renderTileEntityAt(TileEntity par1TileEntityChest, double posX, double posY, double posZ,
        float partialTicks) {
        int var9;

        if (par1TileEntityChest == null) {
            TileEntityRendererDispatcher.instance
                .renderTileEntityAt(new TileEntityTreasureChest(), 0.0, 0.0, 0.0, 0.0F);
            return;
        }
        ...
        if (!par1TileEntityChest.hasWorldObj()) {
            ...
            if (var10 instanceof BlockTreasureChest) {
                ((BlockTreasureChest) var10).func_149954_e(
        ...
        if (((TileEntityTreasureChest) par1TileEntityChest).adjacentChestZNeg == null
            && ((TileEntityTreasureChest) par1TileEntityChest).adjacentChestXNeg == null) {
            ModelChest var14;

            if (((TileEntityTreasureChest) par1TileEntityChest).adjacentChestXPos == null
                && ((TileEntityTreasureChest) par1TileEntityChest).adjacentChestZPos == null) {
            ...
            GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
            float var12 = ((TileEntityTreasureChest) par1TileEntityChest).prevLidAngle
                + (((TileEntityTreasureChest) par1TileEntityChest).lidAngle
                    - ((TileEntityTreasureChest) par1TileEntityChest).prevLidAngle) * partialTicks;
            float var13;

            if (((TileEntityTreasureChest) par1TileEntityChest).adjacentChestZNeg != null) {
                var13 = ((TileEntityTreasureChest) par1TileEntityChest).adjacentChestZNeg.prevLidAngle
                    + (((TileEntityTreasureChest) par1TileEntityChest).adjacentChestZNeg.lidAngle
                        - ((TileEntityTreasureChest) par1TileEntityChest).adjacentChestZNeg.prevLidAngle)
                        * partialTicks;
            ...
            if (((TileEntityTreasureChest) par1TileEntityChest).adjacentChestXNeg != null) {
                var13 = ((TileEntityTreasureChest) par1TileEntityChest).adjacentChestXNeg.prevLidAngle
                    + (((TileEntityTreasureChest) par1TileEntityChest).adjacentChestXNeg.lidAngle
                        - ((TileEntityTreasureChest) par1TileEntityChest).adjacentChestXNeg.prevLidAngle)
                        * partialTicks;
