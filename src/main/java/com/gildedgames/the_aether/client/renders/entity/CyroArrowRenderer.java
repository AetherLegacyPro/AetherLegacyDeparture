...
public class CyroArrowRenderer extends Render {
    ...
    public CyroArrowRenderer() {
        super();

    }

    public void renderArrow(EntityCyroArrow var1, double var2, double var4, double var6, float var8, float var9) {
    ...
    public void doRender(Entity entity, double x, double y, double z, float entityYaw, float partialTicks) {
        this.renderArrow((EntityCyroArrow) entity, x, y, z, entityYaw, partialTicks);
    }

    @Override
    protected ResourceLocation getEntityTexture(Entity entity) {
        return Aether.locate("textures/entities/projectile/freezing_arrow.png");
    }
