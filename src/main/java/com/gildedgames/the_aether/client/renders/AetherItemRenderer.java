...
public class AetherItemRenderer extends ItemRenderer {
    ...
    public void renderFirstPersonArm(RenderPlayer renderPlayer, EntityClientPlayerMP playerIn) {
        ...
        ItemStack gloves = playerAether.getAccessoryInventory()
            .getFirstStackIfWearing(AccessoryType.GLOVES);

        this.mc.getTextureManager()
            .bindTexture(playerIn.getLocationSkin());
        ...
        if (gloves.getItem() instanceof ItemAccessory accessory) {
            this.mc.getTextureManager()
                .bindTexture(accessory.texture);

            int colour = gloves.getItem()
                .getColorFromItemStack(gloves, 0);
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        if (itemstack != null && itemstack.getItem() instanceof ItemMap) {
            ...
            if (itemstack.getItem()
                ...
                for (int x = 1; x < itemstack.getItem()
                    .getRenderPasses(itemstack.getItemDamage()); x++) {
                    int k1 = itemstack.getItem()
                        .getColorFromItemStack(itemstack, x);
    ...
    public void updateEquippedItem() {
        ...
        boolean flag = this.equippedItemSlot == entityclientplayermp.inventory.currentItem
