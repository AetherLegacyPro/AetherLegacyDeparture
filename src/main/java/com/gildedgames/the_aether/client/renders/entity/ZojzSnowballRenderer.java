...
public class ZojzSnowballRenderer extends Render {
    ...
    public void doRenderNotchWave(EntityZojzSnowball notchwave, double par2, double par4, double par6, float par8, float par9) {
        GL11.glPushMatrix();
