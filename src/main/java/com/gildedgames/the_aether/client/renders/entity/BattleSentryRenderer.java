...
public class BattleSentryRenderer extends RenderLiving {
    ...
    private static final ResourceLocation TEXTURE = Aether
        .locate("textures/entities/battle_sentry/sentry_melee_new.png");

    private static final ResourceLocation TEXTURE_LIT = Aether
        .locate("textures/entities/battle_sentry/sentry_melee_lit_new.png");
