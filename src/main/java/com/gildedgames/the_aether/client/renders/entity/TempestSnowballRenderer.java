...
public class TempestSnowballRenderer extends Render {

    public TempestSnowballRenderer() {
        super();

        this.shadowSize = 0.0F;
    }

    public void doRenderNotchWave(EntityTempestSnowball notchwave, double par2, double par4, double par6, float par8, float par9) {
        GL11.glPushMatrix();
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
        this.doRenderNotchWave((EntityTempestSnowball) par1Entity, par2, par4, par6, par8, par9);
    }

    @Override
    protected ResourceLocation getEntityTexture(Entity entity) {
        return Aether.locate("textures/entities/projectile/tempest_snowball.png");
    }
