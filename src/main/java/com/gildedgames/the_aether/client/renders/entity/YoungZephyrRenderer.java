...
public class YoungZephyrRenderer extends RenderLiving {
    ...
    public void doRender(final EntityLiving entity, final double par2, final double par4, final double par6,
    ...
    protected void preRenderCallback(final EntityLivingBase entityliving, final float f) {
        ...
        final float scale = 1.0f
            + (attacking ? ((secs >= 30) ? ((120.0f - 1.5f * (secs - 1)) / 100.0f) : (3.0f * (secs + 1) / 100.0f))
                : 0.0f);
