...
public class AmplifiedNotchHammerProjectileRenderer extends Render {
    ...
    public void doRenderNotchWave(EntityAmplifiedHammerProjectile notchwave, double par2, double par4, double par6, float par8, float par9) {
        GL11.glPushMatrix();
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
        this.doRenderNotchWave((EntityAmplifiedHammerProjectile) par1Entity, par2, par4, par6, par8, par9);
    }

    @Override
    protected ResourceLocation getEntityTexture(Entity entity) {
        return Aether.locate("textures/entities/projectile/amplified_notch_hammer.png");
    }
