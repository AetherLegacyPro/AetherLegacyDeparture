    ...
    public void doRender(Entity entity, double x, double y, double z, float pitch, float yaw) {
        ...
        if (calendar.get(2) + 1 == 12 && calendar.get(5) >= 24 && calendar.get(5) <= 26) {
            this.renderManager.renderEngine
                .bindTexture(Aether.locate("textures/entities/mimic/mimic_head_christmas.png"));
            this.modelbase.renderHead(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F, mimic);
            this.renderManager.renderEngine
                .bindTexture(Aether.locate("textures/entities/mimic/mimic_legs_christmas.png"));
            this.modelbase.renderLegs(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F, mimic);
        } else {
            this.renderManager.renderEngine.bindTexture(Aether.locateII("textures/mobs/mimic/mimic1.png"));
            this.modelbase.renderHead(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F, mimic);
            this.renderManager.renderEngine.bindTexture(Aether.locateII("textures/mobs/mimic/mimic2.png"));
            this.modelbase.renderLegs(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F, mimic);
        }
