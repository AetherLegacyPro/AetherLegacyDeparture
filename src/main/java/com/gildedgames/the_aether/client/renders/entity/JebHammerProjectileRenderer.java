...
public class JebHammerProjectileRenderer extends Render {
    ...
    public void doRenderNotchWave(EntityJebHammerProjectile notchwave, double par2, double par4, double par6, float par8, float par9) {
        GL11.glPushMatrix();
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        return Aether.locate("textures/entities/projectile/jeb_wave.png");
    }
