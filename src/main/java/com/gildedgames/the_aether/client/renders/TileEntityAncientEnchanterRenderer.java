...
public class TileEntityAncientEnchanterRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAncientEnchanterAt(final TileEntityAncientEnchanter enchanter, final double d,
        ...
        if (enchanter.getEnchanterStacks(1) != null) {
            final Item item = enchanter.getEnchanterStacks(1)
                .getItem();
            final IIcon var15 = item.getIconFromDamage(
                enchanter.getEnchanterStacks(1)
                    .getItemDamage());
