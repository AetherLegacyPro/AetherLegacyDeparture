...
public class AetherMainMenu extends GuiMainMenu {
    ...
    private static final ResourceLocation aetherTitleTextures = new ResourceLocation(
        "aether_legacy",
        "textures/gui/menu/aether.png");
    private static final ResourceLocation[] titlePanoramaPaths = new ResourceLocation[] {
        new ResourceLocation("aether_legacy", "textures/gui/menu/panorama/panorama_0.png"),
        new ResourceLocation("aether_legacy", "textures/gui/menu/panorama/panorama_1.png"),
        new ResourceLocation("aether_legacy", "textures/gui/menu/panorama/panorama_2.png"),
        new ResourceLocation("aether_legacy", "textures/gui/menu/panorama/panorama_3.png"),
        new ResourceLocation("aether_legacy", "textures/gui/menu/panorama/panorama_4.png"),
        new ResourceLocation("aether_legacy", "textures/gui/menu/panorama/panorama_5.png") };
    public static final String field_96138_a = "Please click " + EnumChatFormatting.UNDERLINE
        + "here"
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        ...
        GuiButton realmsButton = new AetherMainMenuButton(
            14,
            30,
            ...
            if (p_73878_1_) {
                try {
                    ...
                    oclass.getMethod("browse", new Class[] { URI.class })
                        .invoke(object, new URI(this.field_104024_v));
        ...
        for (int k = 0; k < b0 * b0; ++k) {
            ...
            for (int l = 0; l < 6; ++l) {
                ...
                this.mc.getTextureManager()
                    .bindTexture(titlePanoramaPaths[l]);
    ...
    private void rotateAndBlurSkybox(float p_73968_1_) {
        this.mc.getTextureManager()
            .bindTexture(this.field_110351_G);
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        ...
        this.mc.getTextureManager()
            .bindTexture(aetherTitleTextures);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef(200.0F, 55.0F, 0.0F);
        ...
        List<String> brandings = Lists.reverse(
        ...
        for (int i = 0; i < brandings.size(); i++) {
            ...
            if (!Strings.isNullOrEmpty(brd)) {
                this.drawString(
                    ...
                    brd,
                    this.width - this.fontRendererObj.getStringWidth(brd) - 2,
                    this.height - (30 + i * (this.fontRendererObj.FONT_HEIGHT + 1)),
                    16777215);
            }
        }
        ...
        for (int j = 0; j < this.labelList.size(); ++j) {
            this.labelList.get(j)
                .func_146159_a(this.mc, p_73863_1_, p_73863_2_);
        }
    }
    ...
    protected void mouseClicked(int p_73864_1_, int p_73864_2_, int p_73864_3_) {
        ...
        synchronized (this.field_104025_t) {
            if (!this.field_92025_p.isEmpty() && p_73864_1_ >= this.field_92022_t
