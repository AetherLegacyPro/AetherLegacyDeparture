...
public class GuiAccessoryButton extends GuiButton {
    ...
    protected static final ResourceLocation BUTTON_HOVERED_TEXTURE = Aether
        .locate("textures/gui/inventory/button/cloud_hover.png");
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        ...
        if (this.visible) {
            ...
            mc.getTextureManager()
                .bindTexture(i == 2 ? BUTTON_HOVERED_TEXTURE : BUTTON_TEXTURE);
            ...
            if (AetherConfig.cloud_icon == false) {
                ...
                GuiAccessoryButton
                    .func_146110_a(this.xPosition - 1, this.yPosition, -2.0f, -2.0f, 20, 20, 16.0f, 16.0f);
            }
            GL11.glPopMatrix();
        }
    }
