...
public class GuiDivineEnchantmentTable extends GuiContainer {
    ...
    private static final ResourceLocation field_147078_C = new ResourceLocation(
        "aether_legacy",
        "textures/gui/divine_enchanting_table.png");
    private static final ResourceLocation field_147070_D = new ResourceLocation(
        "aether_legacy",
        "textures/entities/divine_enchanting_table_book.png");
    ...
    public GuiDivineEnchantmentTable(InventoryPlayer p_i1090_1_, World p_i1090_2_, int p_i1090_3_, int p_i1090_4_,
        int p_i1090_5_, String p_i1090_6_) {
            ...
            if (j1 == 0) {
                ...
                if (this.mc.thePlayer.experienceLevel < j1 && !this.mc.thePlayer.capabilities.isCreativeMode) {
                    ...
                    fontrenderer.drawStringWithShadow(
                        s1,
                        k + 62 + 104 - fontrenderer.getStringWidth(s1),
                        l + 16 + 19 * i1 + 7,
                        k1);
                } else {
    ...
    public void func_147068_g() {
        ItemStack itemstack = this.inventorySlots.getSlot(0)
            .getStack();
