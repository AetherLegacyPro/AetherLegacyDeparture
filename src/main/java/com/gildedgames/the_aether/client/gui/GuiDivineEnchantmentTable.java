...
public class GuiDivineEnchantmentTable extends GuiContainer {
    ...
    public GuiDivineEnchantmentTable(InventoryPlayer inventoryPlayer, World world, int p_i1090_3_, int p_i1090_4_, int p_i1090_5_, String string) {
        super(new DivineEnchantmentTableContainer(inventoryPlayer, world, p_i1090_3_, p_i1090_4_, p_i1090_5_));
