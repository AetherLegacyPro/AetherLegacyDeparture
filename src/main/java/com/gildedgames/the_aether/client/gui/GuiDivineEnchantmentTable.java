...
public class GuiDivineEnchantmentTable extends GuiContainer
{
    private static final ResourceLocation field_147078_C = new ResourceLocation("aether_legacy","textures/gui/divine_enchanting_table.png");
    private static final ResourceLocation field_147070_D = new ResourceLocation("aether_legacy","textures/entities/divine_enchanting_table_book.png");
    private static final ModelBook field_147072_E = new ModelBook();
    private Random field_147074_F = new Random();
    private DivineEnchantmentTableContainer field_147075_G;
    ...
    public GuiDivineEnchantmentTable(InventoryPlayer p_i1090_1_, World p_i1090_2_, int p_i1090_3_, int p_i1090_4_, int p_i1090_5_, String p_i1090_6_)
    {
        super(new DivineEnchantmentTableContainer(p_i1090_1_, p_i1090_2_, p_i1090_3_, p_i1090_4_, p_i1090_5_));
        this.field_147075_G = (DivineEnchantmentTableContainer)this.inventorySlots;
