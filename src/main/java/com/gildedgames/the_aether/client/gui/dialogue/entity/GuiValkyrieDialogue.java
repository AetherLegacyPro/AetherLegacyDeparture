            ...
            if (dialogue.getDialogueId() == 0) {
                ...
                if (this.medalSlotId != -1) {
                    AetherNetwork.sendToServer(
                        new PacketInitiateValkyrieFight(this.medalSlotId, this.valkyrieQueen.getEntityId()));
        ...
        for (int slotId = 0; slotId < this.mc.thePlayer.inventory.mainInventory.length; ++slotId) {
            ...
            if (stack != null && stack.getItem() == ItemsAether.victory_medal) {
                if (stack.stackSize >= 4) {
                    ...
                    return I18n.format("gui.valkyrie.dialog.player.lackmedals") + " (" + stack.stackSize + "/4)";
                }
            }
        }

        return I18n.format("gui.valkyrie.dialog.player.lackmedals") + " (0/4)";
    }
