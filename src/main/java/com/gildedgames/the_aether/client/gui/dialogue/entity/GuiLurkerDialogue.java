...
public class GuiLurkerDialogue extends GuiDialogue {
    ...
    public GuiLurkerDialogue(EntityLurker urker) {
        super(
            "[\247e" + urker.getName() + ", " + I18n.format("tile.aether_legacy.aer_lurker.name") + "\247r]",
            new DialogueOption(I18n.format("gui.urker.dialog.0")),
            new DialogueOption(I18n.format("gui.urker.dialog.1")),
            new DialogueOption(I18n.format("gui.urker.dialog.2")));
        ...
        if (this.getDialogueOptions()
            ...
            if (dialogue.getDialogueId() == 0) {
                ...
                this.addDialogueWithOptions(
                    this.title + ": " + I18n.format("gui.urker.dialog.answer.1"),
                    medalDialogue,
            ...
            if (dialogue.getDialogueId() == 0) {
                ...
                if (this.medalSlotId != -1) {
                    AetherNetwork
                        .sendToServer(new PacketInitiateValkyrieFight(this.medalSlotId, this.urker.getEntityId()));
