...
public class PacketUpdatePowerShardCount extends AetherPacket<PacketUpdatePowerShardCount>
{
    ...
    public PacketUpdatePowerShardCount(EntityPlayer thePlayer, int count)
    {
    ...
    @Override
    public void handleClient(PacketUpdatePowerShardCount message, EntityPlayer player)
    {
    ...
    @Override
    public void handleServer(PacketUpdatePowerShardCount message, EntityPlayer player)
    {
