...
public class AbilityBoneRing implements IAetherAbility {
    ...
    public void onUpdate() {
        ...
        if (accessoryInventory.wearingAccessory(ItemsAether.bone_ring)
            || accessoryInventory.wearingAccessory(ItemsAether.reinforced_bone_ring)) {
            if (accessoryInventory.wearingAccessory(ItemsAether.elysian_ring)
                || accessoryInventory.wearingAccessory(ItemsAether.reinforced_elysian_ring)) {
