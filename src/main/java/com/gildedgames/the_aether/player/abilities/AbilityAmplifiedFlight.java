...
public class AbilityAmplifiedFlight implements IAetherAbilityAmplified {
    ...
    public boolean shouldExecute() {
        return this.playerr.getAccessoryInventory()
    ...
    public void onUpdate() {
        ...
        List<?> entities = this.playerr.getEntity().worldObj.getEntitiesWithinAABBExcludingEntity(
            this.playerr.getEntity(),
            this.playerr.getEntity().boundingBox.expand(3.0D, 3.0D, 3.0D));
