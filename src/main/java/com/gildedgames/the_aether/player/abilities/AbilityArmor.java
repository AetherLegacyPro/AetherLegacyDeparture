...
public class AbilityArmor implements IAetherAbility {
	...
	public void onUpdate() {
		...
		//Gravitite
		else if (this.player.getAccessoryInventory().wearingAccessory(ItemsAether.aer_cape) && this.player.getAccessoryInventory().isWearingGravititeSet()) {
		...
		//Divineral
		else if (this.player.getAccessoryInventory().wearingAccessory(ItemsAether.aer_cape) && this.player.getAccessoryInventory().isWearingDivineralSet()) {
			if (this.player.isJumping() && !this.jumpBoosted) {
		...
		//Continuum
		else if (this.player.getAccessoryInventory().wearingAccessory(ItemsAether.aer_cape) && this.player.getAccessoryInventory().isWearingContinuumSet()) {
			if (this.player.isJumping() && !this.jumpBoosted) {
			this.player.getEntity().motionY = 1D;
			this.jumpBoosted = true;
			}
		...
		//Continuum Combo
		else if (this.player.getAccessoryInventory().wearingAccessory(ItemsAether.aer_cape) && this.player.getAccessoryInventory().isWearingContinuumComboSet()) {
			if (this.player.isJumping() && !this.jumpBoosted) {
			this.player.getEntity().motionY = 1D;
			this.jumpBoosted = true;
			}
		...
		//Amplified Continuum
		else if (this.player.getAccessoryInventory().wearingAccessory(ItemsAether.aer_cape) && this.player.getAccessoryInventory().isWearingAmplifiedContinuumSet()) {
			if (this.player.isJumping() && !this.jumpBoosted) {
			this.player.getEntity().motionY = 1D;
			this.jumpBoosted = true;
			}
		...
		//Aer Cape
		else if (this.player.getAccessoryInventory().wearingAccessory(ItemsAether.aer_cape)) {
			if (this.player.isJumping() && !this.jumpBoosted) {
				this.player.getEntity().motionY = .5D;
				this.jumpBoosted = true;
		...
		if (this.player.getEntity().isWet()) {
			if (this.player.getAccessoryInventory().wearingArmor(ItemsAether.phoenix_boots)) {
				this.damagePhoenixArmor(this.player.getEntity(), ItemsAether.obsidian_boots, 0);
			}

			if (this.player.getAccessoryInventory().wearingArmor(ItemsAether.phoenix_leggings)) {
				this.damagePhoenixArmor(this.player.getEntity(), ItemsAether.obsidian_leggings, 1);
			}

			if (this.player.getAccessoryInventory().wearingArmor(ItemsAether.phoenix_chestplate)) {
				this.damagePhoenixArmor(this.player.getEntity(), ItemsAether.obsidian_chestplate, 2);
			}

			if (this.player.getAccessoryInventory().wearingArmor(ItemsAether.phoenix_helmet)) {
				this.damagePhoenixArmor(this.player.getEntity(), ItemsAether.obsidian_helmet, 3);
			}
					
			if (this.player.getAccessoryInventory().wearingArmor(ItemsAether.amplified_phoenix_boots)) {
				this.damagePhoenixArmor(this.player.getEntity(), ItemsAether.amplified_obsidian_boots, 0);
			}

			if (this.player.getAccessoryInventory().wearingArmor(ItemsAether.amplified_phoenix_leggings)) {
				this.damagePhoenixArmor(this.player.getEntity(), ItemsAether.amplified_obsidian_leggings, 1);
			}

			if (this.player.getAccessoryInventory().wearingArmor(ItemsAether.amplified_phoenix_chestplate)) {
				this.damagePhoenixArmor(this.player.getEntity(), ItemsAether.amplified_obsidian_chestplate, 2);
			}

			if (this.player.getAccessoryInventory().wearingArmor(ItemsAether.amplified_phoenix_helmet)) {
