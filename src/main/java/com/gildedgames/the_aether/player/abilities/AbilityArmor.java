...
public class AbilityArmor implements IAetherAbility {
    ...
    public void onUpdate() {
        ...
        // Divineral
            ...
            && accessoryInventory.isWearingDivineralSet()) {
                if (this.player.isJumping() && !this.jumpBoosted) {
        ...
        // Continuum
            ...
            && accessoryInventory.isWearingContinuumSet()) {
                if (this.player.isJumping() && !this.jumpBoosted) {
                    playerEntity.motionY = 1D;
                    this.jumpBoosted = true;
                }
        ...
        // Continuum Combo
            ...
            && accessoryInventory.isWearingContinuumComboSet()) {
                if (this.player.isJumping() && !this.jumpBoosted) {
                    playerEntity.motionY = 1D;
                    this.jumpBoosted = true;
                }
        ...
        // Amplified Continuum
            ...
            && accessoryInventory.isWearingAmplifiedContinuumSet()) {
                if (this.player.isJumping() && !this.jumpBoosted) {
                    playerEntity.motionY = 1D;
                    this.jumpBoosted = true;
                }
        ...
        if (this.player.getAccessoryInventory()
            ...
            if (!playerEntity.worldObj.isRemote) {
                ((WorldServer) playerEntity.worldObj).func_147487_a(
                    "flame",
                    playerEntity.posX + (this.random.nextGaussian() / 5D),
                    playerEntity.posY + (this.random.nextGaussian() / 5D),
                    playerEntity.posZ + (this.random.nextGaussian() / 3D),
                    0,
                    0.0D,
                    0.0D,
                    0.0D,
        ...
        if (this.player.getAccessoryInventory()
            ...
            if (!playerEntity.worldObj.isRemote) {
                ...
                ((WorldServer) playerEntity.worldObj).func_147487_a(
                    "flame",
                    playerEntity.posX + (this.random.nextGaussian() / 3D),
                    playerEntity.posY + (this.random.nextGaussian() / 3D),
                    playerEntity.posZ + (this.random.nextGaussian() / 3D),
                    0,
                    0.0D,
                    0.0D,
        ...
        /*
         * if (this.player.getAccessoryInventory().isWearingAgilityBoots() ||
         * this.player.getAccessoryInventory().isWearingAgilityBootsAndCape()
         * || this.player.getAccessoryInventory().isWearingAmplifiedAgilityBoots() ||
         * this.player.getAccessoryInventory().isWearingAmplifiedAgilityBootsAndCape()) {
         * int rand = (int)(1 + Math.random() * 150);
         * if (!playerEntity.worldObj.isRemote && rand == 5) {
         * ((WorldServer) playerEntity.worldObj).func_147487_a("explode", playerEntity.posX +
         * (this.random.nextGaussian() / 5D), playerEntity.posY + (this.random.nextGaussian() / 5D), playerEntity.posZ +
         * (this.random.nextGaussian() / 3D), 0, 0.0D, 0.0D, 0.0D, 0.0D);
         * }
         * }
         */

        if (this.player.getAccessoryInventory()
            .wearingAccessory(ItemsAether.phoenix_cape)) {
            playerEntity.extinguish();
            this.player_movement.onUpdate();
