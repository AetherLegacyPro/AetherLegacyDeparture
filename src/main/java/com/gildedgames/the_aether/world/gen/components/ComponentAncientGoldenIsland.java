					...
					for (int l2 = j1; l2 <= i2; l2++) {
						...
						if (d12 * d12 + d13 * d13 < 1.0D) {
							for (int i3 = k1; i3 <= j2; i3++) {
								...
								if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && (block == BlocksAether.bloodmoss_stone || block == BlocksAether.holystone || block == BlocksAether.aether_grass || block == BlocksAether.aether_dirt)) {
