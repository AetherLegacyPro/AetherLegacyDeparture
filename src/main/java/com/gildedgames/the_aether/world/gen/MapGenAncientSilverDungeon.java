...
public class MapGenAncientSilverDungeon extends MapGenStructure {
    ...
    public String func_143025_a() {
        return "aether_legacy:ancient_silver_dungeon";
    }
    ...
    protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ) {
        ...
        if (randomTracker.testRandom(this.rand, 200) != 0) {
            if (randomTracker.testRandom(this.rand, 240) != 0) {
                return false;
            }
        }

        return chunkX % 7 == 0 && chunkZ % 7 == 0;
    }
    ...
    public static class Start extends StructureStart {
        ...
        private void create(World worldIn, Random random, int chunkX, int chunkZ) {
            ...
            ComponentAncientSilverDungeon dungeon = new ComponentAncientSilverDungeon(
                (chunkX << 4) + 2,
                (chunkZ << 4) + 2);
            ...
            dungeon.getBoundingBox()
                .offset(0, random.nextInt(64), 0);
