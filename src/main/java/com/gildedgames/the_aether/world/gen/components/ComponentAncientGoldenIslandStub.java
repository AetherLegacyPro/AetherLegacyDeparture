...
public class ComponentAncientGoldenIslandStub extends AetherStructure {

    private int x, y, z;

    private int l;

    public ComponentAncientGoldenIslandStub() {

    }

    public ComponentAncientGoldenIslandStub(int chunkX, int chunkZ, int x, int y, int z, int l) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.l = l;
                            ...
                            if (k1 >= 4) {
                                ...
                                if (l3 == 0) {
                                    ...
                                    if (this.random.nextInt(3) == 0) {
                                        ...
                                        // BlockPos.MutableBlockPos((i1 + i + random.nextInt(3)) - random.nextInt(3), k1
                                        // + j, (i2 + k + random.nextInt(3)) - random.nextInt(3)));
                                    }
                                }
                            }
