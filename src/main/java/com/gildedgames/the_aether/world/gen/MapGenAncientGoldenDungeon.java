...
public class MapGenAncientGoldenDungeon extends MapGenStructure {
    ...
    public static class Start extends StructureStart {
        ...
        private void create(World worldIn, Random random, int chunkX, int chunkZ) {
            ...
            ComponentAncientGoldenIsland dungeon = new ComponentAncientGoldenIsland(
                (chunkX << 4) + 2,
                (chunkZ << 4) + 2);
            ...
            for (int stubIslands = 0; stubIslands < this.stubIslandCount; ++stubIslands) {
                ...
                this.components
                    .add(new ComponentAncientGoldenIslandStub((chunkX << 4) + 2, (chunkZ << 4) + 2, l4, k5, i6, 8));
            }

            this.components
                .add(new ComponentAncientGoldenDungeon((chunkX << 4) + 2, (chunkZ << 4) + 2, this.dungeonDirection));
