...
public class MapGenAncientGoldenDungeon extends MapGenStructure {
    ...
    public String func_143025_a() {
        return "AetherAncientSilverDungeon";
    }
    ...
    private boolean isValidGoldenDungeonBiomeAt(int worldX, int worldZ) {
        ...
        if (AetherWorld.aercloud_fields != null && biome.biomeID == AetherWorld.aercloud_fields.biomeID) {
            return false;
        }

        if (AetherWorld.quicksoil_dunes != null && biome.biomeID == AetherWorld.quicksoil_dunes.biomeID) {
            return false;
        }
