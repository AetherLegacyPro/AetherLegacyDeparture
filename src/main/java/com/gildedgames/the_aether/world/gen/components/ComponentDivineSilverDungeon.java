...
public class ComponentDivineSilverDungeon extends AetherStructure {
    ...
    public boolean generate() {
        ...
        this.setBlocks(LOCKED_ANGELIC_STONE, BlocksAether.divine_angelic_trap, 70);
                    ...
                    if (p == 0 && q != 0 && this.secondStaircaseZ == r) {
                        ...
                        if (type >= 3) {
                            this.setBlockWithOffset(
                                ...
                                -1 + q * 5,
                                7 + r * 7,
                                BlocksAether.divine_angelic_trap,
                                0);
        ...
        EntityDivineValkyrieQueen valkyrieQueen = new EntityDivineValkyrieQueen(
            this.worldObj,
    ...
    public void generateChandelier(int x, int y, int z, int height) {
        for (int lineY = y + (height + 3); lineY < y + (height + 6); lineY++) {
            this.setBlockWithOffset(x, lineY, z, BlocksAether.golden_oak_fence, 0);
        }
    ...
    private ItemStack getNormalLoot(Random random) {
        ...
        switch (item) {
            ...
            case 12: {
                if (random.nextInt(15) == 0) return new ItemStack(ItemsAether.raw_gravitite, random.nextInt(2) + 1);
            }
            case 13:
    ...
    public static ItemStack getDivineSilverLoot(Random random) {
        ...
        switch (item) {
            case 0:
                return new ItemStack(ItemsAether.gummy_swet, random.nextInt(4) + 1, random.nextInt(2));
            case 1:
