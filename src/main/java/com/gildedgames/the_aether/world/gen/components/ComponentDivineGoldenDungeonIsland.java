							...
							if (l2 >= 24 / 2) {
								...
								if (j5 < 2) {
									...
									if (this.random.nextInt(3) == 0) {
										AetherGenUtils.generateGoldenTulip(this, BlocksAether.enchanted_aether_tulips, 0, (i2 + this.random.nextInt(3)) - this.random.nextInt(3), l2 + 1, (i3 + this.random.nextInt(3)) - this.random.nextInt(3));
									}
									if (this.random.nextInt(3) == 0) {
										AetherGenUtils.generateGoldenQuickshoot(this, BlocksAether.enchanted_quickshoot, 0, (i2 + this.random.nextInt(3)) - this.random.nextInt(3), l2 + 1, (i3 + this.random.nextInt(3)) - this.random.nextInt(3));
									}else {
										AetherGenUtils.generateGoldenFlower(this, BlocksAether.enchanted_aether_tallgrass, 0, (i2 + this.random.nextInt(3)) - this.random.nextInt(3), l2 + 1, (i3 + this.random.nextInt(3)) - this.random.nextInt(3));
									}
								}
					...
					for (int l2 = j1; l2 <= i2; l2++) {
						...
						if (d12 * d12 + d13 * d13 < 1.0D) {
							for (int i3 = k1; i3 <= j2; i3++) {
								...
								if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && (block == BlocksAether.azure_holystone || block == BlocksAether.holystone || block == BlocksAether.enchanted_aether_grass || block == BlocksAether.aether_dirt)) {
