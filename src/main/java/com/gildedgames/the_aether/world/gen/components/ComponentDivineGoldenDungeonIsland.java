        ...
        for (int k1 = -j1; k1 <= j1; k1++) {
            for (int l1 = 24; l1 >= -j1; l1--) {
                for (int k2 = -j1; k2 <= j1; k2++) {
                    ...
                    if (state == BlocksAether.locked_divine_hellfire_stone && ++i1 > 24 / 2) {
                        return;
                    }
                }
                ...
                for (int i3 = -24; i3 <= 24; i3++) {
                    ...
                    if (Math.sqrt(k3 * k3 + i4 * i4 + k4 * k4) <= 24.0D) {
                        if (BlocksAether.isGood(this.getBlockStateWithOffset(i2, l2 + 1, i3)) && l2 > 4) {
                            this.setBlockWithOffset(i2, l2, i3, BlocksAether.enchanted_aether_grass, 3);
                            this.setBlockWithOffset(i2, l2 - 1, i3, BlocksAether.aether_dirt, 0);
                            this.setBlockWithOffset(
                                i2,
                                l2 - (1 + this.random.nextInt(2)),
                                i3,
                            ...
                            if (l2 >= 24 / 2) {
                                ...
                                if (j5 < 2) {
                                    ...
                                    if (this.random.nextInt(2) == 0) {
                                        // new WorldGenLakes(Blocks.FLOWING_WATER).generate(world, random, new
                                        // BlockPos.MutableBlockPos((i2 + i + random.nextInt(3)) - random.nextInt(3), l2
                                        // + j, (i3 + k + random.nextInt(3)) - random.nextInt(3)));
                                    }
                                } else if (j5 == 4) {
                                    if (this.random.nextInt(4) == 0) {
                                        AetherGenUtils.generateGoldenFlower(
                                            this,
                                            BlocksAether.enchanted_aether_tallgrass,
                                            0,
                                            (i2 + this.random.nextInt(3)) - this.random.nextInt(3),
                                            l2 + 1,
                                            (i3 + this.random.nextInt(3)) - this.random.nextInt(3));
                                    }
                                    if (this.random.nextInt(3) == 0) {
                                        AetherGenUtils.generateGoldenTulip(
                                            this,
                                            BlocksAether.enchanted_aether_tulips,
                                            0,
                                            (i2 + this.random.nextInt(3)) - this.random.nextInt(3),
                                            l2 + 1,
                                            (i3 + this.random.nextInt(3)) - this.random.nextInt(3));
                                    ...
                                    if (this.random.nextInt(3) == 0) {
                                        AetherGenUtils.generateGoldenQuickshoot(
                                            this,
                                            BlocksAether.enchanted_quickshoot,
                                            0,
                                            (i2 + this.random.nextInt(3)) - this.random.nextInt(3),
                                            l2 + 1,
                                            (i3 + this.random.nextInt(3)) - this.random.nextInt(3));
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D) {
                            for (int i3 = k1; i3 <= j2; i3++) {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D
                                    && (block == BlocksAether.azure_holystone || block == BlocksAether.holystone
