...
public class MapGenAetherCaves extends MapGenBase {
    ...
    protected void func_151542_a(final long p_151542_1_, final int p_151542_3_, final int p_151542_4_,
        final Block[] p_151542_5_, final byte[] metadata, final double p_151542_6_, final double p_151542_8_,
        final double p_151542_10_) {
        this.func_151541_a(
            p_151542_1_,
            p_151542_3_,
            p_151542_4_,
    ...
    protected void func_151541_a(final long p_151541_1_, final int p_151541_3_, final int p_151541_4_,
        final Block[] p_151541_5_, final byte[] metadata, double p_151541_6_, double p_151541_8_, double p_151541_10_,
        final float p_151541_12_, float p_151541_13_, float p_151541_14_, int p_151541_15_, int p_151541_16_,
        final double p_151541_17_) {
        ...
        while (p_151541_15_ < p_151541_16_) {
            ...
            if (flag2 || random.nextInt(4) != 0) {
                ...
                if (p_151541_6_ >= d4 - 16.0 - d6 * 2.0 && p_151541_10_ >= d5 - 16.0 - d6 * 2.0
                    && p_151541_6_ <= d4 + 16.0 + d6 * 2.0
                    && p_151541_10_ <= d5 + 16.0 + d6 * 2.0) {
                                ...
                                if (d12 * d12 + d13 * d13 < 1.0) {
                                    for (int l3 = i5 - 1; l3 >= j2; --l3) {
                                        ...
                                        if (d14 > -0.7 && d12 * d12 + d14 * d14 + d13 * d13 < 1.0) {
                                            ...
                                            if (this
                                                .isTopBlock(p_151541_5_, k4, k3, l3, j4, p_151541_3_, p_151541_4_)) {
                                                flag5 = true;
                                            }
                                            this.digBlock(
                                                p_151541_5_,
                                                ...
                                                flag5);
                                            this.worldObj
                                                .getBiomeGenForCoords(k3 + p_151541_3_ * 16, j4 + p_151541_4_ * 16);
                                        }
                                        --k4;
                                    }
                                }
    ...
    protected void func_151538_a(final World p_151538_1_, final int p_151538_2_, final int p_151538_3_,
        final int p_151538_4_, final int p_151538_5_, final Block[] p_151538_6_, final byte[] metadata) {
    ...
    protected void digBlock(final Block[] data, final byte[] metadata, final int index, final int x, final int y,
        final int z, final int chunkX, final int chunkZ, final boolean foundTop) {
        final BiomeGenBase biome = this.worldObj.getBiomeGenForCoords(x + chunkX * 16, z + chunkZ * 16);
        final Block top = biome.topBlock;
        final Block filler = biome.fillerBlock;
        final Block block = data[index];
        if (block == BlocksAether.holystone || block == BlocksAether.mossy_holystone
    ...
    public void generate(final IChunkProvider p_151539_1_, final World p_151539_2_, final int p_151539_3_,
        final int p_151539_4_, final Block[] p_151539_5_, final byte[] metadata) {
