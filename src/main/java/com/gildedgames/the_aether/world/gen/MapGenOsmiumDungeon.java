...
public class MapGenOsmiumDungeon extends MapGenStructure {

	public MapGenOsmiumDungeon() {
	}

	@Override
	public String func_143025_a() {
		return "aether_legacy:osmium_dungeon";
	}
	...
	public static class Start extends StructureStart {
		...
		private void create(World worldIn, Random random, int chunkX, int chunkZ) {
			...
			ComponentOsmiumDungeon dungeon = new ComponentOsmiumDungeon((chunkX << 4) + 2, (chunkZ << 4) + 2);
			...
			dungeon.getBoundingBox().offset(0, random.nextInt(64), 0); //64
