...
public class ComponentAncientSilverDungeon extends AetherStructure {
	...
	public boolean generate() {
		...
		EntityAncientValkyrieQueen valkyrieQueen = new EntityAncientValkyrieQueen(this.worldObj, this.getActualX(40, 15), (double) this.getActualY(1) + 0.5D, this.getActualZ(40, 15));
