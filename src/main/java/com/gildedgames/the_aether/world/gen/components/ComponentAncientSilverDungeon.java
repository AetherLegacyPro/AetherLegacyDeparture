...
public class ComponentAncientSilverDungeon extends AetherStructure {
    ...
    public boolean generate() {
        ...
        for (int tries = 0; tries < 100; tries++) {
            AetherGenUtils.generateClouds(
                this,
                BlocksAether.aercloud,
                0,
                false,
                10,
                this.random.nextInt(77),
                0,
                    ...
                    if (p == 0 && q != 0 && this.secondStaircaseZ == r) {
                        ...
                        if (type >= 3) {
                            this.setBlockWithOffset(
                                ...
                                -1 + q * 5,
                                7 + r * 7,
                                BlocksAether.ancient_angelic_trap,
                                0);
                            ...
                            switch (roomType) {
                                case 1: {
                                    ...
                                    if (this.getBlockState(u, 5 * q + 1, v)
                                        .getMaterial() == Material.air) {
                                        this.setBlockWithOffset(u, 5 * q + 1, v, BlocksAether.skyroot_chest, 0);
                                        ...
                                        if (tileEntity instanceof TileEntitySkyrootChest) {
                                            for (u = 0; u < 3 + random.nextInt(3); u++) {
                                                ((TileEntitySkyrootChest) tileEntity).setInventorySlotContents(
                                                    this.random.nextInt(
                                                        ((TileEntitySkyrootChest) tileEntity).getSizeInventory()),
                                                    this.getNormalLoot(this.random));
                                            }
                                        }
                                    }
                                ...
                                case 2: {
                                    this.addPlaneY(7 + 7 * p, 5 * q, 7 + 7 * r, 2, 2);
                                    this.setBlockWithOffset(
                                        7 + 7 * p + this.random.nextInt(2),
                                        5 * q + 1,
                                        7 + 7 * r + this.random.nextInt(2),
        ...
        EntityAncientValkyrieQueen valkyrieQueen = new EntityAncientValkyrieQueen(
            this.worldObj,
            this.getActualX(40, 15),
            (double) this.getActualY(1) + 0.5D,
            this.getActualZ(40, 15));
        ...
        this.setBlockWithOffset(x - 1, -1, z + 1, BlocksAether.treasure_chest, 0);
    ...
    public void generateChandelier(int x, int y, int z, int height) {
        for (int lineY = y + (height + 3); lineY < y + (height + 6); lineY++) {
            this.setBlockWithOffset(x, lineY, z, BlocksAether.wisproot_fence, 0);
        }
    ...
    public void generateStaircase(int x, int y, int z, int height) {
        ...
        Block slab = BlocksAether.carved_caelestia_stone_slab;

        Block double_slab = BlocksAether.carved_caelestia_stone_double_slab;
    ...
    private ItemStack getNormalLoot(Random random) {
        ...
        switch (item) {
            ...
            case 6:
                return new ItemStack(ItemsAether.dart, random.nextInt(20) + 1, 0);
            case 7:
                return new ItemStack(ItemsAether.dart, random.nextInt(15) + 1, 1);
            case 8:
                return new ItemStack(ItemsAether.dart, random.nextInt(15) + 1, 2);
            case 9: {
                if (random.nextInt(20) == 0) return new ItemStack(ItemsAether.aether_tune);
                break;
            }
            case 10:
                return new ItemStack(ItemsAether.zanite_gemstone, random.nextInt(5) + 1);
            case 11: {
                if (random.nextInt(10) == 0) return new ItemStack(ItemsAether.ascending_dawn);
                break;
            }
            case 12: {
            ...
            case 13: {
                if (random.nextInt(4) == 0) return new ItemStack(ItemsAether.wynberry, random.nextInt(6) + 1, 2);
            }
            case 14: {
                if (random.nextInt(10) == 0) return new ItemStack(ItemsAether.continuum_gemstone);
            }
            case 15: {
                if (random.nextInt(15) == 0) return new ItemStack(ItemsAether.arkenium_chunk, random.nextInt(1) + 1);
            }
            case 16:
    ...
    public static ItemStack getAncientSilverLoot(Random random) {
        ...
        switch (item) {
            ...
            case 12:
                if (AetherConfig.valkyrieCapeEnabled()) return new ItemStack(ItemsAether.valkyrie_cape);
            case 13:
                if (AetherConfig.goldenFeatherEnabled()) return new ItemStack(ItemsAether.golden_feather);
        }
