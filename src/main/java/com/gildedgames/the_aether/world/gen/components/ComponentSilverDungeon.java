...
public class ComponentSilverDungeon extends AetherStructure {
    ...
    public boolean generate() {
        ...
        EntityValkyrieQueen valkyrieQueen = new EntityValkyrieQueen(
            this.worldObj,
    ...
    public void generateChandelier(int x, int y, int z, int height) {
        for (int lineY = y + (height + 3); lineY < y + (height + 6); lineY++) {
            this.setBlockWithOffset(x, lineY, z, BlocksAether.skyroot_fence, 0);
        }
    ...
    private ItemStack getNormalLoot(Random random) {
        ...
        switch (item) {
            ...
            case 15: {
                if (random.nextInt(15) == 0) return new ItemStack(ItemsAether.arkenium_pendant);
            }
            case 16:
    ...
    public static ItemStack getSilverLoot(Random random) {
        ...
        return new ItemStack(ItemsAether.zanite_gemstone, random.nextInt(3) + 4);
    }
}
