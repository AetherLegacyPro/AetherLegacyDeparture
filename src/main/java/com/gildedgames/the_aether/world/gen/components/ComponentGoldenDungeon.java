...
public class ComponentGoldenDungeon extends AetherStructure {
    ...
    public ComponentGoldenDungeon(int chunkX, int chunkZ, int direction) {
        ...
        this.boundingBox = new StructureBoundingBox(chunkX, 80, chunkZ, chunkX + 100, 160, chunkZ + 100); // 220
    }
    ...
    public boolean generate() {
                ...
                for (int k = -a; k <= a; k++) {
                    if (j == 4) {
                        ...
                        if (i == a || -i == a || k == a || -k == a) {
                            ...
                            if (j == -2 && (i == (a - 1) || -i == (a - 1) || k == (a - 1) || -k == (a - 1))
                                && (i % 3 == 0 || k % 3 == 0)) {
                        ...
                        if (j == -3) {
                            ...
                            if (i == wid) {
                                if (k < 2 && k > -2 && j < 0) {
                                    ...
                                    this.setBlocks(
                                        BlocksAether.locked_hellfire_stone,
                                        BlocksAether.locked_light_hellfire_stone,
                                        10);
        ...
        EntitySunSpirit boss = new EntitySunSpirit(
            this.worldObj,
            this.getActualX(0, 0),
            this.getActualY(-1),
            this.getActualZ(0, 0),
