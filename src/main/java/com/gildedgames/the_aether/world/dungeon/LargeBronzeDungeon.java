...
public class LargeBronzeDungeon extends AetherDungeon {
	private boolean needsCorridor;
	private int roomMaximum;
	private int roomCount;

	public LargeBronzeDungeon() {
		needsCorridor = false;
	}
	...
	public boolean generateBossRoom(World world, Random random, int i, int j, int k)
	{
		...
		setBlocks(this.lockedBlock(), this.lockedLightBlock(), 15);
		...
		EntityEnhancedSlider slider = new EntityEnhancedSlider(world);
	...
	public boolean generateNextRoom(World world, Random random, PositionData pos, int dir) {
		...
		switch (type) {
			case 0: {
				...
				world.setBlock(p + 1, y + 2, q, BlocksAether.chest_mimic);
				break;
			}
			case 1: {
				if (world.getBlock(p, y + 2, q) == Blocks.air) {
					world.setBlock(p, y + 2, q, BlocksAether.skyroot_chest);
					world.setBlock(p + 1, y + 2, q, BlocksAether.skyroot_chest);
					TileEntitySkyrootChest chest = (TileEntitySkyrootChest) world.getTileEntity(p, y + 2, q);
					TileEntitySkyrootChest chestt = (TileEntitySkyrootChest) world.getTileEntity(p + 1, y + 2, q);
					...
					// - -	
					world.setBlock(x + 4, y + 6, z + 4, BlocksAether.ancient_carved_stone_wall);
										
					world.setBlock(x + 3, y + 1, z + 3, BlocksAether.ancient_carved_stone);
					world.setBlock(x + 4, y + 1, z + 3, BlocksAether.ancient_carved_stone);
					world.setBlock(x + 3, y + 1, z + 4, BlocksAether.ancient_carved_stone);
					world.setBlock(x + 3, y + 2, z + 3, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 4, y + 2, z + 3, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 3, y + 2, z + 4, BlocksAether.ancient_carved_stone_wall);
					
					// + -
					world.setBlock(x + 7, y + 6, z + 4, BlocksAether.ancient_carved_stone_wall);
					
					world.setBlock(x + 8, y + 1, z + 3, BlocksAether.ancient_carved_stone);
					world.setBlock(x + 7, y + 1, z + 3, BlocksAether.ancient_carved_stone);
					world.setBlock(x + 8, y + 1, z + 4, BlocksAether.ancient_carved_stone);				
					world.setBlock(x + 8, y + 2, z + 3, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 7, y + 2, z + 3, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 8, y + 2, z + 4, BlocksAether.ancient_carved_stone_wall);
					
					// - +
					world.setBlock(x + 4, y + 6, z + 7, BlocksAether.ancient_carved_stone_wall);
					
					world.setBlock(x + 3, y + 1, z + 8, BlocksAether.ancient_carved_stone);
					world.setBlock(x + 3, y + 1, z + 7, BlocksAether.ancient_carved_stone);
					world.setBlock(x + 4, y + 1, z + 8, BlocksAether.ancient_carved_stone);					
					world.setBlock(x + 3, y + 2, z + 8, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 3, y + 2, z + 7, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 4, y + 2, z + 8, BlocksAether.ancient_carved_stone_wall);
					
					// + +
					world.setBlock(x + 7, y + 6, z + 7, BlocksAether.ancient_carved_stone_wall);
					
					world.setBlock(x + 8, y + 1, z + 8, BlocksAether.ancient_carved_stone);
					world.setBlock(x + 7, y + 1, z + 8, BlocksAether.ancient_carved_stone);
					world.setBlock(x + 8, y + 1, z + 7, BlocksAether.ancient_carved_stone);					
					world.setBlock(x + 8, y + 2, z + 8, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 7, y + 2, z + 8, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 8, y + 2, z + 7, BlocksAether.ancient_carved_stone_wall);
					
					world.setBlock(x + 1, y + 1, z + 1, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 2, z + 1, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 3, z + 1, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 4, z + 1, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 5, z + 1, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 6, z + 1, BlocksAether.ancient_carved_stone_wall);
					
					world.setBlock(x + 9, y + 1, z + 1, BlocksAether.ancient_carved_stone_wall);					
					world.setBlock(x + 9, y + 2, z + 1, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 9, y + 3, z + 1, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 9, y + 4, z + 1, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 9, y + 5, z + 1, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 9, y + 6, z + 1, BlocksAether.ancient_carved_stone_wall);	
					
					world.setBlock(x + 9, y + 1, z + 9, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 9, y + 2, z + 9, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 9, y + 3, z + 9, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 9, y + 4, z + 9, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 9, y + 5, z + 9, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 9, y + 6, z + 9, BlocksAether.ancient_carved_stone_wall);	
					
					world.setBlock(x + 1, y + 1, z + 9, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 2, z + 9, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 3, z + 9, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 4, z + 9, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 5, z + 9, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 6, z + 9, BlocksAether.ancient_carved_stone_wall);
			...
			case 2: {
				if (world.getBlock(p, y + 2, q) == Blocks.air) {
					...
					world.setBlock(x + 11, y + 1, z + 1, BlocksAether.ancient_carved_stone_wall);					
					world.setBlock(x + 11, y + 2, z + 1, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 11, y + 3, z + 1, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 11, y + 4, z + 1, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 11, y + 5, z + 1, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 11, y + 6, z + 1, BlocksAether.ancient_carved_stone_wall);	
					
					world.setBlock(x + 11, y + 1, z + 11, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 11, y + 2, z + 11, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 11, y + 3, z + 11, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 11, y + 4, z + 11, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 11, y + 5, z + 11, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 11, y + 6, z + 11, BlocksAether.ancient_carved_stone_wall);	
					
					world.setBlock(x + 1, y + 1, z + 11, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 2, z + 11, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 3, z + 11, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 4, z + 11, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 5, z + 11, BlocksAether.ancient_carved_stone_wall);
					world.setBlock(x + 1, y + 6, z + 11, BlocksAether.ancient_carved_stone_wall);
		...
		switch (switchCase)
		{
			case 1:
			{
				...
				while(tunnelling)
				{
					...
					if (hasBlock(world, new PositionData(x + 1, y, z), new PositionData(2, 8, 6), BlocksAether.ancient_carved_stone)
							|| hasBlock(world, new PositionData(x + 1, y, z), new PositionData(2, 8, 6), BlocksAether.locked_ancient_carved_stone))
					{
						tunnelling = false;
					}
			...
			case 2:
			{
				...
				while(tunnelling)
				{
					...
					if (hasBlock(world, new PositionData(x - 1, y, z), new PositionData(1, 8, 6), BlocksAether.ancient_carved_stone)
							|| hasBlock(world, new PositionData(x - 1, y, z), new PositionData(1, 8, 6), BlocksAether.locked_ancient_carved_stone))
					{
						tunnelling = false;
					}
			...
			case 3:
			{
				...
				while(tunnelling)
				{
					...
					if (hasBlock(world, new PositionData(x, y, z + 1), new PositionData(6, 8, 2), BlocksAether.ancient_carved_stone)
							|| hasBlock(world, new PositionData(x, y, z + 1), new PositionData(6, 8, 2), BlocksAether.locked_ancient_carved_stone))
					{
						tunnelling = false;
					}
			...
			case 4:
			{
				...
				while(tunnelling)
				{
					...
					if (hasBlock(world, new PositionData(x, y, z - 1), new PositionData(6, 8, 1), BlocksAether.ancient_carved_stone)
							|| hasBlock(world, new PositionData(x, y, z - 1), new PositionData(6, 8, 1), BlocksAether.locked_ancient_carved_stone))
					{
						tunnelling = false;
					}
	...
	private ItemStack getNormalLoot(Random random) {
		...
		switch (item) {
			...
			case 5:
				return new ItemStack(ItemsAether.ambrosium_shard, random.nextInt(5) + 1);
			case 6:
				return new ItemStack(ItemsAether.gummy_swet, random.nextInt(3) + 2, 1);
			case 7:
				return new ItemStack(ItemsAether.zanite_gemstone, random.nextInt(8) + 1);
			case 10: {
	...
	protected Block setRandomBlock(World world, Random random) {
		...
		return BlocksAether.ancient_carved_stone;
	}
	

	public Block lockedLightBlock() {
		return BlocksAether.locked_ancient_sentry_stone;
	}
	...
	public Block lockedBlock() {
		return BlocksAether.locked_ancient_carved_stone;
	}

	public Block mainLightBlock() {
		return BlocksAether.ancient_sentry_stone;
	}
	...
	public Block fillerBlock1() {
		return BlocksAether.bloodmoss_stone;
	}
