...
public class PalladiumDungeonTotem extends WorldGenerator {
    ...
    public static ItemStack getPalladiumLoot(Random random) {
        ...
        switch (item) {
            ...
            case 2: {
                if (random.nextBoolean()) return new ItemStack(ItemsAether.divineral_ingot, random.nextInt(2) + 1);
                if (random.nextBoolean()) return new ItemStack(ItemsAether.arkenium_ingot, random.nextInt(5) + 2);
                if (random.nextBoolean()) return new ItemStack(ItemsAether.continuum_gemstone, random.nextInt(2) + 1);
                if (random.nextBoolean()) return new ItemStack(ItemsAether.zanite_gemstone, random.nextInt(20) + 18);
                break;
            }
            case 3:
            ...
            case 12:
                return new ItemStack(ItemsAether.elysian_boots);
            case 13:
                if (random.nextBoolean()) return new ItemStack(ItemsAether.elysian_ring);
            case 14:
                if (random.nextBoolean()) return new ItemStack(ItemsAether.elysian_apple);
            case 15:
