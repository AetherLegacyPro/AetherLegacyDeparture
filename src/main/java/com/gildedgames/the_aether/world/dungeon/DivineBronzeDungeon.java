...
public class DivineBronzeDungeon extends AetherDungeon {
        ...
        switch (rand) {
            case 1:
                ...
                TileEntityMobSpawner tileentitymobspawner2 = (TileEntityMobSpawner) world
                    .getTileEntity(i + 9, j + 9, k + 9);

                if (tileentitymobspawner2 != null) {
                    tileentitymobspawner2.func_145881_a()
                        .setEntityName("aether_legacy.aercenturion");
                }
                break;
            case 2:
                world.setBlock(i + 9, j + 10, k + 9, BlocksAether.divine_carved_stone_wall);
                ...
                if (tileentitymobspawner3 != null) {
                    tileentitymobspawner3.func_145881_a()
                        .setEntityName("aether_legacy.cockatrice");
                }
                break;
            case 3:
                world.setBlock(i + 9, j + 10, k + 9, BlocksAether.divine_carved_stone_wall);
            ...
            case 0: {
                ...
                for (int p = x + 2; p < x + 10; p += 3) {
                    for (int q = z + 2; q < z + 10; q += 3) {
                        ...
                        world.setBlock(p, j, q, BlocksAether.locked_divine_carved_stone);
                    }
                }
        ...
        switch (type) {
            case 0: {
                ...
                for (p = 0; p < 3 + random.nextInt(10); p++) {
                    chest
                        .setInventorySlotContents(random.nextInt(chest.getSizeInventory()), this.getNormalLoot(random));
                }
            ...
            case 1: {
                ...
                while (tunnelling) {
                    ...
                    if (hasBlock(
                        ...
                        BlocksAether.divine_carved_stone)
                        || hasBlock(
                            world,
                            new PositionData(x + 1, y, z),
                            new PositionData(2, 8, 6),
                            BlocksAether.locked_divine_carved_stone)) {
                        tunnelling = false;
                    }
    ...
    private ItemStack getNormalLoot(Random random) {
        ...
        switch (item) {
            ...
            case 5:
                return new ItemStack(ItemsAether.ambrosium_shard, random.nextInt(12) + 1);
            case 6:
    ...
    public static ItemStack getDivineBronzeLoot(Random random) {
        ...
        return switch (item) {
            ...
            case 1 -> new ItemStack(ItemsAether.zanite_shield);
            ...
            case 9 -> new ItemStack(ItemsAether.enchanted_divineral, random.nextInt(2) + 1);
            case 10 -> new ItemStack(ItemsAether.phoenix_bow);
            case 11 -> new ItemStack(ItemsAether.cloud_staff);
            case 12 -> new ItemStack(BlocksAether.ancient_enchanter);
            default -> new ItemStack(BlocksAether.enchanted_gravitite, random.nextInt(2) + 1);
        };
    }
