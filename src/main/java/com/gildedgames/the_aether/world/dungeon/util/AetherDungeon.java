...
public abstract class AetherDungeon extends WorldGenerator {
    ...
    public void addSquareTube(World world, Random rand, PositionData pos, PositionData radius, int angel) {
        ...
        if (angel == 0 || angel == 2) {
            ...
            this.addPlaneY(
                world,
                rand,
                new PositionData(pos.getX(), pos.getY() + (radius.getY() - 1), pos.getZ()),
                radius);
        }
        ...
        if (angel == 1 || angel == 2) {
            ...
            this.addPlaneX(
                world,
                rand,
                new PositionData(pos.getX() + (radius.getX() - 1), pos.getY(), pos.getZ()),
                radius);
        }
        ...
        if (angel == 0 || angel == 1) {
            ...
            this.addPlaneZ(
                world,
                rand,
                new PositionData(pos.getX(), pos.getY(), pos.getZ() + (radius.getZ() - 1)),
                radius);
        }
    }
    ...
    protected void setBlock(World world, Random random, int x, int y, int z, Block state, Block extraState,
        int chance) {
    ...
    protected void setTwoBlock(World world, Random random, int x, int y, int z, Block statee, Block extraStatee,
        int chancee) {
        if (random.nextInt(chancee) == 0) {
            this.setBlockAndNotifyAdequately(world, x, y, z, extraStatee, 0);
        } else {
            this.setBlockAndNotifyAdequately(world, x, y, z, statee, 0);
        }
    }
