...
public class PalladiumDungeon extends WorldGenerator {
   ...
   private void generateOre(World world, Random rand, int x, int y, int z) {
      ...
      for(int i = 0; i < 8 + rand.nextInt(radius); ++i) {
         ...
         if (world.getBlock(x1, y1, z1).isReplaceableOreGen(world, x, y, z, BlocksAether.genesis_stone)) {
   ...
   private static PalladiumDecorationHiddenTreasure hidden = new PalladiumDecorationHiddenTreasure(Blocks.air, 1, true);
