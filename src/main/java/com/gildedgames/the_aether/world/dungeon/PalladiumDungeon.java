...
public class PalladiumDungeon extends WorldGenerator {
    ...
    public PalladiumDungeon(int bumpsWide1, int bumpsLong1, int bumpHeightVarTop1, int bumpHeightVarBottom1,
        int bumpHeightMinTop1, int bumpHeightMinBottom1, int blocksPerBumpX1, int blocksPerBumpZ1,
        int blocksPerBumpTopY1, int blocksPerBumpBottomY1, int blurPassesTop1, int blurPassesBottom1,
        int spikeHeightVarTop1, int spikeHeightVarBottom1, int radialDistanceSamples1, double radialDistanceMin1,
        double radialDistanceVar1, int radialDistanceScaling1, int radialDistanceBlurPasses1, Block genOre) {
    ...
    public boolean generate(World world, Random rand, int x, int y, int z) {
        double[] ad = this.createRadialDistanceMap(
            rand,
            this.radialDistanceSamples1,
            this.radialDistanceMin1,
            this.radialDistanceVar1,
            this.radialDistanceScaling1,
            this.radialDistanceBlurPasses1);
        this.generateHalf(
            world,
            rand,
            x,
            ...
            this.bumpsWide1,
            this.bumpsLong1,
            this.bumpHeightMinBottom1,
            this.bumpHeightVarBottom1,
            this.blocksPerBumpX1,
            this.blocksPerBumpZ1,
            this.blocksPerBumpBottomY1,
            this.blurPassesBottom1,
            this.spikeHeightVarBottom1,
            ad,
            this.radialDistanceSamples1 * this.radialDistanceScaling1);
        this.generateHalf(
            world,
            rand,
            x,
            ...
            this.bumpsWide1,
            this.bumpsLong1,
            this.bumpHeightMinTop1,
            this.bumpHeightVarTop1,
            this.blocksPerBumpX1,
            this.blocksPerBumpZ1,
            this.blocksPerBumpTopY1,
            this.blurPassesTop1,
            this.spikeHeightVarTop1,
            ad,
            this.radialDistanceSamples1 * this.radialDistanceScaling1);
    ...
    private void generateHalf(World world, Random rand, int x, int y, int z, boolean flag, int l, int i1, int j1,
        int k1, int l1, int i2, int j2, int k2, int l2, double[] ad, int i3) {
    ...
    private int[][] generateHeightMap(Random rand, int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2,
        double[] ad, int j2) {
        int k2 = i * i1;
        int l2 = j * j1;
    ...
    private Block materialAtLevel(Random rand, int i, boolean flag) {
        ...
        if (i < j) {
            return rand.nextInt(10) == 0 ? BlocksAether.light_genesis_stone : BlocksAether.genesis_stone;
        }
        if (i == j) {
            int rand3 = (int) (1 + Math.random() * 3);
            if (rand3 == 1) {
                return rand.nextInt(14) == 0 ? BlocksAether.light_genesis_stone : BlocksAether.genesis_stone; // put 3rd
                                                                                                              // variant
                                                                                                              // for
                                                                                                              // this
                                                                                                              // block
        ...
        if (i > j) {
            return rand.nextInt(10) == 0 ? BlocksAether.light_genesis_stone : BlocksAether.genesis_stone; // put 3rd
                                                                                                          // variant for
                                                                                                          // this block
                                                                                                          // here
        } else {
    ...
    private void generateOre(World world, Random rand, int x, int y, int z) {
        ...
        for (int i = 0; i < 8 + rand.nextInt(radius); ++i) {
            ...
            if (world.getBlock(x1, y1, z1)
                .isReplaceableOreGen(world, x, y, z, BlocksAether.genesis_stone)) {
                world.setBlock(x1, y1, z1, BlocksAether.light_genesis_stone);

                for (int yTest = y1; yTest < 128; ++yTest) { // 128
                    if (world.getBlock(x1, yTest, z1)
                        .isReplaceable(world, x1, yTest, z1)
                        && (world.getBlock(x1, yTest - 1, z1) == BlocksAether.genesis_stone
                            || world.getBlock(x1, yTest - 1, z1) == BlocksAether.enchanted_holystone)) {
    ...
    private static PalladiumDecorationRuins ruins = new PalladiumDecorationRuins(Blocks.air, 1, true);
    private static PalladiumDecorationHiddenTreasure hidden = new PalladiumDecorationHiddenTreasure(
        Blocks.air,
        1,
        true);
    private static PalladiumDungeonSpawner spawner = new PalladiumDungeonSpawner(Blocks.air, 1, true);
    ...
    private void generateTrees(World world, Random rand, int x, int y, int z) {
        ...
        int k2;
        int l2;
        for (i7 = 0; i7 < 1 + rand.nextInt(2); ++i7) {
            j2 = x + this.centerX + rand.nextInt(this.width) - this.centerX;
            k2 = z + this.centerZ + rand.nextInt(this.length) - this.centerZ;
            l2 = world.getHeightValue(j2, k2);
            if (l2 > 100) {
        ...
        int k8;
        int l8;
        j8 = x + this.centerX + rand.nextInt(this.width) - this.centerX;
        k8 = z + this.centerZ + rand.nextInt(this.length) - this.centerZ;
        l8 = world.getHeightValue(j8, k8);
        if (l8 > 100) {
        ...
        int k7;
        int l7;
        for (i12 = 0; i12 < 1 + rand.nextInt(2); ++i12) {
            j7 = x + this.centerX + rand.nextInt(this.width) - this.centerX;
            k7 = z + this.centerZ + rand.nextInt(this.length) - this.centerZ;
            l7 = world.getHeightValue(j7, k7);
            if (l7 > 100) {
        ...
        int k3;
        int l3;
        for (i8 = 0; i8 < 2 + rand.nextInt(2); ++i8) {
            j3 = x + this.centerX + rand.nextInt(this.width) - this.centerX;
            k3 = z + this.centerZ + rand.nextInt(this.length) - this.centerZ;
            l3 = world.getHeightValue(j3, k3);
            if (l3 > 100) {
        ...
        int k4;
        int l4;
        for (i9 = 0; i9 < 12 + rand.nextInt(60); ++i9) {
            j4 = x + this.centerX + rand.nextInt(this.width) - this.centerX;
            k4 = z + this.centerZ + rand.nextInt(this.length) - this.centerZ;
            l4 = world.getHeightValue(j4, k4);
            if (l4 > 100) {
        ...
        int k5;
        int l5;
        for (i10 = 0; i10 < 12 + rand.nextInt(60); ++i10) {
            j5 = x + this.centerX + rand.nextInt(this.width) - this.centerX;
            k5 = z + this.centerZ + rand.nextInt(this.length) - this.centerZ;
            l5 = world.getHeightValue(j5, k5);
            if (l5 > 100) {
        ...
        int k6;
        int l6;
        for (i11 = 0; i11 < 12 + rand.nextInt(60); ++i11) {
            ...
            if (l6 > 100) {
                gem.generate(world, rand, j6, l6, k6);
            }
        }
    }
