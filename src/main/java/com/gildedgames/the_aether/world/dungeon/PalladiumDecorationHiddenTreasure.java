...
public class PalladiumDecorationHiddenTreasure extends WorldGenAbstractTree {
    ...
    public boolean generate(final World world, final Random random, final int x, final int y, final int z) {
    		...
    		switch (random2) {
            case 1: world.setBlock(x + 1, y, z, BlocksAether.continuum_pile, random3, random3);
                    ...
                    break;
    		case 2: world.setBlock(x + 1, y, z, BlocksAether.gravitite_pile, random3, random3);
    			    ...
    			    break;
    		case 3: world.setBlock(x + 1, y, z, BlocksAether.arkenium_pile, random3, random3);
                    ...
                    break;
    		case 4: world.setBlock(x + 1, y, z, BlocksAether.divineral_pile, random3, random3);
