...
public class TeleporterAether extends Teleporter {
    ...
    public boolean placeInExistingPortal(Entity entityIn, double x, double y, double z, float rotationYaw) {
        ...
        if (this.destinationCoordinateCache.containsItem(j1)) {
            AetherPortalPosition portalposition = (AetherPortalPosition) this.destinationCoordinateCache
                .getValueByKey(j1);
            d3 = 0.0D;
        ...
        if (d3 >= 0.0D) {
            if (flag) {
                this.destinationCoordinateCache
                    .add(j1, new AetherPortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
            ...
            for (j3 = 0; j3 < 4; ++j3) {
                for (k3 = -1; k3 < 4; ++k3) {
                    ...
                    this.worldServerInstance
                        .setBlock(l3, i4, j4, flag ? Blocks.glowstone : BlocksAether.aether_portal, 0, 2);
                }
            }
