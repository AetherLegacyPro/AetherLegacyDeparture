...
public class ChunkProviderAether implements IChunkProvider {
    ...
    public Chunk provideChunk(int x, int z) {
        ...
        if (AetherConfig.tier2_silver_dungeon_enable && ancient_silver_chance > 2
            && (Math.abs(x) > 1200 || Math.abs(z) > 1200)) {
            this.ancientsilverDungeonStructure.func_151539_a(this, this.worldObj, x, z, ablock);
        }
        if (AetherConfig.tier3_silver_dungeon_enable && divine_silver_chance >= 4
            && (Math.abs(x) > 3000 || Math.abs(z) > 3000)) {
        ...
        if (AetherConfig.tier2_gold_dungeon_enable && ancient_gold_chance > 2
            && (Math.abs(x) > 2000 || Math.abs(z) > 2000)) {
            this.ancientGoldenDungeonStructure.func_151539_a(this, this.worldObj, x, z, ablock);
        }
        if (AetherConfig.tier3_gold_dungeon_enable && divine_gold_chance >= 4
            && (Math.abs(x) > 5000 || Math.abs(z) > 5000)) {
    ...
    public void populate(IChunkProvider provider, int chunkX, int chunkZ) {
        ...
        if (AetherConfig.tier4_bronze_dungeon_enable && mythic_bronze_chance == 1
            && (Math.abs(x) > 5000 || Math.abs(z) > 5000)) {
        ...
        if (AetherConfig.enablePurpleAercloud()) {
            if (this.rand.nextInt(60) == 0) {
                ...
                final int y = this.rand.nextInt(64) + 32;
                final int z1 = z + this.rand.nextInt(64);
                final int meta = rand.nextInt(8);
                new AetherCloudsGenNew(BlocksAether.purple_aercloud, meta, 8, false)
                    .generate(this.worldObj, this.rand, x, y, z);
            }
        }
        if (AetherConfig.enableVioletAercloud()) {
            if (this.rand.nextInt(14) == 0) {
                ...
                final int meta = rand.nextInt(8);
                new AetherCloudsGenNew(BlocksAether.violet_aercloud, meta, 4, false)
                    .generate(this.worldObj, this.rand, x, y, z);
            }
        }
        if (AetherConfig.enableDarkPurpleAercloud()) {
            if (this.rand.nextInt(17) == 0) {
                ...
                final int meta = rand.nextInt(8);
                new AetherCloudsGenNew(BlocksAether.dark_purple_aercloud, meta, 4, false)
                    .generate(this.worldObj, this.rand, x, y, z);
            }
        }
        // Green Aerclouds
        if (AetherConfig.enableLightGreenAercloud()) {
            if (this.rand.nextInt(70) == 0) {
                ...
                new AetherCloudsGenNew(BlocksAether.green_aercloud, 0, 9, false)
                    .generate(this.worldObj, this.rand, x, y, z);
            }
        }
        if (AetherConfig.enableGreenAercloud()) {
            if (this.rand.nextInt(14) == 0) {
                ...
                final int z1 = z + this.rand.nextInt(128);
                new AetherCloudsGenNew(BlocksAether.green_aercloud, 1, 4, false)
                    .generate(this.worldObj, this.rand, x, y, z);
            }
        }
        if (AetherConfig.enableLimeAercloud()) {
            if (this.rand.nextInt(17) == 0) {
                ...
                final int z1 = z + this.rand.nextInt(128);
                new AetherCloudsGenNew(BlocksAether.green_aercloud, 2, 4, false)
                    .generate(this.worldObj, this.rand, x, y, z);
            }
        }
        // Pink Aerclouds
        if (AetherConfig.enablePinkAercloud()) {
            if (this.rand.nextInt(52) == 0) {
                ...
                new AetherCloudsGenNew(BlocksAether.pink_aercloud, 0, 9, false)
                    .generate(this.worldObj, this.rand, x, y, z);
            }
        }
        if (AetherConfig.enableMagentaAercloud()) {
            if (this.rand.nextInt(54) == 0) {
                ...
                final int y = this.rand.nextInt(64) + 148;
                final int z1 = z + this.rand.nextInt(1024);
                new AetherCloudsGenNew(BlocksAether.pink_aercloud, 1, 4, false)
                    .generate(this.worldObj, this.rand, x, y, z);
            }
        }
        if (AetherConfig.enableOrangeAercloud()) {
            if (this.rand.nextInt(50) == 0) {
                ...
                new AetherCloudsGenNew(BlocksAether.pink_aercloud, 2, 4, false)
                    .generate(this.worldObj, this.rand, x, y, z);
            }
        }
        ...
        if (this.rand.nextInt(30) == 0) {
            if ((AetherConfig.shouldLoadHolidayContent())
                || (AetherConfig.allowSeasonalChristmas() && (Calendar.getInstance()
