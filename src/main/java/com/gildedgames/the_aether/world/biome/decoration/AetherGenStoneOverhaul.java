...
public class AetherGenStoneOverhaul implements IWorldGenerator {
    ...
    protected final WorldGenMinable AetheralStoneGen = new WorldGenMinable(
        BlocksAether.aetheral_stone,
        32,
        BlocksAether.holystone);
    protected final WorldGenMinable AgiositeStoneGen = new WorldGenMinable(
        BlocksAether.agiosite,
        32,
        BlocksAether.holystone);
    protected final WorldGenMinable DeificStoneGen = new WorldGenMinable(
        BlocksAether.deific,
        32,
        BlocksAether.holystone);
    protected final WorldGenMinable AetherDirtGen = new WorldGenMinable(
        BlocksAether.aether_dirt,
        32,
        BlocksAether.holystone);
    protected final WorldGenMinable IcestoneGen = new WorldGenMinable(
    ...
    public void generateOre(WorldGenMinable gen, World world, Random random, int chunkX, int chunkZ, float chance,
        int minY, int maxY) {
        if (minY < 0 || maxY < minY || chance <= 0) return;
