...
public class ArcticIslandWorldGen implements IWorldGenerator {
    ...
    public void generateAether(World world, Random rand, int x, int z) {
        ...
        if ((biome == AetherWorld.aether_biome) && AetherConfig.arctic_island_rarity != 0
            && rand.nextInt(aether_random) == 0
            && AetherConfig.arctic_island_enable) {
            byte byte0 = 20;
            byte byte1 = 20;
            byte byte2 = 35;
            byte byte3 = 35;
            ...
            if (rand.nextInt(byte21) == 0) {
                ...
                if (chance == 1) {
                    if (world.canBlockSeeTheSky(
                        MathHelper.floor_double(x1),
                        MathHelper.floor_double(y1),
                        MathHelper.floor_double(z1))) {
                        (new ArcticIsland(
                            bumpsWide1,
                            bumpsLong1,
                            bumpHeightVarTop1,
                    ...
                    if (world.canBlockSeeTheSky(
                        MathHelper.floor_double(x1 - 32),
                        MathHelper.floor_double(y1),
                        MathHelper.floor_double(z1 + 32))) {
                        (new ArcticIsland(
                            bumpsWide1,
                            bumpsLong1,
                            bumpHeightVarTop1,
