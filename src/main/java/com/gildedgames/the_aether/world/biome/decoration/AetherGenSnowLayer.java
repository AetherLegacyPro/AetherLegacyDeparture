...
public class AetherGenSnowLayer extends WorldGenerator {
    private Block plantBlockId;
    private int placementChance;

    public AetherGenSnowLayer(final Block i, final int chance) {
        this.plantBlockId = i;
    ...
    public boolean generate(final World world, final Random random, final int i, final int j, final int k) {
        for (int l = 0; l < this.placementChance; ++l) {
            ...
            if (world.isAirBlock(i2, j2, k2) && world.getBlock(i2, j2 - 1, k2) == BlocksAether.arctic_grass) {
