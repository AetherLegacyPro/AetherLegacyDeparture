...
public class AetherGenHolidayTree extends WorldGenerator {
    ...
    public boolean generate(World world, Random rand, int x, int y, int z) {
        ...
        if (block == BlocksAether.aether_grass) {
                ...
                for (int yss = z - 7; yss < z + 7; yss++) {
                    if (((xss - x) * (xss - x) + (yss - z) * (yss - z)) < 29) {
                        ...
                        if (block1 != Blocks.air) {
                            ...
                            } else if (world.getBlock(x1, y1, z1) != Blocks.snow_layer
                                || world.getBlock(x1, y1, z1) != BlocksAether.present) {
                                    world.setBlock(x1, y1, z1, Blocks.snow_layer);
                                }
                        }
                    }
            ...
            world.setBlock(x, y + 2, 1 + z, getBlock(rand));
            world.setBlock(x, y + 2, 2 + z, BlocksAether.skyroot_log);
            world.setBlock(x, y + 2, 3 + z, getBlock(rand));
            world.setBlock(x, y + 2, 4 + z, getBlock(rand));
            world.setBlock(x, y + 2, -1 + z, getBlock(rand));
            world.setBlock(x, y + 2, -2 + z, getBlock(rand));
            world.setBlock(x, y + 2, -3 + z, getBlock(rand));
            world.setBlock(x, y + 2, -4 + z, getBlock(rand));
            world.setBlock(x + 1, y + 2, z, getBlock(rand));
            world.setBlock(x + 2, y + 2, z, getBlock(rand));
            world.setBlock(x + 3, y + 2, z, getBlock(rand));
            world.setBlock(x + 4, y + 2, z, getBlock(rand));
            world.setBlock(x - 1, y + 2, z, getBlock(rand));
            world.setBlock(x - 2, y + 2, z, getBlock(rand));
            world.setBlock(x - 3, y + 2, z, BlocksAether.skyroot_log);
            world.setBlock(x - 4, y + 2, z, getBlock(rand));
            ...
            world.setBlock(x, y + 3, 1 + z, getBlock(rand));
            world.setBlock(x, y + 3, 2 + z, getBlock(rand));
            world.setBlock(x, y + 3, 3 + z, getBlock(rand));
            world.setBlock(x, y + 3, 4 + z, getBlock(rand));
            world.setBlock(x, y + 3, -1 + z, getBlock(rand));
            world.setBlock(x, y + 3, -2 + z, getBlock(rand));
            world.setBlock(x, y + 3, -3 + z, getBlock(rand));
            world.setBlock(x, y + 3, -4 + z, getBlock(rand));
            world.setBlock(x + 1, y + 3, z, getBlock(rand));
            world.setBlock(x + 2, y + 3, z, getBlock(rand));
            world.setBlock(x + 3, y + 3, z, getBlock(rand));
            world.setBlock(x + 4, y + 3, z, getBlock(rand));
            world.setBlock(x - 1, y + 3, z, getBlock(rand));
            world.setBlock(x - 2, y + 3, z, getBlock(rand));
            world.setBlock(x - 3, y + 3, z, getBlock(rand));
            world.setBlock(x - 4, y + 3, z, getBlock(rand));
            ...
            world.setBlock(x, y + 4, 1 + z, getBlock(rand));
            world.setBlock(x, y + 4, 2 + z, getBlock(rand));
            world.setBlock(x, y + 4, 3 + z, getBlock(rand));
            world.setBlock(x, y + 4, -1 + z, getBlock(rand));
            world.setBlock(x, y + 4, -2 + z, getBlock(rand));
            world.setBlock(x, y + 4, -3 + z, getBlock(rand));
            world.setBlock(x + 1, y + 4, z, getBlock(rand));
            world.setBlock(x + 2, y + 4, z, getBlock(rand));
            world.setBlock(x + 3, y + 4, z, getBlock(rand));
            world.setBlock(x - 1, y + 4, z, getBlock(rand));
            world.setBlock(x - 2, y + 4, z, getBlock(rand));
            world.setBlock(x - 3, y + 4, z, getBlock(rand));
            ...
            world.setBlock(x, y + 5, 1 + z, getBlock(rand));
            world.setBlock(x, y + 5, 2 + z, getBlock(rand));
            world.setBlock(x, y + 5, 3 + z, getBlock(rand));
            world.setBlock(x, y + 5, -1 + z, getBlock(rand));
            world.setBlock(x, y + 5, -2 + z, getBlock(rand));
            world.setBlock(x, y + 5, -3 + z, getBlock(rand));
            world.setBlock(x + 1, y + 5, z, getBlock(rand));
            world.setBlock(x + 2, y + 5, z, getBlock(rand));
            world.setBlock(x + 3, y + 5, z, getBlock(rand));
            world.setBlock(x - 1, y + 5, z, getBlock(rand));
            world.setBlock(x - 2, y + 5, z, getBlock(rand));
            world.setBlock(x - 3, y + 5, z, getBlock(rand));
            ...
            world.setBlock(x, y + 6, 1 + z, getBlock(rand));
            world.setBlock(x, y + 6, 2 + z, getBlock(rand));
            world.setBlock(x, y + 6, -1 + z, getBlock(rand));
            world.setBlock(x, y + 6, -2 + z, getBlock(rand));
            world.setBlock(x + 1, y + 6, z, getBlock(rand));
            world.setBlock(x + 2, y + 6, z, getBlock(rand));
            world.setBlock(x - 1, y + 6, z, getBlock(rand));
            world.setBlock(x - 2, y + 6, z, getBlock(rand));
            ...
            world.setBlock(x, y + 7, 1 + z, getBlock(rand));
            world.setBlock(x, y + 7, -1 + z, getBlock(rand));
            world.setBlock(x + 1, y + 7, z, getBlock(rand));
            world.setBlock(x - 1, y + 7, z, getBlock(rand));
            ...
            world.setBlock(x, y + 8, 1 + z, getBlock(rand));
            world.setBlock(x, y + 8, -1 + z, getBlock(rand));
            world.setBlock(x + 1, y + 8, z, getBlock(rand));
            world.setBlock(x - 1, y + 8, z, getBlock(rand));
