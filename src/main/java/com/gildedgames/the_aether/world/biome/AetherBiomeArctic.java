...
public class AetherBiomeArctic extends BiomeGenBase {
    ...
    public AetherBiomeArctic() {
        ...
        this.setBiomeName("Arctic Highlands");
        this.setDisableRain();
        this.setColor(0);
    }

    public WorldGenerator getRandomWorldGenForGrass(Random random) {
        return new WorldGenAetherGrass(BlocksAether.arctic_tallgrass, 0);
    }
    ...
    public void addDefaultFlowers() {
        ...
        this.flowers.add(new FlowerEntry(BlocksAether.neverbloom, 0, 5));
    ...
    public WorldGenAbstractTree getRandomTreeFeature(final Random random) {
        ...
        if (ratio <= 35) {
            ...
            return new AetherGenLargeTree(BlocksAether.blue_skyroot_leaves, BlocksAether.skyroot_log, 0);
        } else if (ratio <= 72) {
            return new AetherGenLargeTree(BlocksAether.blue_skyroot_leaves, BlocksAether.skyroot_log, 0);
        } else if (ratio <= 73) {
