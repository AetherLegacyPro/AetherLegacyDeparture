...
public class AetherBiome extends BiomeGenBase {
    ...
    public WorldGenAbstractTree getRandomTreeFeature(final Random random) {
        ...
        if (ratio <= 35) {
            ...
            return new AetherGenFruitTree(
                BlocksAether.dark_blue_skyroot_leaves,
                BlocksAether.dark_blue_skyroot_leaves,
                50,
                5,
                true);
            ...
            return new AetherGenFruitTree(
                BlocksAether.purple_skyroot_leaves,
                BlocksAether.purple_skyroot_fruit_leaves,
                50,
                5,
                true);
        } else if (ratio <= 77) {
            ...
            return new AetherGenFruitTree(
                BlocksAether.blue_skyroot_leaves,
                BlocksAether.blue_skyroot_leaves,
                35,
                5,
                true);
