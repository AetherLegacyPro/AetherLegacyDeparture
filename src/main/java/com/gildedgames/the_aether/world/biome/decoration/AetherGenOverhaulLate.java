...
public class AetherGenOverhaulLate implements IWorldGenerator {
    ...
    public void generateAetherLate(World world, Random rand, int x, int z) {
        ...
        if (AetherConfig.enableAetheralStone()) {
            this.generateOre(
                BlocksAether.aetheral_ambrosium_ore,
                world,
                rand,
                x,
                z,
            ...
            this.generateOre(
                BlocksAether.aetheral_zanite_ore,
                world,
                rand,
                x,
                z,
                ...
                BlocksAether.aetheral_stone);
            this.generateOre(
                BlocksAether.aetheral_arkenium_ore,
                world,
                rand,
                x,
                z,
                ...
                BlocksAether.aetheral_stone);
            this.generateOre(
                BlocksAether.aetheral_continuum_ore,
                world,
                rand,
                x,
                z,
                ...
                BlocksAether.aetheral_stone);
            this.generateOre(
                BlocksAether.aetheral_gravitite_ore,
                world,
                rand,
                x,
                z,
        ...
        if (AetherConfig.enableAgisoite()) {
            this.generateOre(
                BlocksAether.agiosite_ambrosium_ore,
                world,
                rand,
                x,
                z,
            ...
            this.generateOre(
                BlocksAether.agiosite_zanite_ore,
                world,
                rand,
                x,
                z,
                ...
                BlocksAether.agiosite);
            this.generateOre(
                BlocksAether.agiosite_arkenium_ore,
                world,
                rand,
                x,
                z,
                ...
                BlocksAether.agiosite);
            this.generateOre(
                BlocksAether.agiosite_continuum_ore,
                world,
                rand,
                x,
                z,
                ...
                BlocksAether.agiosite);
            this.generateOre(
                BlocksAether.agiosite_gravitite_ore,
                world,
                rand,
                x,
                z,
        ...
        if (AetherConfig.enableDeific()) {
            this.generateOre(
                BlocksAether.deific_ambrosium_ore,
                world,
                rand,
                x,
                z,
