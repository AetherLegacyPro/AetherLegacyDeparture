...
public class WorldGenArcticGlowstone extends WorldGenerator {
    ...
    public boolean generate(World world, Random random, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
        if (!world.isAirBlock(p_76484_3_, p_76484_4_, p_76484_5_)) {
            ...
            world.setBlock(p_76484_3_, p_76484_4_, p_76484_5_, BlocksAether.arctic_glowstone, 0, 2);
            ...
            for (int l = 0; l < 1500; ++l) {
                ...
                if (world.getBlock(i1, j1, k1).getMaterial() == Material.air) {
                    ...
                    for (int i2 = 0; i2 < 6; ++i2) {
                        ...
                        if (block == BlocksAether.arctic_glowstone) {
                            ++l1;
                        }
                    }

                    if (l1 == 1) {
                        world.setBlock(i1, j1, k1, BlocksAether.arctic_glowstone, 0, 2);
                    }
                }
            }
