...
public class PalladiumDungeonWorldGen implements IWorldGenerator {
    ...
    public void generateAether(World world, Random rand, int x, int z) {
        ...
        if ((biome == AetherWorld.aether_biome) && AetherConfig.palladium_dungeon_rarity != 0
            && rand.nextInt(aether_random) == 0
            && AetherConfig.palladium_dungeon_enable == true) {
            byte byte0 = 20;
            byte byte1 = 20;
            byte byte2 = 35;
            byte byte3 = 35;
            ...
            if (rand.nextInt(byte21) == 0) {
                ...
                (new PalladiumDungeon(
                    ...
                    genOre3)).generate(world, rand, x1, y2, z1);
                (new PalladiumDungeon(
                    bumpsWide1,
                    bumpsLong1,
                    bumpHeightVarTop1,
                    ...
                    radialDistanceScaling1,
                    radialDistanceBlurPasses1,
                    genOre3)).generate(world, rand, x1 - 16, y2, z1 + 16);
                (new PalladiumDungeon(
                    bumpsWide1,
                    bumpsLong1,
                    bumpHeightVarTop1,
                ...
                (new PalladiumDungeon(
                    ...
                    radialDistanceScaling1,
                    radialDistanceBlurPasses1,
                    genOre3)).generate(world, rand, x1 - 32, y2, z1 + 32);
                (new PalladiumDungeon(
                    bumpsWide1,
                    bumpsLong1,
                    bumpHeightVarTop1,
                ...
                (new DivineIsland(
                    ...
                    radialDistanceScaling1,
                    radialDistanceBlurPasses1,
                    genOre3)).generate(world, rand, x1 - 48, y1 - 6, z1 + 48);
                (new DivineIsland(
                    bumpsWide1,
                    bumpsLong1,
                    bumpHeightVarTop1,
