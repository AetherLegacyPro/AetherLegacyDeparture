...
public class AetherBiomeStormySkies extends BiomeGenBase {

    @SuppressWarnings("unchecked")
    public AetherBiomeStormySkies() {
        super(AetherConfig.getStormySkiesBiomeID());
        ...
        this.topBlock = BlocksAether.storm_aercloud;
        this.fillerBlock = BlocksAether.storm_aercloud;

        this.setBiomeName("Stormy Skies");
        this.setDisableRain();
        this.setColor(0);
    }

    public WorldGenerator getRandomWorldGenForGrass(Random random) {
        return new WorldGenAetherGrass(BlocksAether.aether_tallgrass, 0);
    }

    @Override
    public void addDefaultFlowers() {
        this.flowers.add(new FlowerEntry(BlocksAether.berry_bush, 0, 10));
    ...
    public WorldGenAbstractTree getRandomTreeFeature(final Random random) {
        ...
        if (ratio <= 35) {
            ...
            return new AetherGenMassiveTree(BlocksAether.dark_blue_skyroot_leaves, 18, false);
        }
    ...
    private void addMobEntry(ArrayList<SpawnListEntry> list) {
        ...
        list.add(new SpawnListEntry(EntityTempest.class, 100, 1, 4));
