...
public class AetherGenGoldenFruitTree extends WorldGenAbstractTree {
    ...
    public AetherGenGoldenFruitTree(final Block leafID, final Block fruitMeta, final int fruitChance,
        final int heightWeight, final boolean branchFlag) {
        super(true);
        this.leaves = leafID;
    ...
    public boolean generate(final World world, final Random random, final int x, final int y, final int z) {
        ...
        if (y3 != BlocksAether.aether_grass && y3 != BlocksAether.aether_dirt
            && y3 != BlocksAether.enchanted_aether_grass) {
            return false;
        }
