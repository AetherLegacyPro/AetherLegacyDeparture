...
public class AetherGenFruitTree extends WorldGenAbstractTree {
    ...
    public AetherGenFruitTree(final Block leafID, final Block fruitMeta, final int fruitChance, final int heightWeight,
        final boolean branchFlag) {
        super(true);
        this.leaves = leafID;
    ...
    public boolean generate(final World world, final Random random, final int x, final int y, final int z) {
        ...
        for (int y4 = y; y4 <= y + height; ++y4) {
            world.setBlock(x, y4, z, BlocksAether.skyroot_log_wall);
        }
        this.setBlockAirCheck(
            world,
            x,
            y + (height + 1),
            z,
            this.leaves,
            (random.nextInt(this.fruitChance) == 0) ? this.fruit : Blocks.air);
        this.setBlockAirCheck(
            world,
            x,
            y + (height + 2),
                    ...
                    case 0: {
                        for (int x3 = x; x3 <= x + branchLength; ++x3) {
                            ...
                            this.setBlockAirCheck(
                                ...
                                z,
                                this.leaves,
                                (random.nextInt(chance) == 0) ? this.fruit : Blocks.air);
                            this.setBlockAirCheck(
                                world,
                                x3,
                                y5 - 1,
