...
public class AetherGenWisprootTree extends WorldGenAbstractTree
{
    Block leaves;
    int randHeight;
    boolean branches;
    
    public AetherGenWisprootTree(final Block leafID, final int heightWeight, final boolean branchFlag) {
        super(true);
        this.leaves = leafID;
    ...
    public boolean generate(final World world, final Random random, final int x, final int y, final int z) {
        ...
        if (y3 != BlocksAether.arctic_grass && y3 != BlocksAether.aether_dirt) {
            return false;
        }
        world.setBlock(x, y - 1, z, BlocksAether.aether_dirt);
        for (int y4 = y; y4 <= y + height; ++y4) {
            world.setBlock(x, y4, z, BlocksAether.wisproot_log);
        }
        if (this.branches) {
            world.setBlock(x + 1, y, z, BlocksAether.wisproot_log);
            world.setBlock(x + 1, y + 1, z, BlocksAether.wisproot_log);
            world.setBlock(x + 2, y, z, BlocksAether.wisproot_log);
            world.setBlock(x - 1, y, z, BlocksAether.wisproot_log);
            world.setBlock(x - 1, y + 1, z, BlocksAether.wisproot_log);
            world.setBlock(x - 2, y, z, BlocksAether.wisproot_log);
            world.setBlock(x, y, z + 1, BlocksAether.wisproot_log);
            world.setBlock(x, y + 1, z + 1, BlocksAether.wisproot_log);
            world.setBlock(x, y, z + 2, BlocksAether.wisproot_log);
            world.setBlock(x, y, z - 1, BlocksAether.wisproot_log);
            world.setBlock(x, y + 1, z - 1, BlocksAether.wisproot_log);
            world.setBlock(x, y, z - 2, BlocksAether.wisproot_log);
            world.setBlock(x + 1, y - 1, z, BlocksAether.arctic_grass);
            world.setBlock(x + 2, y - 1, z, BlocksAether.arctic_grass);
            world.setBlock(x - 1, y - 1, z, BlocksAether.arctic_grass);
            world.setBlock(x - 2, y - 1, z, BlocksAether.arctic_grass);
            world.setBlock(x, y - 1, z + 1, BlocksAether.arctic_grass);
            world.setBlock(x, y - 1, z + 2, BlocksAether.arctic_grass);
            world.setBlock(x, y - 1, z - 1, BlocksAether.arctic_grass);
            world.setBlock(x, y - 1, z - 2, BlocksAether.arctic_grass);
                ...
                switch (side) {
                    case 0: {
                        for (int x3 = x; x3 <= x + branchLength; ++x3) {
                            world.setBlock(x3, y5, z, BlocksAether.wisproot_log);
                            this.setBlockAirCheck(world, x3, y5 + 1, z, this.leaves);
                            this.setBlockAirCheck(world, x3, y5 - 1, z, this.leaves);
                            this.setBlockAirCheck(world, x3 + 1, y5, z + 1, this.leaves);
                            this.setBlockAirCheck(world, x3 - 1, y5, z - 1, this.leaves);
                        }
                        world.setBlock(x + (branchLength + 1), y5 + 1, z, BlocksAether.wisproot_log);
                        world.setBlock(x + (branchLength + 2), y5 + 2, z, BlocksAether.wisproot_log);
                        world.setBlock(x + (branchLength + 2), y5 + 3, z, BlocksAether.wisproot_log);
                    ...
                    case 1: {
                        for (int x4 = x; x4 >= x - branchLength; --x4) {
                            world.setBlock(x4, y5, z, BlocksAether.wisproot_log);
                    ...
                    case 2: {
                        for (int z3 = z; z3 <= z + branchLength; ++z3) {
                            world.setBlock(x, y5, z3, BlocksAether.wisproot_log);
                            this.setBlockAirCheck(world, x, y5 + 1, z3, this.leaves);
                            this.setBlockAirCheck(world, x, y5 - 1, z3, this.leaves);
                            this.setBlockAirCheck(world, x + 1, y5, z3, this.leaves);
                            this.setBlockAirCheck(world, x - 1, y5, z3, this.leaves);
                        }
                        world.setBlock(x, y5 + 1, z + (branchLength + 1), BlocksAether.wisproot_log);
                        world.setBlock(x, y5 + 2, z + (branchLength + 2), BlocksAether.wisproot_log);
                        world.setBlock(x, y5 + 3, z + (branchLength + 2), BlocksAether.wisproot_log);
                    ...
                    case 3: {
                        for (int z4 = z; z4 >= z - branchLength; --z4) {
                            world.setBlock(x, y5, z4, BlocksAether.wisproot_log);
