...
public class AetherGenOakTree extends WorldGenAbstractTree {
	...
	public boolean generate(World world, Random random, int x, int y, int z) {
		if (world.getBlock(x, y - 1, z) != BlocksAether.aether_grass && world.getBlock(x, y - 1, z) != BlocksAether.enchanted_aether_grass && world.getBlock(x, y - 1, z) != BlocksAether.aether_dirt) {
			return false;
		}
