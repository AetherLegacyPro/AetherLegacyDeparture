...
public class AetherBiomeAetherPeaks extends BiomeGenBase {

    @SuppressWarnings("unchecked")
    public AetherBiomeAetherPeaks() {
        super(AetherConfig.getAetherPeaksBiomeID());
        ...
        this.setBiomeName("Aether Peaks");
        this.setDisableRain();
        this.setColor(0);
    }
    ...
    @Override
    public int getSkyColorByTemp(float currentTemperature) { return 0xc4c4ff; }
