...
public class AetherWorld {
    ...
    public static void initialization() {
        ...
        MapGenStructureIO
            .registerStructure(MapGenAncientSilverDungeon.Start.class, "aether_legacy:ancient_silver_dungeon_start");
        MapGenStructureIO
            .registerStructure(MapGenDivineSilverDungeon.Start.class, "aether_legacy:divine_silver_dungeon_start");

        MapGenStructureIO.registerStructure(MapGenGoldenDungeon.Start.class, "aether_legacy:golden_dungeon_start");
        MapGenStructureIO
            .registerStructure(MapGenAncientGoldenDungeon.Start.class, "aether_legacy:ancient_golden_dungeon_start");
        MapGenStructureIO
            .registerStructure(MapGenDivineGoldenDungeon.Start.class, "aether_legacy:divine_golden_dungeon_start");

        MapGenStructureIO
            .registerStructure(MapGenLargeColdAercloud.Start.class, "aether_legacy:large_cold_aercloud_start");

        MapGenStructureIO
            .func_143031_a(ComponentLargeColdAercloud.class, "aether_legacy:large_cold_aercloud_component");

        MapGenStructureIO.func_143031_a(ComponentSilverDungeon.class, "aether_legacy:silver_dungeon_component");
        MapGenStructureIO
            .func_143031_a(ComponentAncientSilverDungeon.class, "aether_legacy:ancient_silver_dungeon_component");
        MapGenStructureIO
            .func_143031_a(ComponentDivineSilverDungeon.class, "aether_legacy:divine_silver_dungeon_component");
        ...
        MapGenStructureIO
            .func_143031_a(ComponentAncientGoldenDungeon.class, "aether_legacy:ancient_golden_dungeon_component");
        MapGenStructureIO
            .func_143031_a(ComponentAncientGoldenIsland.class, "aether_legacy:ancient_golden_island_component");
        MapGenStructureIO.func_143031_a(
            ComponentAncientGoldenIslandStub.class,
            "aether_legacy:ancient_golden_island_stub_component");

        MapGenStructureIO
            .func_143031_a(ComponentDivineGoldenDungeon.class, "aether_legacy:divine_golden_dungeon_component");
        MapGenStructureIO
            .func_143031_a(ComponentDivineGoldenDungeonIsland.class, "aether_legacy:divine_golden_island_component");
        MapGenStructureIO
            .func_143031_a(ComponentDivineGoldenIslandStub.class, "aether_legacy:divine_golden_island_stub_component");
