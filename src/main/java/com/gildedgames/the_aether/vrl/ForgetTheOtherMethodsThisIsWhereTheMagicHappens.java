...
public class ForgetTheOtherMethodsThisIsWhereTheMagicHappens {
    ...
    public static File getJarName() {
        // try {
        // String jarFilePath =
        // ForgetTheOtherMethodsThisIsWhereTheMagicHappens.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath();
        ...
        if (modFiles != null) {
            ...
            for (File modFile : modFiles) {
                if (modFile != null) if ((modFile.getName()
                    .toLowerCase()
                    .contains("aether")
                    && modFile.getName()
                        .toLowerCase()
                    ...
                    || (modFile.getName()
                        ...
                        && modFile.getName()
                            ...
                            .contains("dirty"))) {
                                ...
                                System.out.println("Detected Aether Departure jar name: " + modFile); // actually keep
                                                                                                      // this one
                                return modFile;
                            }
            }
            ...
            for (File modFile : modFiles) {
                if (modFile != null) if ((modFile.getName()
                    ...
                    || modFile.getName()
                        ...
                        .contains("departure"))) {
                            // ronaldoMods.add(modFile);
                            System.out.println("Detected Aether Departure jar name: " + modFile); // actually keep this
                                                                                                  // one
                            return modFile;
                        }
            }
    ...
    public static void updateJar(File jarFile) throws Exception {
         ...
         * //if (filesInCowFolder[i].getAbsolutePath().contains("assets") &&
         * !(filesInCowFolder[i].getAbsolutePath().contains("LICENSE")))
         * if (filesInCowFolder[i].toString().contains("assets") && !filesInCowFolder[i].toString().contains("legacy")
         * && !filesInCowFolder[i].toString().contains("LICENSE")) {
         ...
         * //String[] cmd1 = {"copy", "/Y", jarFile.getAbsolutePath(), (System.getProperty("user.dir") +
         * "\\unpack\\tmp1.zip")};
         * String[] cmd1 = {"powershell", "-command", "\"" + "/Y" + " " + jarFile.getAbsolutePath() + " " +
         * (System.getProperty("user.dir") + "\\unpack\\tmp1.zip" + "\"")};
         * for (String str : cmd1) {
         ...
         * String[] cmd2 = {"powershell", "-command", "\"Expand-Archive -Path " + (System.getProperty("user.dir") +
         * "\\unpack\\tmp1.zip") + " -DestinationPath " + (System.getProperty("user.dir") + "\\unpack\\unpacked") +
         * "-Force\""};
         * for (String str : cmd2) {
         * System.out.print(str + " ");
         * }
         ...
         * System.out.println(exitCode);
         * //String[] cmd3 = {"cp", "-r", (System.getProperty("user.dir") + "/cow/assets/."),
         * (System.getProperty("user.dir") + "/unpack/unpacked/assets")};
         * Process process33 = Runtime.getRuntime().exec("xcopy /E /Y " + (System.getProperty("user.dir") +
         * "\\cow\\assets\\* " + (System.getProperty("user.dir") + "\\unpack\\unpacked\\assets\\ > nul")));
         * //for (String str : cmd3) {
         * // System.out.print(str + " ");
         * //}
         * System.out.println("xcopy /E /Y " + (System.getProperty("user.dir") + "\\cow\\assets\\* " +
         * (System.getProperty("user.dir") + "\\unpack\\unpacked\\assets\\ > nul")));
         ...
         * System.out.println(exitCode);
         * String[] cmd4 = {"Compact", "/C", "/S:\"" + (System.getProperty("user.dir") + "\\unpack\\unpacked") + "\"",
         * "/F:\"" + jarFile.getAbsolutePath() + "\""};
         * for (String str : cmd4) {
         * System.out.print(str + " ");
         * }
         ...
         * int exitCode = process1.waitFor();
         * System.out.println(exitCode);
         * String[] cmd2 = {"unzip", "-q", "-o", (System.getProperty("user.dir") + "/unpack/tmp1.zip"), "-d",
         * (System.getProperty("user.dir") + "/unpack/unpacked")};
         * for (String str : cmd2) {
         * System.out.print(str + " ");
         * }
         * Process process2 = Runtime.getRuntime().exec(cmd2);
         ...
         * System.out.println(exitCode);
         * String[] cmd4 = {"zip", "-q", "-FS", "-r", jarFile.getAbsolutePath(), (System.getProperty("user.dir") +
         * "/unpack/unpacked")};
         * for (String str : cmd4) {
         * System.out.print(str + " ");
         * }
        ...
        if (System.getProperty("os.name")
            .toLowerCase()
            .contains("windows")) {
            // ProcessBuilder processBuilder = new ProcessBuilder("cmd", "/c", "xcopy", "/Y", "/F",
            // (System.getProperty("user.dir") + "/mods/temptemptemp.zip"), (jarFile.getAbsolutePath()));
            // ProcessBuilder processBuilder = new ProcessBuilder("C:\\Windows\\System32\\cmd.exe", "/c", "xcopy", "/Y",
            // "/F", (System.getProperty("user.dir") + "/mods/temptemptemp.zip"), (jarFile.getAbsolutePath()));
            ...
            copyFolder(
                Paths.get(System.getProperty("user.dir") + "/cow/assets/aether"),
                Paths.get(System.getProperty("user.dir") + "/resourcepacks/aether_departure/assets/aether"));
            copyFolder(
                Paths.get(System.getProperty("user.dir") + "/cow/assets/aether_legacy"),
                Paths.get(System.getProperty("user.dir") + "/resourcepacks/aether_departure/assets/aether_legacy"));
            copyFolder(
                Paths.get(System.getProperty("user.dir") + "/cow/assets/aetherii"),
                Paths.get(System.getProperty("user.dir") + "/resourcepacks/aether_departure/assets/aetherii"));

            // Files.copy(source, destination, StandardCopyOption.REPLACE_EXISTING);
            Files.copy(
                Paths.get(System.getProperty("user.dir") + "/unpack/pack.mcmeta"),
                Paths.get(System.getProperty("user.dir") + "/resourcepacks/aether_departure/pack.mcmeta"),
                StandardCopyOption.REPLACE_EXISTING);
            Files.copy(
                Paths.get(System.getProperty("user.dir") + "/unpack/pack.png"),
                Paths.get(System.getProperty("user.dir") + "/resourcepacks/aether_departure/pack.png"),
                StandardCopyOption.REPLACE_EXISTING);
            // I really fricking hate this
            // Files.move(Paths.get(System.getProperty("user.dir") + "/mods/temptemptemp.zip"),
            // Paths.get(System.getProperty("user.dir") + "/resourcepacks/AetherDepartureAssets.zip"),
            // StandardCopyOption.REPLACE_EXISTING);
            System.out.println("winblows");
        } else {
            copyFolder(
                Paths.get(System.getProperty("user.dir") + "/cow/assets/aether"),
                Paths.get(System.getProperty("user.dir") + "/unpack/assets/aether"));
            copyFolder(
                Paths.get(System.getProperty("user.dir") + "/cow/assets/aether_legacy"),
                Paths.get(System.getProperty("user.dir") + "/unpack/assets/aether_legacy"));
            copyFolder(
                Paths.get(System.getProperty("user.dir") + "/cow/assets/aetherii"),
                Paths.get(System.getProperty("user.dir") + "/unpack/assets/aetherii"));
            compress((System.getProperty("user.dir") + "/unpack"));
            Files.move(
                Paths.get(System.getProperty("user.dir") + "/mods/temptemptemp.zip"),
