	...
	public static void updateJar(File jarFile) throws Exception {
		...
		*/
		...
		if(System.getProperty("os.name").toLowerCase().contains("windows")) {
        	...
        	Files.copy(Paths.get(System.getProperty("user.dir") + "/unpack/pack.mcmeta"), Paths.get(System.getProperty("user.dir") + "/resourcepacks/aether_departure/pack.mcmeta"), StandardCopyOption.REPLACE_EXISTING);
        	Files.copy(Paths.get(System.getProperty("user.dir") + "/unpack/pack.png"), Paths.get(System.getProperty("user.dir") + "/resourcepacks/aether_departure/pack.png"), StandardCopyOption.REPLACE_EXISTING);
