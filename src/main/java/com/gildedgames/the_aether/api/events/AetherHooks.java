...
import com.gildedgames.the_aether.api.events.enchantments.AetherAmplifierEvent;
import com.gildedgames.the_aether.api.events.enchantments.AetherAmplifierEvent.AmplifyEvent;
...
public class AetherHooks {
    ...
    public static int onSetEnchantmentTime(TileEntity enchanter, AetherEnchantment enchantment, int original) {
        AetherEnchantmentEvent.SetTimeEvent event = new AetherEnchantmentEvent.SetTimeEvent(
            enchanter,
            enchantment,
            original);
