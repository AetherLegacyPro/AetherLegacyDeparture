...
public class TileEntityElysianChest extends TileEntity implements IInventory
{
  private ItemStack[] chestContents;
  public boolean adjacentChestChecked;
  public TileEntityElysianChest adjacentChestZNeg;
  public TileEntityElysianChest adjacentChestXPos;
  public TileEntityElysianChest adjacentChestXNeg;
  public TileEntityElysianChest adjacentChestZPosition;
  ...
  public TileEntityElysianChest() {
      this.chestContents = new ItemStack[36];
      this.cachedChestType = -1;
  }
  
  @SideOnly(Side.CLIENT)
  public TileEntityElysianChest(final int par1) {
      this.chestContents = new ItemStack[36];
  ...
  private void func_90009_a(final TileEntityElysianChest par1TileEntityChest, final int par2) {
  ...
  public void checkForAdjacentChests() {
      if (!this.adjacentChestChecked) {
          ...
          if (this.func_94044_a(this.xCoord - 1, this.yCoord, this.zCoord)) {
              this.adjacentChestXNeg = (TileEntityElysianChest)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
          }
          if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord)) {
              this.adjacentChestXPos = (TileEntityElysianChest)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
          }
          if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1)) {
              this.adjacentChestZNeg = (TileEntityElysianChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
          }
          if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1)) {
              this.adjacentChestZPosition = (TileEntityElysianChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
          }
  ...
  public void closeInventory() {
      if (this.getBlockType() != null && this.getBlockType() instanceof BlockElysianChest) {
          --this.numUsingPlayers;
          this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numUsingPlayers);
          this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
          this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord - 1, this.zCoord, this.getBlockType());
  ...
  public int getChestType() {
      if (this.cachedChestType == -1) {
          if (this.worldObj == null || !(this.getBlockType() instanceof BlockElysianChest)) {
              return 0;
          }
          this.cachedChestType = ((BlockElysianChest)this.getBlockType()).chestType;
      }
