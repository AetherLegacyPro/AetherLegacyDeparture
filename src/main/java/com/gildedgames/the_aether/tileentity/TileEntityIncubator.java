...
public class TileEntityIncubator extends AetherTileEntity {
    ...
    public void updateEntity() {
        ...
        if (this.progress >= this.ticksRequired) {
            if (this.getStackInSlot(1)
                .getItem() instanceof ItemMoaEgg moaEgg) {
        ...
        if (this.powerRemaining <= 0) {
            if (this.getStackInSlot(0) != null && this.getStackInSlot(1) != null
                && this.getStackInSlot(1)
                    .getItem() == ItemsAether.moa_egg
                && this.getStackInSlot(0)
                    .getItem() == Item.getItemFromBlock(BlocksAether.ambrosium_torch)) {
    ...
    public boolean isValidSlotItem(int index, ItemStack itemstack) {
        return (index == 0 && itemstack.getItem() == Item.getItemFromBlock(BlocksAether.ambrosium_torch) ? true
            : (index == 1 && itemstack.getItem() == ItemsAether.moa_egg));
    }
