    ...
    public void unlock(int kind) {
        ...
        if (kind == 3) {
            for (p = 0; p < 5 + random.nextInt(2); ++p) {
                this.setInventorySlotContents(
                    random.nextInt(this.getSizeInventory()),
                    LargeBronzeDungeon.getAncientBronzeLoot(random));
            }
        ...
        if (kind == 4) {
            for (p = 0; p < 5 + random.nextInt(2); ++p) {
                this.setInventorySlotContents(
                    random.nextInt(this.getSizeInventory()),
                    DivineBronzeDungeon.getDivineBronzeLoot(random));
            }
        }
        ...
        if (kind == 5) {
            for (p = 0; p < 5 + random.nextInt(2); ++p) {
                this.setInventorySlotContents(
                    random.nextInt(this.getSizeInventory()),
                    ComponentAncientSilverDungeon.getAncientSilverLoot(random));
            }
        }
        ...
        if (kind == 7) {
            for (p = 0; p < 5 + random.nextInt(5); ++p) {
                this.setInventorySlotContents(
                    random.nextInt(this.getSizeInventory()),
                    ComponentAncientGoldenDungeon.getAncientGoldLoot(random));
            }
        }
        ...
        if (kind == 9) {
            for (p = 0; p < 7 + random.nextInt(3); ++p) {
                this.setInventorySlotContents(
                    random.nextInt(this.getSizeInventory()),
                    MythicBronzeDungeon.getMythicBronzeLoot(random));
            }
        }
        ...
        if (kind == 10) {
            for (p = 0; p < 7 + random.nextInt(3); ++p) {
                this.setInventorySlotContents(
                    random.nextInt(this.getSizeInventory()),
                    CobaltDungeon.getCobaltLoot(random));
            }
        }
