...
public class TileEntityTreasureChestBreakable extends TileEntity implements IInventory {
    ...
    public void checkForAdjacentChests() {
        if (!this.adjacentChestChecked) {
            ...
            if (this.func_94044_a(this.xCoord - 1, this.yCoord, this.zCoord)) {
                this.adjacentChestXNeg = (TileEntityTreasureChestBreakable) this.worldObj
                    .getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }
            if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord)) {
                this.adjacentChestXPos = (TileEntityTreasureChestBreakable) this.worldObj
                    .getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }
            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1)) {
                this.adjacentChestZNeg = (TileEntityTreasureChestBreakable) this.worldObj
                    .getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }
            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1)) {
                this.adjacentChestZPosition = (TileEntityTreasureChestBreakable) this.worldObj
                    .getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_94044_a(final int par1, final int par2, final int par3) {
        ...
        return block instanceof BlockTreasureChestBreakable
            && ((BlockTreasureChestBreakable) block).chestType == this.getChestType();
    }
        ...
        if (!this.worldObj.isRemote && this.numUsingPlayers != 0
            ...
            for (final Object aList : list) {
                ...
                if (entityplayer.openContainer instanceof ContainerChest) {
                    ...
                    if (iinventory != this && (!(iinventory instanceof InventoryLargeTreasureChestBreakable)
                        || !((InventoryLargeTreasureChestBreakable) iinventory).isPartOfLargeChest(this))) {
                        continue;
                    }
