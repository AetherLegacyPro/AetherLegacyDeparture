...
public class TileEntitySkyrootChest extends TileEntity implements IInventory
{
  ...
  public TileEntitySkyrootChest(final int par1) {
      this.chestContents = new ItemStack[36];
  ...
  private void func_90009_a(final TileEntitySkyrootChest par1TileEntityChest, final int par2) {
  ...
  public void checkForAdjacentChests() {
      if (!this.adjacentChestChecked) {
          ...
          if (this.func_94044_a(this.xCoord - 1, this.yCoord, this.zCoord)) {
              this.adjacentChestXNeg = (TileEntitySkyrootChest)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
          }
          if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord)) {
              this.adjacentChestXPos = (TileEntitySkyrootChest)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
          }
          if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1)) {
              this.adjacentChestZNeg = (TileEntitySkyrootChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
          }
          if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1)) {
              this.adjacentChestZPosition = (TileEntitySkyrootChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
          }
  ...
  private boolean func_94044_a(final int par1, final int par2, final int par3) {
      ...
      return block != null && block instanceof BlockSkyrootChest && ((BlockSkyrootChest)block).chestType == this.getChestType();
  }
      ...
      if (!this.worldObj.isRemote && this.numUsingPlayers != 0 && (this.ticksSinceSync + this.xCoord + this.yCoord + this.zCoord) % 200 == 0) {
          ...
          for (final Object aList : list) {
              ...
              if (entityplayer.openContainer instanceof ContainerChest) {
                  ...
                  if (iinventory != this && (!(iinventory instanceof InventoryLargeSkyrootChest) || !((InventoryLargeSkyrootChest)iinventory).isPartOfLargeChest((IInventory)this))) {
                      continue;
                  }
  ...
  public void closeInventory() {
      if (this.getBlockType() != null && this.getBlockType() instanceof BlockSkyrootChest) {
          --this.numUsingPlayers;
          this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numUsingPlayers);
          this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
          this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord - 1, this.zCoord, this.getBlockType());
  ...
  public int getChestType() {
      if (this.cachedChestType == -1) {
          if (this.worldObj == null || !(this.getBlockType() instanceof BlockSkyrootChest)) {
              return 0;
          }
          this.cachedChestType = ((BlockSkyrootChest)this.getBlockType()).chestType;
      }
