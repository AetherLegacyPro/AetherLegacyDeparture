    ...
    public void checkForAdjacentChests() {
        if (!this.adjacentChestChecked) {
            ...
            if (this.func_94044_a(this.xCoord - 1, this.yCoord, this.zCoord)) {
                this.adjacentChestXNeg = (TileEntitySkyrootChest) this.worldObj
                    .getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }
            if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord)) {
                this.adjacentChestXPos = (TileEntitySkyrootChest) this.worldObj
                    .getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }
            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1)) {
                this.adjacentChestZNeg = (TileEntitySkyrootChest) this.worldObj
                    .getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }
            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1)) {
                this.adjacentChestZPosition = (TileEntitySkyrootChest) this.worldObj
                    .getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
        ...
        if (!this.worldObj.isRemote && this.numUsingPlayers != 0
            ...
            for (final Object aList : list) {
                ...
                if (entityplayer.openContainer instanceof ContainerChest) {
                    ...
                    if (iinventory != this && (!(iinventory instanceof InventoryLargeSkyrootChest)
                        || !((InventoryLargeSkyrootChest) iinventory).isPartOfLargeChest(this))) {
                        continue;
                    }
