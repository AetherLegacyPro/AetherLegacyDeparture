...
public class TileEntityEnchanter extends AetherTileEntity {
        ...
        if (this.currentEnchantment != null) {
            if (this.progress >= this.ticksRequired) {
                if (!this.worldObj.isRemote) {
                    ItemStack result = this.currentEnchantment.getOutput()
                        .copy();
            ...
            if (this.getStackInSlot(0) == null || (this.getStackInSlot(0) != null && AetherAPI.instance()
                .getEnchantment(this.getStackInSlot(0)) != this.currentEnchantment)) {
            ...
            if (this.powerRemaining <= 0) {
                if (this.getStackInSlot(1) != null && AetherAPI.instance()
                    .isEnchantmentFuel(this.getStackInSlot(1))) {
                    this.powerRemaining += AetherAPI.instance()
                        .getEnchantmentFuel(this.getStackInSlot(1))
                        .getTimeGiven();
            ...
            AetherEnchantment enchantment = AetherAPI.instance()
            ...
            if (enchantment != null) {
                if (this.getStackInSlot(2) == null || (enchantment.getOutput()
                    ...
                    this.ticksRequired = AetherHooks
                        .onSetEnchantmentTime(this, this.currentEnchantment, this.ticksRequired);
                }
            }
        }
    ...
    public boolean isValidSlotItem(int slot, ItemStack stackInSlot) {
        if (slot == 2) {
            ...
            .isEnchantmentFuel(stackInSlot)) {
                return true;
            } else if (slot == 0 && AetherAPI.instance()
                .hasEnchantment(stackInSlot)) {
                    return true;
                }
