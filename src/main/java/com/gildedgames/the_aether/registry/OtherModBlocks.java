...
public class OtherModBlocks {
    ...
    public static Block stone_klangite_ore, deepslate_klangite_ore, klangite_ore, end_klangite_ore,
        frontierslate_klangite_ore;
    ...
    static {
        ...
        // NovaCraft
        OtherModBlocks.large_pherithium_stalagmite = GameRegistry
            .findBlock("nova_craft", "large_pherithium_stalagmite");
        OtherModBlocks.small_pherithium_stalagmite = GameRegistry
            .findBlock("nova_craft", "small_pherithium_stalagmite");
