...
public class ContainerSkyrootWorkbench extends ContainerWorkbench {
    ...
    public ContainerSkyrootWorkbench(final InventoryPlayer par1InventoryPlayer, final World par2World, final int par3,
    ...
    public boolean canInteractWith(final EntityPlayer par1EntityPlayer) {
        return this.worldObj.getBlock(this.posX, this.posY, this.posZ) == BlocksAether.skyroot_workbench
