...
public class InventoryLargeTreasureChestBreakable implements IInventory {

    private String name;
    private IInventory upperChest;
    private IInventory lowerChest;

    public InventoryLargeTreasureChestBreakable(final String par1Str, IInventory par2IInventory,
