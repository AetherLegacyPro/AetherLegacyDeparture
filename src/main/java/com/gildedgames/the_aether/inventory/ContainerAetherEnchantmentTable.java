...
public class ContainerAetherEnchantmentTable extends ContainerEnchantment {
    ...
    public ContainerAetherEnchantmentTable(final InventoryPlayer par1InventoryPlayer, final World par2World,
    ...
    public boolean canInteractWith(final EntityPlayer par1EntityPlayer) {
        return this.worldObj.getBlock(this.posX, this.posY, this.posZ) == BlocksAether.aether_enchantment_table
